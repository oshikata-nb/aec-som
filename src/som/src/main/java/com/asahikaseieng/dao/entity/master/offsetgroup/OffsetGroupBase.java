 ...
 * @author t0011036
 */
public class OffsetGroupBase implements Serializable {
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "OFFSET_GROUP";


//	/** IDアノテーション offsetGroupCd. */
//	public static final String offsetGroupCd_ID = "assigned";
//	/** IDアノテーション venderCd. */
