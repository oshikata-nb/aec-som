...
/**
 * BuyingApprovalDeliveryForAutoCompleteクラス.
 * @author t0011036
 */
public class BuyingApprovalDeliveryForAutoCompleteBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public BuyingApprovalDeliveryForAutoCompleteBase() {
	}
