 ...
 * Created on Thu Mar 12 18:28:22 JST 2009
 *
 * $copyright$
 *
 */
...
/**
 * AspImportPurchaseAttributeQueueBaseクラス.
 * @author 
 */
public class AspImportPurchaseAttributeQueueBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public AspImportPurchaseAttributeQueueBase() {
	}
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "PURCHASE_ATTRIBUTE_QUEUE";
