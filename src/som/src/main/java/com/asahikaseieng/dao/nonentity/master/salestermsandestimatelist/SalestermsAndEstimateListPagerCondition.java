 ...
 * @author t0011036
 */
public class SalestermsAndEstimateListPagerCondition extends
	 ...
	 * コンストラクタ
	 */
	public SalestermsAndEstimateListPagerCondition() {
	}
	...
	public void setSrhItemCdFrom(final String srhItemCdFrom) {
		this.srhItemCdFrom = AecTextUtils.likeFilter(srhItemCdFrom);
	}
	...
	public void setSrhItemCdTo(final String srhItemCdTo) {
		this.srhItemCdTo = AecTextUtils.likeFilter(srhItemCdTo);
	}
