...
/**
 * SlipShippingListForReportクラス.
 * @author kanri-user
 */
public class SlipShippingListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public SlipShippingListForReportBase() {
	}
	...
	/** COLUMNアノテーション slipShippningFareComp */
	public static final String slipShippningFareComp_COLUMN = "SLIP_SHIPPING_FARE_COMP";
	...
	/** COLUMNアノテーション carryLabelPublish */
	public static final String carryLabelPublish_COLUMN = "CARRY_LABEL_PUBLISH";
	...
	private String carryLabelPublish;
	...
	/**
	 * carryLabelPublish取得.
	 * @return carryLabelPublish
	 */
	public String getCarryLabelPublish() {
		return this.carryLabelPublish;
	}

	/**
	 * carryLabelPublish設定.
	 * @param carryLabelPublish carryLabelPublish
	 */
	public void setCarryLabelPublish(final String carryLabelPublish) {
		this.carryLabelPublish = carryLabelPublish;
	}
