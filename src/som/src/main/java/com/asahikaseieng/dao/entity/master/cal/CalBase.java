 ...
 * @author t0011036
 */
public class CalBase implements Serializable {
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "CAL";


//	/** IDアノテーション calCd. */
//	public static final String calCd_ID = "assigned";
//	/** IDアノテーション calDate. */
//	public static final String calDate_ID = "assigned";
