...
/**
 * MidInspectCompProcedureListForReportクラス.
 * @author kanri-user
 */
public class MidInspectCompProcedureListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public MidInspectCompProcedureListForReportBase() {
	}
