...
/**
 * RepPurchaseOrderDetailクラス.
 * @author kanri-user
 */
public class RepPurchaseOrderDetailBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public RepPurchaseOrderDetailBase() {
	}
	...
	/** COLUMNアノテーション todokesaki */
	public static final String todokesaki_COLUMN = "TODOKESAKI";
	...
	public String getTodokesaki() {
		return this.todokesaki;
	}

	/**
	 * todokesaki設定.
	 * @param todokesaki todokesaki
	 */
	public void setTodokesaki(final String todokesaki) {
