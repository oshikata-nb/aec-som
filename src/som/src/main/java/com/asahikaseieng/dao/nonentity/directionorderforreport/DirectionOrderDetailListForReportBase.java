...
/**
 * DirectionOrderDetailListForReportクラス.
 * @author kanri-user
 */
public class DirectionOrderDetailListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionOrderDetailListForReportBase() {
	}
