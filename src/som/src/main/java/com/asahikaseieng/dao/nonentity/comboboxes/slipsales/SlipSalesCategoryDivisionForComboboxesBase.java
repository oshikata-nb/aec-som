...
/**
 * 売上伝票出力－売上区分コンボボックス用データ
 *
 * @author tosco
 */
public class SlipSalesCategoryDivisionForComboboxesBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public SlipSalesCategoryDivisionForComboboxesBase() {
	}
