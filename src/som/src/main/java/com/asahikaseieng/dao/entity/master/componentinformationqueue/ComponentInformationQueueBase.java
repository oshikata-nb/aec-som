...
/**
 * ComponentInformationQueueBaseクラス.
 * @author t0011036
 */
public class ComponentInformationQueueBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public ComponentInformationQueueBase() {
	}
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "COMPONENT_INFORMATION_QUEUE";


//	/** IDアノテーション indicateOrder. */
//	public static final String indicateOrder_ID = "assigned";
//	/** IDアノテーション itemCd. */
