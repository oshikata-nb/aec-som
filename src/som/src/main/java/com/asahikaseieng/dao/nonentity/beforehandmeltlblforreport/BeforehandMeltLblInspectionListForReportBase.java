...
/**
 * BeforehandMeltLblInspectionListForReportクラス.
 * @author kanri-user
 */
public class BeforehandMeltLblInspectionListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public BeforehandMeltLblInspectionListForReportBase() {
	}
