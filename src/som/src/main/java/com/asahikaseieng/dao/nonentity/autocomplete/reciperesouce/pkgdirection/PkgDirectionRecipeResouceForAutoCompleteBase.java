...
/**
 * 包装指図－包装ラインAuto Complete用データ格納クラス.
 *
 * @author tosco
 */
public class PkgDirectionRecipeResouceForAutoCompleteBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionRecipeResouceForAutoCompleteBase() {
	}
