...
/**
 * MidInspectCompFormulaListForReportクラス.
 * @author kanri-user
 */
public class MidInspectCompFormulaListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public MidInspectCompFormulaListForReportBase() {
	}
