...
/**
 * PkgRdirectionDetailListForReportクラス.
 * @author kanri-user
 */
public class PkgRdirectionDetailListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgRdirectionDetailListForReportBase() {
	}
