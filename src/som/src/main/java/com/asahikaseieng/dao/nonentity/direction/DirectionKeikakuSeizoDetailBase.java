 ...
 * @author tosco
 */
public class DirectionKeikakuSeizoDetailBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionKeikakuSeizoDetailBase() {
	}
	...
	private java.sql.Timestamp seizobi;
	 ...
	 * @return seizobi
	 */
	public java.sql.Timestamp getSeizobi() {
		return this.seizobi;
	}
	 ...
	 */
	public void setSeizobi(final java.sql.Timestamp seizobi) {
