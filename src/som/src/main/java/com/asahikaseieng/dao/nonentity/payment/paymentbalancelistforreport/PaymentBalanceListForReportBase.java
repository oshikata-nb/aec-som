...
/**
 * PaymentBalanceListForReportクラス.
 * @author t0011036
 */
public class PaymentBalanceListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PaymentBalanceListForReportBase() {
	}
	...
	private java.math.BigDecimal otherTotal;
	 ...
	 * @return otherTotal
	 */
	public java.math.BigDecimal getOtherTotal() {
		return this.otherTotal;
	}

	/**
	 * otherTotal設定.
	 * @param otherTotal otherTotal
	 */
	public void setOtherTotal(final java.math.BigDecimal otherTotal) {
