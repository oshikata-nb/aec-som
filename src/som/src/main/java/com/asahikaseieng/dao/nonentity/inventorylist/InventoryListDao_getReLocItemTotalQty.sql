...
AND LOT_INVENTORY.ITEM_CD LIKE /*itemCd*/'%'
/*END*/

/*IF (otherCompanyCd1 != null) && (otherCompanyCd1 != "")*/
AND OTHER_COMPANY_CD1 LIKE /*otherCompanyCd1*/'%'
/*END*/
...
/*IF (locationCd != null) && (locationCd != "")*/
AND LOCATION_INVENTORY.LOCATION_CD IN(SELECT LOCATION_CD FROM LOCATION WHERE UPPER_LOCATION_CD = /*locationCd*/'%')
/*END*/

/*IF (itemCd != null) && (itemCd != "")*/
AND LOCATION_INVENTORY.ITEM_CD LIKE /*itemCd*/'%'
/*END*/
