...
/**
 * PkgRdirectionHeaderListForReportクラス.
 * @author kanri-user
 */
public class PkgRdirectionHeaderListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgRdirectionHeaderListForReportBase() {
	}
