 ...
 * @author t0011036
 */
public class EstimateBase implements Serializable {
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "ESTIMATE";


//	/** IDアノテーション consecutiveNo. */
//	public static final String consecutiveNo_ID = "assigned";
//	/** IDアノテーション estimateNo. */
//	public static final String estimateNo_ID = "assigned";
