...
/**
 * RepSlipShippingDirDetailクラス.
 * @author kanri-user
 * 2019/12/10 AECS佐藤　（原料ロット番号追加）
 */
public class RepSlipShippingDirDetailBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public RepSlipShippingDirDetailBase() {
	}
	...
	/** COLUMNアノテーション convertQty */
	public static final String convertQty_COLUMN = "CONVERT_QTY";
	
	// 2019/12/10 AECS佐藤（追加）
	 ...
	 * @return convertQty
	 */
	public String getConvertQty() {
		return this.convertQty;
	}

	/**
	 * convertQty設定.
	 * @param convertQty convertQty
	 */
	public void setConvertQty(final String convertQty) {
