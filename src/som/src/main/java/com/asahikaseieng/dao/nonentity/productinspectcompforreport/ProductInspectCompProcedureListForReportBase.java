...
/**
 * ProductInspectCompProcedureListForReportクラス.
 * @author kanri-user
 */
public class ProductInspectCompProcedureListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public ProductInspectCompProcedureListForReportBase() {
	}
