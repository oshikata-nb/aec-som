...
/**
 * AspImportUnitpriceBaseクラス.
 * @author 
 */
public class AspImportUnitpriceBase implements Serializable {
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "UNITPRICE";
