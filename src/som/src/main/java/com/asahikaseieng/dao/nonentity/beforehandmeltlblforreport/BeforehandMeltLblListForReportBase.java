...
/**
 * BeforehandMeltLblListForReportクラス.
 * @author kanri-user
 */
public class BeforehandMeltLblListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public BeforehandMeltLblListForReportBase() {
	}
	...
	/** COLUMNアノテーション stockdissLabelName */
	public static final String stockdissLabelName_COLUMN = "STOCKDISS_LABEL_NAME";
	...
	private String stockdissLabelName;
	...
	private java.math.BigDecimal mainStreamCount;
	...
	/**
	 * stockdissLabelName取得.
	 * @return stockdissLabelName
	 */
	public String getStockdissLabelName() {
		return this.stockdissLabelName;
	}

	/**
	 * stockdissLabelName設定.
	 * @param stockdissLabelName stockdissLabelName
	 */
	public void setStockdissLabelName(final String stockdissLabelName) {
		this.stockdissLabelName = stockdissLabelName;
	}
	 ...
	 */
	public java.math.BigDecimal getMainStreamCount() {
		return this.mainStreamCount;
	}

	/**
	 * mainStreamCount設定.
	 * @param mainStreamCount mainStreamCount
	 */
	public void setMainStreamCount(final java.math.BigDecimal mainStreamCount) {
