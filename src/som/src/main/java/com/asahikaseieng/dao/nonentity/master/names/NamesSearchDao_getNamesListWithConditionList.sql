/*
 * コンボ用データリスト用SQL.(絞り込み条件付き in）
 *
 * entityName=Names
 * packageName=names
 * methodName=getNamesListWithConditionList.sql
 *
 */
...
AND NAME_CD in /*nameCd*/('1')
/*END*/

/*IF (name01 != null) && (name01 != "")*/
AND NAME01 in /*name01*/('1')
/*END*/

/*IF (name02 != null) && (name02 != "")*/
AND NAME02 in /*name02*/('1')
/*END*/

/*IF (name03 != null) && (name03 != "")*/
AND NAME03 in /*name03*/('1')
/*END*/
