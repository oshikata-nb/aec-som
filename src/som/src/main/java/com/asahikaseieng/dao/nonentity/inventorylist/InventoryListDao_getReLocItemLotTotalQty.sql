 ...
 * methodName=getLocItemLotTotalQty
 *
 */
...
AND (LOT_INVENTORY.ITEM_CD LIKE /*itemCd*/'%' OR ITEM_NAME LIKE /*itemCd*/'%')
/*END*/
...
/*IF (locationCd != null) && (locationCd != "")*/
AND LOT_INVENTORY.LOCATION_CD IN(SELECT LOCATION_CD FROM LOCATION WHERE UPPER_LOCATION_CD = /*locationCd*/'%')
/*END*/
