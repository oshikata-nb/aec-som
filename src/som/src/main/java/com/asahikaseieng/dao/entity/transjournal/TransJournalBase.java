 ...
 * Created on Sun Jul 12 18:24:45 JST 2009
 *
 * $copyright$
 *
 */
 ...
 * @author t0011036
 */
public class TransJournalBase implements Serializable {
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "TRANS_JOURNAL";


//	/** IDアノテーション denNo. */
//	public static final String denNo_ID = "assigned";
//	/** IDアノテーション denYmd. */
//	public static final String denYmd_ID = "assigned";
//	/** IDアノテーション gyoNo. */
//	public static final String gyoNo_ID = "assigned";
