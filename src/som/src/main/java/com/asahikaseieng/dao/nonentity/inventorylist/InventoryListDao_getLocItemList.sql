...
SELECT LOCATION_INVENTORY.LOCATION_CD, LOCATION_NAME, SUBSTR(LOCATION_NAME, 0, 8) SHORT_LOCATION_NAME, LOCATION_INVENTORY.ITEM_CD, ITEM_NAME, SUBSTR(ITEM_NAME, 0, 8) SHORT_ITEM_NAME, NULL LOT_NO, STYLE_OF_PACKING,
...
AND (LOCATION_INVENTORY.LOCATION_CD = /*condition.srhLocationCd*/'%' OR LOCATION_NAME = /*condition.srhLocationCd*/'%')
/*END*/
