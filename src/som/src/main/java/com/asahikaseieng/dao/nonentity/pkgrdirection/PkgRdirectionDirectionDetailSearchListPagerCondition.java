...
/**
 * 包装実績－製造指図明細ポップアップ画面一覧複数ページ制御クラス
 * @author tosco
 */
public class PkgRdirectionDirectionDetailSearchListPagerCondition extends DefaultThresholdPagerCondition {
	 ...
	 * コンストラクタ
	 */
	public PkgRdirectionDirectionDetailSearchListPagerCondition() {
	}
