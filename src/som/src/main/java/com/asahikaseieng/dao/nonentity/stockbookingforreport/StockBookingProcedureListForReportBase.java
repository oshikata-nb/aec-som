...
/**
 * StockBookingProcedureListForReportクラス.
 * @author kanri-user
 */
public class StockBookingProcedureListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public StockBookingProcedureListForReportBase() {
	}
