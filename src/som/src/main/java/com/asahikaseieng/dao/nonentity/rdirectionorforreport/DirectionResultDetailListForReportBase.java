...
/**
 * DirectionResultDetailListForReportクラス.
 * @author kanri-user
 */
public class DirectionResultDetailListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionResultDetailListForReportBase() {
	}
