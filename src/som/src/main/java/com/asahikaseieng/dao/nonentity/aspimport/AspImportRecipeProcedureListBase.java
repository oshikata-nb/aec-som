 ...
 * @author tosco
 */
public class AspImportRecipeProcedureListBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public AspImportRecipeProcedureListBase() {
	}
...
//	/** 包装予定数量 */
//	private BigDecimal wrappingQty;
...
//	/**
//	 * 包装予定数量取得
//	 * @return BigDecimal 包装予定数量
//	*/
//	public BigDecimal getWrappingQty() {
//		return this.wrappingQty;
//	}
//
//	/**
//	 * 包装予定数量設定
//	 * @param wrappingQty 包装予定数量
//	*/
//	public void setWrappingQty(final BigDecimal wrappingQty) {
