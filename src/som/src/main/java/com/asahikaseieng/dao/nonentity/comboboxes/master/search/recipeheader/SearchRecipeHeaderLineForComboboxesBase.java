...
/**
 * 製造指図－新規入力画面_生産工場コンボボックス_表示用データ格納クラス.
 *
 * @author tosco
 */
public class SearchRecipeHeaderLineForComboboxesBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public SearchRecipeHeaderLineForComboboxesBase() {
	}
