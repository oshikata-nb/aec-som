...
/**
 * RepManufactDirectionHeaderクラス.
 * @author kanri-user
 */
public class RepManufactDirectionHeaderBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public RepManufactDirectionHeaderBase() {
	}
	...
	public static final String seizotantoname_COLUMN = "SEIZOTANTONAME";

	/** COLUMNアノテーション senjotantoname */
	public static final String senjotantoname_COLUMN = "SENJOTANTONAME";

	/** COLUMNアノテーション mekkintantoname */
	public static final String mekkintantoname_COLUMN = "MEKKINTANTONAME";
