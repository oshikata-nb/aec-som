...
/**
 * PkgDirectionOrderFormulaListForReportクラス.
 * @author kanri-user
 */
public class PkgDirectionOrderFormulaListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionOrderFormulaListForReportBase() {
	}
