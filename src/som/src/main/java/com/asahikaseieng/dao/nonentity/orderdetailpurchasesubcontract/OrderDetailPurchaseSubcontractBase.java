...
/**
 * PurchaseSubcontractBaseクラス.
 * @author kanri-user
 */
public class OrderDetailPurchaseSubcontractBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public OrderDetailPurchaseSubcontractBase() {
	}
	...
	// /** IDアノテーション purchaseNo. */
	// public static final String purchaseNo_ID = "assigned";
