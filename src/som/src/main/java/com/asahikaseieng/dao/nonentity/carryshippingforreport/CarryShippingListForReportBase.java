...
/**
 * CarryShippingListForReportクラス.
 * @author kanri-user
 */
public class CarryShippingListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public CarryShippingListForReportBase() {
	}
	...
	/** COLUMNアノテーション shippingOrderSendComp */
	public static final String shippingOrderSendComp_COLUMN = "SHIPPING_ORDER_SEND_COMP";
	...
	private String shippingOrderSendComp;
	...
	/**
	 * shippingOrderSendComp取得.
	 * @return shippingOrderSendComp
	 */
	public String getShippingOrderSendComp() {
		return this.shippingOrderSendComp;
	}

	/**
	 * shippingOrderSendComp設定.
	 * @param shippingOrderSendComp shippingOrderSendComp
	 */
	public void setShippingOrderSendComp(final String shippingOrderSendComp) {
		this.shippingOrderSendComp = shippingOrderSendComp;
	}
