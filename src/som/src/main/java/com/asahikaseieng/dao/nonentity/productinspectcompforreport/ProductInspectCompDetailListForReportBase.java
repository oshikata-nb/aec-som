...
/**
 * ProductInspectCompDetailListForReportクラス.
 * @author kanri-user
 */
public class ProductInspectCompDetailListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public ProductInspectCompDetailListForReportBase() {
	}
