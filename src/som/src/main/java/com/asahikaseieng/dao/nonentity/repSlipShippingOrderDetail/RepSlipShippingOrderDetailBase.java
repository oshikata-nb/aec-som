...
/**
 * RepSlipShippingOrderDetailクラス.
 * @author kanri-user
 */
public class RepSlipShippingOrderDetailBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public RepSlipShippingOrderDetailBase() {
	}
	...
	/** COLUMNアノテーション shippingSum */
	public static final String shippingSum_COLUMN = "SHIPPING_SUM";
	...
	/** COLUMNアノテーション numberOfInsertionsOrder */
	public static final String numberOfInsertionsOrder_COLUMN = "NUMBER_OF_INSERTIONS_ORDER";

	/** COLUMNアノテーション numberOfInsertionsMatss */
	public static final String numberOfInsertionsMatss_COLUMN = "NUMBER_OF_INSERTIONS_MATSS";
	...
	private String shippingSum;

	private String orderQty;

	private String matss;

	private String numberOfInsertionsOrder;

	private String numberOfInsertionsMatss;
	 ...
	 */
	public void setSlipShippingScheduleComp(final String slipShippingScheduleComp) {
	 ...
	 */
	public void setSlipShippingScheduleDate(final String slipShippingScheduleDate) {
	 ...
	 * @return shippingSum
	 */
	public String getShippingSum() {
		return this.shippingSum;
	}

	/**
	 * shippingSum設定.
	 * @param shippingSum shippingSum
	 */
	public void setShippingSum(final String shippingSum) {
	...
	/**
	 * numberOfInsertionsOrder取得.
	 * @return numberOfInsertionsOrder
	 */
	public String getNumberOfInsertionsOrder() {
		return this.numberOfInsertionsOrder;
	}

	/**
	 * numberOfInsertionsOrder設定.
	 * @param numberOfInsertionsOrder numberOfInsertionsOrder
	 */
	public void setNumberOfInsertionsOrder(final String numberOfInsertionsOrder) {
		this.numberOfInsertionsOrder = numberOfInsertionsOrder;
	}

	/**
	 * numberOfInsertionsMatss取得.
	 * @return numberOfInsertionsMatss
	 */
	public String getNumberOfInsertionsMatss() {
		return this.numberOfInsertionsMatss;
	}

	/**
	 * numberOfInsertionsMatss設定.
	 * @param numberOfInsertionsMatss numberOfInsertionsMatss
	 */
	public void setNumberOfInsertionsMatss(final String numberOfInsertionsMatss) {
		this.numberOfInsertionsMatss = numberOfInsertionsMatss;
	}
