 ...
 * @author tosco
 */
public class PkgRdirectionListBase implements Serializable {
	...
	*/
	 ...
	 */
	public void setResultSdate(final java.sql.Timestamp planedSdate) {
		this.resultSdate = planedSdate;
	}
	 ...
	 */
	public void setResultEdate(final java.sql.Timestamp planedEdate) {
		this.resultEdate = planedEdate;
	}
