...
/**
 * OrderImportListPagerConditionクラス.
 * @author 
 */
public class OrderImportListPagerCondition extends DefaultThresholdPagerCondition {
	 ...
	 * コンストラクタ.
	 */
	public OrderImportListPagerCondition() {
	}
	...
	public void setSrhCtmOrderNo(String srhCtmOrderNo) {
		//0525 S.Fujimaki ％検索対応
		//this.srhCtmOrderNo = srhCtmOrderNo;
		this.srhCtmOrderNo = AecTextUtils.likeFilter(srhCtmOrderNo);
	}
	/**
	...
	public void setSrhAddress(String srhAddress) {
		...
		this.srhAddress = AecTextUtils.likeFilter(srhAddress);
	}
	/**
	...
	public void setSrhCarryBc(String srhCarryBc) {
		...
		this.srhCarryBc = AecTextUtils.likeFilter(srhCarryBc);
	}
	/**
	 * srhItemCdを取得します。
	 * @return srhItemCd
