...
/**
 * InoutMonthlyReportStatusBaseクラス.
 * @author kanri-user
 */
public class InoutMonthlyReportStatusBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public InoutMonthlyReportStatusBase() {
	}
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "INOUT_MONTHLY_REPORT_STATUS";
