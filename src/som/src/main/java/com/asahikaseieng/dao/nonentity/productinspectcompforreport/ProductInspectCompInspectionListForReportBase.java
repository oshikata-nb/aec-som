...
/**
 * ProductInspectCompInspectionListForReportクラス.
 * @author kanri-user
 */
public class ProductInspectCompInspectionListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public ProductInspectCompInspectionListForReportBase() {
	}
