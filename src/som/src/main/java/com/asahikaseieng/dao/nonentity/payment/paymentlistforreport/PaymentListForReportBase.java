...
/**
 * PaymentListForReportクラス.
 * @author t0011036
 */
public class PaymentListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PaymentListForReportBase() {
	}
	...
	/** COLUMNアノテーション debitAccountsName */
	public static final String debitAccountsName_COLUMN = "DEBIT_ACCOUNTS_NAME";

	/** COLUMNアノテーション creditSectionName */
	public static final String creditSectionName_COLUMN = "CREDIT_SECTION_NAME";

	/** COLUMNアノテーション creditAccountsName */
	public static final String creditAccountsName_COLUMN = "CREDIT_ACCOUNTS_NAME";
	...
	/** COLUMNアノテーション noteDivisionName */
	public static final String noteDivisionName_COLUMN = "NOTE_DIVISION_NAME";
	...
	private String debitAccountsName;

	private String creditSectionName;

	private String creditAccountsName;
	...
	private String noteDivisionName;
	...
	/**
	 * debitAccountsName取得.
	 * @return debitAccountsName
	 */
	public String getDebitAccountsName() {
		return this.debitAccountsName;
	}

	/**
	 * debitAccountsName設定.
	 * @param debitAccountsName debitAccountsName
	 */
	public void setDebitAccountsName(final String debitAccountsName) {
		this.debitAccountsName = debitAccountsName;
	}
	...
	/**
	 * creditAccountsName取得.
	 * @return creditAccountsName
	 */
	public String getCreditAccountsName() {
		return this.creditAccountsName;
	}

	/**
	 * creditAccountsName設定.
	 * @param creditAccountsName creditAccountsName
	 */
	public void setCreditAccountsName(final String creditAccountsName) {
		this.creditAccountsName = creditAccountsName;
	}
	...
	/**
	 * noteDivisionName取得.
	 * @return noteDivisionName
	 */
	public String getNoteDivisionName() {
		return this.noteDivisionName;
	}

	/**
	 * noteDivisionName設定.
	 * @param noteDivisionName noteDivisionName
	 */
	public void setNoteDivisionName(final String noteDivisionName) {
		this.noteDivisionName = noteDivisionName;
	}
