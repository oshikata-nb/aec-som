...
/**
 * DirectionResultHeaderListForReportクラス.
 * @author kanri-user
 */
public class DirectionResultHeaderListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionResultHeaderListForReportBase() {
	}
