 ...
 *
 *
 * entityName=InventoryLocationListForReport
 * packageName=inventorylistforreport
 * methodName=getLocationListForReport
 *
 */
SELECT
...
AND	LOCATION_INVENTORY.LOCATION_CD = /*condition.srhLocationCd*/'%'
/*END*/

/*IF (condition.srhLocationCd == null) || (condition.srhLocationCd == "")*/
AND	LOCATION_INVENTORY.LOCATION_CD IN (SELECT LOCATION_CD FROM LOCATION WHERE UPPER_LOCATION_CD IS NULL)
/*END*/
