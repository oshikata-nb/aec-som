...
/**
 * 包装指図－工程順序コンボボックス用データ.
 *
 * @author tosco
 */
public class PkgDirectionProcedureSetpNoForComboboxesBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionProcedureSetpNoForComboboxesBase() {
	}
