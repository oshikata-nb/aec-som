...
/**
 * DirectionOrderInspectionListForReportクラス.
 * @author kanri-user
 */
public class DirectionOrderInspectionListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionOrderInspectionListForReportBase() {
	}
