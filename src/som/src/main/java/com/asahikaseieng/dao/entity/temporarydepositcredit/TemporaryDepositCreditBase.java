 ...
 * Created on Fri Jan 08 08:30:51 JST 2010
 *
 * $copyright$
 *
 */
...
/**
 * TemporaryDepositCreditBaseクラス.
 * @author t0011036
 */
public class TemporaryDepositCreditBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public TemporaryDepositCreditBase() {
	}
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "TEMPORARY_DEPOSIT_CREDIT";


//	/** IDアノテーション creditNo. */
//	public static final String creditNo_ID = "assigned";
//	/** IDアノテーション rowNo. */
