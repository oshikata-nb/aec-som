...
/**
 * PkgRdirectionInspectionListForReportクラス.
 * @author kanri-user
 */
public class PkgRdirectionInspectionListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgRdirectionInspectionListForReportBase() {
	}
