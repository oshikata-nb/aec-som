...
/**
 * MidInspectCompDetailListForReportクラス.
 * @author kanri-user
 */
public class MidInspectCompDetailListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public MidInspectCompDetailListForReportBase() {
	}
