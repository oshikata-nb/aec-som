...
/**
 * ProductInspectCompHeaderListForReportクラス.
 * @author kanri-user
 */
public class ProductInspectCompHeaderListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public ProductInspectCompHeaderListForReportBase() {
	}
	...
	private java.math.BigDecimal lotInventoryQty;
	...
	/**
	 * lotInventoryQty取得.
	 * @return lotInventoryQty
	 */
	public java.math.BigDecimal getLotInventoryQty() {
		return this.lotInventoryQty;
	}

	/**
	 * lotInventoryQty設定.
	 * @param lotInventoryQty lotInventoryQty
	 */
	public void setLotInventoryQty(final java.math.BigDecimal lotInventoryQty) {
