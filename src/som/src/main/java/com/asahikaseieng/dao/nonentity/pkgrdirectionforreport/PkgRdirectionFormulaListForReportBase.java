...
/**
 * PkgRdirectionFormulaListForReportクラス.
 * @author kanri-user
 */
public class PkgRdirectionFormulaListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgRdirectionFormulaListForReportBase() {
	}
