 ...
 * @author tosco
 */
public class ClaimEraserCsmListBase implements Serializable {
	...
	/**
	 * 入金消込残を設定します。
	 * @param creditEraserAmount 入金消込残
	 */
