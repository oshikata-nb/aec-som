...
/**
 * MidInspectCompInspectionListForReportクラス.
 * @author kanri-user
 */
public class MidInspectCompInspectionListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public MidInspectCompInspectionListForReportBase() {
	}
