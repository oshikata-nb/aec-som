...
/**
 * StockBookingFormulaListForReportクラス.
 * @author kanri-user
 */
public class StockBookingFormulaListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public StockBookingFormulaListForReportBase() {
	}
