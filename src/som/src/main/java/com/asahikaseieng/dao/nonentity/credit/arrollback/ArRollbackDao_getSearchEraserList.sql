...
/*END*/
	AND		SALES.DELIVERY_UPDATE_DATE = /*cleditDate*/'2008/07/31'
	UNION ALL
	SELECT 	CREDIT.ORGANIZATION_CD
	,		CREDIT.DELIVERY_UPDATE_DATE
...
/*END*/
	AND		CREDIT.DELIVERY_UPDATE_DATE = /*cleditDate*/'2008/07/31'
	UNION ALL
...
/*END*/
	AND		PAYMENT.DELIVERY_UPDATE_DATE = /*cleditDate*/'2008/07/31'
	UNION ALL
	SELECT 	OFFSET_GROUP_DATA.ORGANIZATION_CD
	,		OFFSET_GROUP_DATA.DELIVERY_UPDATE_DATE
...
/*END*/
	AND		OFFSET_GROUP_DATA.DELIVERY_UPDATE_DATE = /*cleditDate*/'2008/07/31'
	UNION ALL
