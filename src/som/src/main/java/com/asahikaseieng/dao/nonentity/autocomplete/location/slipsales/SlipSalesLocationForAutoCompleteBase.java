...
/**
 * SlipSalesLocationForAutoCompleteBaseクラス.
 * @author tosco
 */
public class SlipSalesLocationForAutoCompleteBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public SlipSalesLocationForAutoCompleteBase() {
	}
