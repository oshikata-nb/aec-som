...
/**
 * SlipShippingCarryListForComboboxesBaseクラス.
 * @author 
 */
public class SlipShippingCarryListForComboboxesBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public SlipShippingCarryListForComboboxesBase() {
	}
