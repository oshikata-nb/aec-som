 ...
 * �i�ڕʈ��׏Ɖ�[�pSQL
 *
 * entityName=InventoryDrawingListForReport
 * packageName=inventorydrawinglistforreport
...
FROM INOUT_SOURCE, ITEM,ITEM PARENT_ITEM,
...
AND	ITEM.PARENT_ITEM_CD = PARENT_ITEM.ITEM_CD(+)
