...
SELECT
	ORGANIZATION_CD
,	VENDER_CD
,	PAYMENT_UPDATE_DATE AS PAYABLE_DATE
FROM
	(
	SELECT 	CREDIT.ORGANIZATION_CD
	,		CREDIT.VENDER_CD
	,		CREDIT.PAYMENT_UPDATE_DATE
...
/*END*/
	AND		CREDIT.PAYMENT_UPDATE_DATE = /*payableDate*/'2008/07/31'
	UNION ALL
...
/*END*/
	AND		PAYMENT.PAYMENT_UPDATE_DATE = /*payableDate*/'2008/07/31'
	UNION ALL
	SELECT 	OFFSET_GROUP_DATA.ORGANIZATION_CD
	,		OFFSET_GROUP_DATA.VENDER_CD
	,		OFFSET_GROUP_DATA.PAYMENT_UPDATE_DATE
...
/*END*/
	AND		OFFSET_GROUP_DATA.PAYMENT_UPDATE_DATE = /*payableDate*/'2008/07/31'
	)
