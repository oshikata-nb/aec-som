...
/**
 * PkgDirectionOrderProcedureListForReportクラス.
 * @author kanri-user
 */
public class PkgDirectionOrderProcedureListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionOrderProcedureListForReportBase() {
	}
