...
/**
 * RecipeProcedureBaseクラス.
 * @author kanri-user
 */
public class RecipeProcedureBase implements Serializable {
...
//	public static final String stepNo_ID = "assigned";
	...
	/** COLUMNアノテーション wrappingQty. */
	public static final String wrappingQty_COLUMN = "WRAPPING_QTY";
	...
	private java.math.BigDecimal wrappingQty;
	 ...
	 * @return wrappingQty
	 */
	public java.math.BigDecimal getWrappingQty() {
		return this.wrappingQty;
	}

	/**
	 * wrappingQty設定.
	 * @param wrappingQty wrappingQty
	 */
	public void setWrappingQty(final java.math.BigDecimal wrappingQty) {
		this.wrappingQty = wrappingQty;
	}
