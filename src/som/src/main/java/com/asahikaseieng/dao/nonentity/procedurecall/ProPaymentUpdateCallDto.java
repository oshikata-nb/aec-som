 ...
 * @author tosco
 */
public final class ProPaymentUpdateCallDto {

	/** Constructor */
	public ProPaymentUpdateCallDto() {
	}
	...
	/** pStrCompanyCd_PROCEDURE_PARAMETER */
	public static final String pStrCompanyCd_PROCEDURE_PARAMETER = "in";
	 ...
	 * @return String 会社コード
	 */
	public String getPStrCompanyCd() {
		return pStrCompanyCd;
	}

	/**
	 * 会社コード設定
	 * @param strCompanyCd 会社コード
	 */
	public void setPStrCompanyCd(final String strCompanyCd) {
		pStrCompanyCd = strCompanyCd;
	}
