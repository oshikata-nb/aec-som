 ...
 * 在庫移動入力詳細用SQL文
 *
 * entityName=InventoryMoveDetail
 * packageName=inventorymovedetail
 * methodName=getEntity
 *
 */

SELECT LOT_INVENTORY.ITEM_CD, ITEM_NAME, OTHER_COMPANY_CD1, STYLE_OF_PACKING, LOT_INVENTORY.LOCATION_CD OUT_LOCATION_CD, LOCATION_NAME OUT_LOCATION_NAME, LOT_NO, ALIAS_LOT_NO,
...
NVL(TYPE_DIVISION, 0) TYPE_DIVISION
