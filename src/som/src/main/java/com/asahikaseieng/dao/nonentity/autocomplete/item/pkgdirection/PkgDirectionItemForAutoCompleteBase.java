...
/**
 * PkgDirectionItemForAutoCompleteBaseクラス.
 * @author tosco
 */
public class PkgDirectionItemForAutoCompleteBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionItemForAutoCompleteBase() {
	}
