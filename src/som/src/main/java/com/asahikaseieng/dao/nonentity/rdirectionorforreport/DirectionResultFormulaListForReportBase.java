...
/**
 * DirectionResultFormulaListForReportクラス.
 * @author kanri-user
 */
public class DirectionResultFormulaListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionResultFormulaListForReportBase() {
	}
