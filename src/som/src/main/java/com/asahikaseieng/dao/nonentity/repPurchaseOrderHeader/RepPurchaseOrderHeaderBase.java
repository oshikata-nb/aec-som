...
/**
 * RepPurchaseOrderHeaderクラス.
 * @author kanri-user
 */
public class RepPurchaseOrderHeaderBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public RepPurchaseOrderHeaderBase() {
	}
	...
	/** COLUMNアノテーション orderSheetNoKao */
	public static final String orderSheetNoKao_COLUMN = "ORDER_SHEET_NO_KAO";
	...
	/** COLUMNアノテーション siCd */
	public static final String siCd_COLUMN = "SI_CD";

	/** COLUMNアノテーション siName */
	public static final String siName_COLUMN = "SI_NAME";

	/** COLUMNアノテーション siTantoName */
	public static final String siTantoName_COLUMN = "SI_TANTO_NAME";

	/** COLUMNアノテーション siTelNo */
	public static final String siTelNo_COLUMN = "SI_TEL_NO";

	/** COLUMNアノテーション siFaxNo */
	public static final String siFaxNo_COLUMN = "SI_FAX_NO";

	/** COLUMNアノテーション hName */
	public static final String hName_COLUMN = "H_NAME";

	/** COLUMNアノテーション hZipcodeNo */
	public static final String hZipcodeNo_COLUMN = "H_ZIPCODE_NO";

	/** COLUMNアノテーション hAddress */
	public static final String hAddress_COLUMN = "H_ADDRESS";

	/** COLUMNアノテーション hTelNo */
	public static final String hTelNo_COLUMN = "H_TEL_NO";

	/** COLUMNアノテーション hFaxNo */
	public static final String hFaxNo_COLUMN = "H_FAX_NO";

	/** COLUMNアノテーション hTBusyo */
	public static final String hTBusyo_COLUMN = "H_T_BUSYO";

	/** COLUMNアノテーション hTantoName */
	public static final String hTantoName_COLUMN = "H_TANTO_NAME";

	/** COLUMNアノテーション subcontractLaw */
	public static final String subcontractLaw_COLUMN = "SUBCONTRACT_LAW";

	/** COLUMNアノテーション masterRemark */
	public static final String masterRemark_COLUMN = "MASTER_REMARK";

	/** COLUMNアノテーション nohinName */
	public static final String nohinName_COLUMN = "NOHIN_NAME";

	/** COLUMNアノテーション nohinAddress */
	public static final String nohinAddress_COLUMN = "NOHIN_ADDRESS";

	/** COLUMNアノテーション nohinTelNo */
	public static final String nohinTelNo_COLUMN = "NOHIN_TEL_NO";

	//
	// インスタンスフィールド
	//

	private String orderSheetNoKao;
	...
	private String siTantoName;

	private String siTelNo;

	private String siFaxNo;

	private String hName;

	private String hZipcodeNo;

	private String hAddress;

	private String hTelNo;

	private String hFaxNo;

	private String hTBusyo;

	private String hTantoName;

	private java.math.BigDecimal subcontractLaw;

	private String masterRemark;

	private String nohinName;

	private String nohinAddress;

	private String nohinTelNo;
	...
	/**
	 * orderSheetNoKao取得.
	 * @return orderSheetNoKao
	 */
	public String getOrderSheetNoKao() {
		return this.orderSheetNoKao;
	}

	/**
	 * orderSheetNoKao設定.
	 * @param orderSheetNoKao orderSheetNoKao
	 */
	public void setOrderSheetNoKao(final String orderSheetNoKao) {
		this.orderSheetNoKao = orderSheetNoKao;
	}
	 ...
	 * @param siCd siCd
	 */
	public void setSiCd(final String siCd) {
		this.siCd = siCd;
	}
	 ...
	 * @param siName siName
	 */
	public void setSiName(final String siName) {
		this.siName = siName;
	}
	 ...
	 * @return siTantoName
	 */
	public String getSiTantoName() {
		return this.siTantoName;
	}

	/**
	 * siTantoName設定.
	 * @param siTantoName siTantoName
	 */
	public void setSiTantoName(final String siTantoName) {
		this.siTantoName = siTantoName;
	}
	 ...
	 * @return siTelNo
	 */
	public String getSiTelNo() {
		return this.siTelNo;
	}

	/**
	 * siTelNo設定.
	 * @param siTelNo siTelNo
	 */
	public void setSiTelNo(final String siTelNo) {
		this.siTelNo = siTelNo;
	}
	 ...
	 * @return siFaxNo
	 */
	public String getSiFaxNo() {
		return this.siFaxNo;
	}

	/**
	 * siFaxNo設定.
	 * @param siFaxNo siFaxNo
	 */
	public void setSiFaxNo(final String siFaxNo) {
		this.siFaxNo = siFaxNo;
	}
	 ...
	 * @return hZipcodeNo
	 */
	public String getHZipcodeNo() {
		return this.hZipcodeNo;
	}

	/**
	 * hZipcodeNo設定.
	 * @param hZipcodeNo hZipcodeNo
	 */
	public void setHZipcodeNo(final String hZipcodeNo) {
		this.hZipcodeNo = hZipcodeNo;
	}
	...
	/**
	 * hAddress設定.
	 * @param hAddress hAddress
	 */
	public void setHAddress(final String hAddress) {
	 ...
	 * @param hTelNo hTelNo
	 */
	public void setHTelNo(final String hTelNo) {
		this.hTelNo = hTelNo;
	}
	 ...
	 * @param hFaxNo hFaxNo
	 */
	public void setHFaxNo(final String hFaxNo) {
		this.hFaxNo = hFaxNo;
	}
	 ...
	 * @return hTBusyo
	 */
	public String getHTBusyo() {
		return this.hTBusyo;
	}

	/**
	 * hTBusyo設定.
	 * @param hTBusyo hTBusyo
	 */
	public void setHTBusyo(final String hTBusyo) {
		this.hTBusyo = hTBusyo;
	}
	 ...
	 * @return hTantoName
	 */
	public String getHTantoName() {
		return this.hTantoName;
	}

	/**
	 * hTantoName設定.
	 * @param hTantoName hTantoName
	 */
	public void setHTantoName(final String hTantoName) {
		this.hTantoName = hTantoName;
	}
	...
	/**
	 * masterRemark設定.
	 * @param masterRemark masterRemark
	 */
	public void setMasterRemark(final String masterRemark) {
	...
	public String getNohinName() {
		return this.nohinName;
	}

	/**
	 * nohinName設定.
	 * @param nohinName nohinName
	 */
	public void setNohinName(final String nohinName) {
		this.nohinName = nohinName;
	}
	 ...
	 * @return nohinAddress
	 */
	public String getNohinAddress() {
		return this.nohinAddress;
	}

	/**
	 * nohinAddress設定.
	 * @param nohinAddress nohinAddress
	 */
	public void setNohinAddress(final String nohinAddress) {
		this.nohinAddress = nohinAddress;
	}
	 ...
	 * @return nohinTelNo
	 */
	public String getNohinTelNo() {
		return this.nohinTelNo;
	}

	/**
	 * nohinTelNo設定.
	 * @param nohinTelNo nohinTelNo
	 */
	public void setNohinTelNo(final String nohinTelNo) {
		this.nohinTelNo = nohinTelNo;
	}
