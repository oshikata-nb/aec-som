 ...
 * @author tosco
 */
public class SlipShippingListPagerCondition extends DefaultThresholdPagerCondition {
	 ...
	 * コンストラクタ.
	 */
	public SlipShippingListPagerCondition() {
	}
	 ...
	 */
	public void setSrhScheduledShippingDateFrom(final Timestamp srhScheduledShippingDateFrom) {
	 ...
	 */
	public void setSrhScheduledShippingDateTo(final Timestamp srhScheduledShippingDateTo) {
	 ...
	 */
	public void setSrhSlipShippingOrderComp(final BigDecimal srhSlipShippingOrderComp) {
	 ...
	 */
	public void setSrhSlipShippingRequestComp(final BigDecimal srhSlipShippingRequestComp) {
		this.srhSlipShippingRequestComp = srhSlipShippingRequestComp;
	}
	
	/**
	 * srhSlipShippingFareCompを取得します。
	...
	/**
	 * srhShippingFareCompを設定します。
	 * @param srhSlipShippingFareComp srhSlipShippingFareComp
	 */
	public void setSrhSlipShippingFareComp(final BigDecimal srhSlipShippingFareComp) {
	 ...
	 */
	public void setSrhSlipShippingScheduleComp(final BigDecimal srhSlipShippingScheduleComp) {
	 ...
	 */
	public void setSrhSlipShippingTagComp(final BigDecimal srhSlipShippingTagComp) {
