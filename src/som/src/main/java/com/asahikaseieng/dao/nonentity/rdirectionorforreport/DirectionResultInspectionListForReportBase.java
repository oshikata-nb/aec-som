...
/**
 * DirectionResultInspectionListForReportクラス.
 * @author kanri-user
 */
public class DirectionResultInspectionListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionResultInspectionListForReportBase() {
	}
