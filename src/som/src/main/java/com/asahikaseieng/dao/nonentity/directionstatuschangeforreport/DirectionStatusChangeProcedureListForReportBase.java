...
/**
 * DirectionStatusChangeProcedureListForReportクラス.
 * @author kanri-user
 */
public class DirectionStatusChangeProcedureListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionStatusChangeProcedureListForReportBase() {
	}
