...
/**
 * PkgRdirectionProcedureListForReportクラス.
 * @author kanri-user
 */
public class PkgRdirectionProcedureListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgRdirectionProcedureListForReportBase() {
	}
