 ...
 * @author tosco
 */
public class PurchaseOrderPagerCondition extends DefaultThresholdPagerCondition {
	 ...
	 * コンストラクタ.
	 */
	public PurchaseOrderPagerCondition() {
	}
	 ...
	 */
	public void setSrhSuggestedDeliverlimitDateTo(final String srhSuggestedDeliverlimitDateTo) {
