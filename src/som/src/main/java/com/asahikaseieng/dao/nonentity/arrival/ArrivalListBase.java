 ...
 * @author tosco
 */
public class ArrivalListBase implements Serializable {
	...
	*/
	...
	/**
	 * 引当明細FLG|0:なし 1:引当あり取得
	 * @return BigDecimal 引当明細FLG|0:なし 1:引当あり
	*/
	...
	/**
	 * 引当明細FLG|0:なし 1:引当あり設定
	 * @param mortgageDetailFlg 引当明細FLG|0:なし 1:引当あり
	*/
