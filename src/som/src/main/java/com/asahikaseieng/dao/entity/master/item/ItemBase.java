/*
 * Created on Thu Jan 22 18:12:15 JST 2009
 *
 * $copyright$
 *
 */
...
public class ItemBase implements Serializable {
	...
	/** COLUMNアノテーション llc. */
	public static final String llc_COLUMN = "LLC";
	 ...
	 * @return llc
	 */
	public java.math.BigDecimal getLlc() {
		return this.llc;
	}
	 ...
	 * @param llc llc
	 */
	public void setLlc(final java.math.BigDecimal llc) {
		this.llc = llc;
	}
