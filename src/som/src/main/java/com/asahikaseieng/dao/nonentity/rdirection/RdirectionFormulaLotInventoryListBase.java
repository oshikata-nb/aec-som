...
/**
 * RdirectionFormulaLotInventoryListクラス.
 * @author t1344224
 */
public class RdirectionFormulaLotInventoryListBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public RdirectionFormulaLotInventoryListBase() {
	}
