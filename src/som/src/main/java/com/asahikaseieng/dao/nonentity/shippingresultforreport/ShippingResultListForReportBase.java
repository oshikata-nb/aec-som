...
/**
 * ShippingResultListForReportクラス.
 * @author kanri-user
 */
public class ShippingResultListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public ShippingResultListForReportBase() {
	}
	...
	private java.math.BigDecimal shippingInstructionSum;

	private java.math.BigDecimal shippingResultQuantitySum;
	...
	/**
	 * shippingInstructionSum取得.
	 * @return shippingInstructionSum
	 */
	public java.math.BigDecimal getShippingInstructionSum() {
		return this.shippingInstructionSum;
	}

	/**
	 * shippingInstructionSum設定.
	 * @param shippingInstructionSum shippingInstructionSum
	 */
	public void setShippingInstructionSum(
			final java.math.BigDecimal shippingInstructionSum) {
		this.shippingInstructionSum = shippingInstructionSum;
	}

	/**
	 * shippingResultQuantitySum取得.
	 * @return shippingResultQuantitySum
	 */
	public java.math.BigDecimal getShippingResultQuantitySum() {
		return this.shippingResultQuantitySum;
	}

	/**
	 * shippingResultQuantitySum設定.
	 * @param shippingResultQuantitySum shippingResultQuantitySum
	 */
	public void setShippingResultQuantitySum(
			final java.math.BigDecimal shippingResultQuantitySum) {
