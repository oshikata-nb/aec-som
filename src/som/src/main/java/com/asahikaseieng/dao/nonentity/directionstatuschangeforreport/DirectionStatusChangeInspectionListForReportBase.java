...
/**
 * DirectionStatusChangeInspectionListForReportクラス.
 * @author kanri-user
 */
public class DirectionStatusChangeInspectionListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionStatusChangeInspectionListForReportBase() {
	}
