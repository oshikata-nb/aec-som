...
/*IF (condition.srhAvailableFlg != "1")*/
SELECT LOCATION_INVENTORY.LOCATION_CD, LOCATION_NAME, SUBSTR(LOCATION_NAME, 0, 12) SHORT_LOCATION_NAME, LOCATION_INVENTORY.ITEM_CD, ITEM_NAME, SUBSTR(ITEM_NAME, 0, 8) SHORT_ITEM_NAME, NULL LOT_NO, STYLE_OF_PACKING,
...
/*IF (condition.srhLocationCd != null) && (condition.srhLocationCd != "")*/
AND LOCATION_INVENTORY.LOCATION_CD IN(SELECT LOCATION_CD FROM LOCATION WHERE UPPER_LOCATION_CD = /*condition.srhLocationCd*/'%')
/*END*/
