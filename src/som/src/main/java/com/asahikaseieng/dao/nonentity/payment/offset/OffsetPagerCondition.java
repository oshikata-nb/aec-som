 ...
 * @author tosco
 */
public class OffsetPagerCondition extends DefaultThresholdPagerCondition {
	...
	public void setSrhOrganizationName(final String srhOrganizationName) {
		this.srhOrganizationName = AecTextUtils.likeFilter(srhOrganizationName);
	}
