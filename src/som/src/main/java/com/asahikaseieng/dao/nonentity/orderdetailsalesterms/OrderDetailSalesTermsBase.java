...
/**
 * OrderDetailSalesTermsBaseクラス.
 * @author
 */
public class OrderDetailSalesTermsBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public OrderDetailSalesTermsBase() {
	}
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "SALES_TERMS";


//	/** IDアノテーション balanceCd. */
//	public static final String balanceCd_ID = "assigned";
//	/** IDアノテーション deliveryCd. */
//	public static final String deliveryCd_ID = "assigned";
//	/** IDアノテーション itemCd. */
