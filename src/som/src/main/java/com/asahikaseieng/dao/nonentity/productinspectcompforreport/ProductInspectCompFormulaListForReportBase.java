...
/**
 * ProductInspectCompFormulaListForReportクラス.
 * @author kanri-user
 */
public class ProductInspectCompFormulaListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public ProductInspectCompFormulaListForReportBase() {
	}
