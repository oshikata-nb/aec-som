...
SELECT
     ...
     , NVL( FRST_ORDER_DETAIL.VIEW_SEQ , FRST_ORDER_DETAIL.FRST_ORDER_ROW_NO ) AS FRST_ORDER_ROW_NO
     , FRST_ORDER_DETAIL.ORDER_IMP_NO
...
,   CASE
    ...
    , CASE WHEN FRST_ORDER_DETAIL.DEL_FLG = 1    THEN '削除'
     ...
     , FRST_ORDER_DETAIL.INPUT_DIVISION
     , FRST_ORDER_DETAIL.CUSTOMER_ORDER_DETAIL_NO
     , FRST_ORDER_DETAIL.INPUT_APPROVAL_DATE
     , FRST_ORDER_DETAIL.INPUT_APPROVER_CD
     , APP_LG.TANTO_NM AS INPUT_APPROVER_NAME
     , FRST_ORDER_DETAIL.DEL_DATE_SEND_DATE
     , FRST_ORDER_DETAIL.DEL_DATE_SENDER_CD
     , DELSEND_LG.TANTO_NM AS DEL_DATE_SENDER_NAME
     , FRST_ORDER_DETAIL.DELETE_DATE
     , FRST_ORDER_DETAIL.DEL_FLG
     , FRST_ORDER_DETAIL.CANCEL_QTY
     , FRST_ORDER_DETAIL.CANCEL_DATE
     , FRST_ORDER_DETAIL.CANCEL_FLG
     , FRST_ORDER_DETAIL.ERROR_FLG
     , FRST_ORDER_DETAIL.INPUT_DATE
     , FRST_ORDER_DETAIL.INPUTOR_CD
     , INP_LG.TANTO_NM AS INPUTOR_NAME
     , FRST_ORDER_DETAIL.UPDATE_DATE
     , FRST_ORDER_DETAIL.UPDATOR_CD
     , UPD_LG.TANTO_NM AS UPDATOR_NAME
     , ORDER_IMP_BASE.VENDER_GROUP_CD
     , ORDER_IMP_BASE.IMPORT_DATE
     , ORDER_IMP_BASE.TEMP_NO
     , ORDER_IMP_BASE.CELL_ROW_NUMBER
     , ORDER_IMP_BASE.CELL_COL_NUMBER
     , ORDER_IMP_BASE.CTM_ORDER_NO
     , ORDER_IMP_BASE.CTM_ORDER_ROW
     , ORDER_IMP_BASE.CTM_ORDER_DATE
     , ORDER_IMP_BASE.CTM_DELIVERLIMIT
     , ORDER_IMP_BASE.CTM_VENDER_CD_01
     , ORDER_IMP_BASE.CTM_VENDER_CD_02
     , ORDER_IMP_BASE.CTM_VENDER_CD_03
     , ORDER_IMP_BASE.CTM_VENDER_NAME_01
     , ORDER_IMP_BASE.CTM_VENDER_NAME_02
     , ORDER_IMP_BASE.CTM_VENDER_NAME_03
     , ORDER_IMP_BASE.CTM_DELIVERY_CD_01
     , ORDER_IMP_BASE.CTM_DELIVERY_CD_02
     , ORDER_IMP_BASE.CTM_DELIVERY_CD_03
     , ORDER_IMP_BASE.CTM_DELIVERY_NAME_01
     , ORDER_IMP_BASE.CTM_DELIVERY_NAME_02
     , ORDER_IMP_BASE.CTM_DELIVERY_NAME_03
     , ORDER_IMP_BASE.CTM_DELIVERY_ADDRESS_01
     , ORDER_IMP_BASE.CTM_DELIVERY_ADDRESS_02
     , ORDER_IMP_BASE.CTM_DELIVERY_ADDRESS_03
     , ORDER_IMP_BASE.CTM_DELIVERY_TEL_NO
     , ORDER_IMP_BASE.CTM_DELIVERY_FAX_NO
     , ORDER_IMP_BASE.CTM_DELIVERY_ZIP_CD
     ...
     , ORDER_IMP_BASE.CTM_MATSS
     , ORDER_IMP_BASE.CTM_ORDER_PIECE
...
LEFT JOIN 
    LOGIN UPD_LG 
ON 
    UPD_LG.TANTO_CD = FRST_ORDER_DETAIL.UPDATOR_CD
LEFT JOIN 
    LOGIN INP_LG 
ON 
    INP_LG.TANTO_CD = FRST_ORDER_DETAIL.INPUTOR_CD
LEFT JOIN 
    LOGIN APP_LG 
ON 
    APP_LG .TANTO_CD = FRST_ORDER_DETAIL.INPUT_APPROVER_CD

LEFT JOIN 
    LOGIN DELSEND_LG 
ON 
    DELSEND_LG .TANTO_CD = FRST_ORDER_DETAIL.DEL_DATE_SENDER_CD
LEFT JOIN 
    ORGANIZATION 
ON 
