...
/**
 * DirectionStatusChangeFormulaListForReportクラス.
 * @author kanri-user
 */
public class DirectionStatusChangeFormulaListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionStatusChangeFormulaListForReportBase() {
	}
	...
	/** COLUMNアノテーション firstLocationName */
	public static final String firstLocationName_COLUMN = "FIRST_LOCATION_NAME";

	/** COLUMNアノテーション nextLocationCd */
	public static final String nextLocationCd_COLUMN = "NEXT_LOCATION_CD";

	/** COLUMNアノテーション secondLocationName */
	public static final String secondLocationName_COLUMN = "SECOND_LOCATION_NAME";

	/** COLUMNアノテーション nextAfterLocationCd */
	public static final String nextAfterLocationCd_COLUMN = "NEXT_AFTER_LOCATION_CD";

	/** COLUMNアノテーション thirdLocationName */
	public static final String thirdLocationName_COLUMN = "THIRD_LOCATION_NAME";
	...
	private String thirdLocationName;
	...
	/**
	 * firstLocationName設定.
	 * @param firstLocationName firstLocationName
	 */
	public void setFirstLocationName(final String firstLocationName) {
	...
	/**
	 * secondLocationName設定.
	 * @param secondLocationName secondLocationName
	 */
	public void setSecondLocationName(final String secondLocationName) {
	...
	/**
	 * thirdLocationName取得.
	 * @return thirdLocationName
	 */
	public String getThirdLocationName() {
		return this.thirdLocationName;
	}

	/**
	 * thirdLocationName設定.
	 * @param thirdLocationName thirdLocationName
	 */
	public void setThirdLocationName(final String thirdLocationName) {
		this.thirdLocationName = thirdLocationName;
	}
