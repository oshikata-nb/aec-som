...
/**
 * ShippingDetailResultListForReportクラス.
 * @author kanri-user
 */
public class ShippingDetailResultListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public ShippingDetailResultListForReportBase() {
	}
