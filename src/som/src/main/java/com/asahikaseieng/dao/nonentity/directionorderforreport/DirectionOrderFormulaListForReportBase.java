...
/**
 * DirectionOrderFormulaListForReportクラス.
 * @author kanri-user
 */
public class DirectionOrderFormulaListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionOrderFormulaListForReportBase() {
	}
