...
/**
 * PkgDirectionOrderDetailListForReportクラス.
 * @author kanri-user
 */
public class PkgDirectionOrderDetailListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionOrderDetailListForReportBase() {
	}
