 ...
 * @author kanri-user
 */
public class RepLabelArrivalBase implements Serializable {
	...
	/** COLUMNアノテーション labelType */
	public static final String labelType_COLUMN = "LABEL_TYPE";
