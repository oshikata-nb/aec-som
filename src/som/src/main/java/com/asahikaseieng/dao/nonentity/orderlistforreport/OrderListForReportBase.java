 ...
 * @author kanri-user
 */
public class OrderListForReportBase implements Serializable {
	...
	// 納入先住所を追加 AEC佐藤 2020/05/08
	/** COLUMNアノテーション deliveryAddressFull */
	public static final String deliveryAddressull_COLUMN = "DELIVERY_ADDRESS_FULL";
	...
	// 納入先住所を追加 AEC佐藤 2020/05/08
	/**
	 * deliveryAddressFullを取得します。
	 * @return deliveryAddressFull
	 */
	public String getDeliveryAddressFull() {
		return deliveryAddressFull;
	}

	/**
	 * deliveryAddressFullを設定します。
	 * @param deliveryAddressFull deliveryAddressFull
	 */
	public void setDeliveryAddressFull(String deliveryAddressFull) {
		this.deliveryAddressFull = deliveryAddressFull;
	}
