/*
 * Created on Thu Apr 09 14:20:20 JST 2009
 *
 * $copyright$
 *
 */
...
/**
 * OrderDetailAspProductionBaseクラス.
 * @author kanri-user
 */
public class OrderDetailAspProductionBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public OrderDetailAspProductionBase() {
	}
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "ASP_PRODUCTION";
