...
/**
 * InventoryShippingoutListForReportクラス.
 * @author kanri-user
 */
public class InventoryShippingoutListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public InventoryShippingoutListForReportBase() {
	}
	...
	/** COLUMNアノテーション inventoryQtyKg */
	public static final String inventoryQtyKg_COLUMN = "INVENTORY_QTY_KG";
	...
	private java.math.BigDecimal inventoryQtyKg;
	 ...
	 */
	public java.math.BigDecimal getInventoryQtyKg() {
		return this.inventoryQtyKg;
	}

	/**
	 * inventoryQtyKg設定.
	 * @param inventoryQtyKg inventoryQtyKg
	 */
	public void setInventoryQtyKg(final java.math.BigDecimal inventoryQtyKg) {
