...
/**
 * DirectionResultProcedureListForReportクラス.
 * @author kanri-user
 */
public class DirectionResultProcedureListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionResultProcedureListForReportBase() {
	}
