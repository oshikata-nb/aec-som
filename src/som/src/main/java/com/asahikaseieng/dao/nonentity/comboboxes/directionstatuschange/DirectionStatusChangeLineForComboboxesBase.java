...
/**
 * 製造指図ステータス変更－生産ラインコンボボックス用データ.
 * @author tosco
 */
public class DirectionStatusChangeLineForComboboxesBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionStatusChangeLineForComboboxesBase() {
	}
