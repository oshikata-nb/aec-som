...
/**
 * SlipShippingLocationForAutoCompleteBaseクラス.
 * @author tosco
 */
public class SlipShippingLocationForAutoCompleteBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public SlipShippingLocationForAutoCompleteBase() {
	}
