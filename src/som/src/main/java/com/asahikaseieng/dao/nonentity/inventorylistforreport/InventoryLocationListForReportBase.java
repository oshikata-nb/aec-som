...
/**
 * InventoryLocationListForReportクラス.
 * @author kanri-user
 */
public class InventoryLocationListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public InventoryLocationListForReportBase() {
	}
	...
	/** COLUMNアノテーション fractionNum_COLUMN */
