 ...
 * packageName=buying
 * methodName=getStockingQuantityRelatedData
 *
 */
...
FROM
	...
	AND		QUANTITY_FROM <= /*stockingQuantity*/'10'
	AND		DECODE(QUANTITY_TO, 0, 9999999999999.9999999, QUANTITY_TO) >= /*stockingQuantity*/'10'
