...
/**
 * ShippingDetailBaseクラス.
 * @author kanri-user
 */
public class ShippingDetailBase implements Serializable {
...
//	/** IDアノテーション shippingRowNo. */
//	public static final String shippingRowNo_ID = "assigned";
