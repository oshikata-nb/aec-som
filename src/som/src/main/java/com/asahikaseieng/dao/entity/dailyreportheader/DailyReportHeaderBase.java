...
/**
 * DailyReportHeaderBaseクラス.
 * @author kanri-user
 */
public class DailyReportHeaderBase implements Serializable {
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "DAILY_REPORT_HEADER";
