 ...
 * Created on Mon Jun 15 11:29:12 JST 2009
 *
 * $copyright$
 *
 */
...
/**
 * TemporaryDepositHeaderBaseクラス.
 * @author a7710658
 */
public class TemporaryDepositHeaderBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public TemporaryDepositHeaderBase() {
	}
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "TEMPORARY_DEPOSIT_HEADER";


//	/** IDアノテーション depositNo. */
//	public static final String depositNo_ID = "assigned";
	 ...
	 */
	public void setOtherDepositAmount(final java.math.BigDecimal otherDepositAmount) {
	 ...
	 */
	public void setCreditSalesBreakdown(final java.math.BigDecimal creditSalesBreakdown) {
	 ...
	 */
	public void setAccruedDebitBreakdown(final java.math.BigDecimal accruedDebitBreakdown) {
