...
/**
 * 包装実績－製造指図明細ポップアップ画面データ格納クラス.
 * @author tosco
 */
public class PkgRdirectionDirectionDetailSearchList extends PkgRdirectionDirectionDetailSearchListBase {
	 ...
	 * コンストラクタ.
	 */
	public PkgRdirectionDirectionDetailSearchList() {
		super();
	}
