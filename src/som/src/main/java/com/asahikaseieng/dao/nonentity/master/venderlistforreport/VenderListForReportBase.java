...
/**
 * VenderListForReportクラス.
 * @author t0011036
 */
public class VenderListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public VenderListForReportBase() {
	}
	...
	/** COLUMNアノテーション otherBankMasterName */
	public static final String otherBankMasterName_COLUMN = "OTHER_BANK_MASTER_NAME";
	...
	private String otherBankMasterName;
	...
	/**
	 * otherBankMasterName取得.
	 * @return otherBankMasterName
	 */
	public String getOtherBankMasterName() {
		return this.otherBankMasterName;
	}

	/**
	 * otherBankMasterName設定.
	 * @param otherBankMasterName otherBankMasterName
	 */
	public void setOtherBankMasterName(final String otherBankMasterName) {
		this.otherBankMasterName = otherBankMasterName;
	}
