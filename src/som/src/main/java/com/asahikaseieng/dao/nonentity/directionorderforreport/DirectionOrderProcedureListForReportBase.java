...
/**
 * DirectionOrderProcedureListForReportクラス.
 * @author kanri-user
 */
public class DirectionOrderProcedureListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionOrderProcedureListForReportBase() {
	}
