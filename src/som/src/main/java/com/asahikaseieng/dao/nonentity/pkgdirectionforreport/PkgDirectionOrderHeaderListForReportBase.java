...
/**
 * PkgDirectionOrderHeaderListForReportクラス.
 * @author kanri-user
 */
public class PkgDirectionOrderHeaderListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionOrderHeaderListForReportBase() {
	}
	...
	/** COLUMNアノテーション productLabelFlagName */
	public static final String productLabelFlagName_COLUMN = "PRODUCT_LABEL_FLAG_NAME";
	...
	private String productLabelFlagName;
	...
	/**
	 * productLabelFlagName取得.
	 * @return productLabelFlagName
	 */
	public String getProductLabelFlagName() {
		return this.productLabelFlagName;
	}

	/**
	 * productLabelFlagName設定.
	 * @param productLabelFlagName productLabelFlagName
	 */
	public void setProductLabelFlagName(final String productLabelFlagName) {
		this.productLabelFlagName = productLabelFlagName;
	}
