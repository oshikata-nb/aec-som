 ...
 * @author tosco
 */
public class RecipeFormulaListBase implements Serializable {
	 ...
	 * @param proSeq proSeq
	 */
	public void setProSeq(final BigDecimal proSeq) {
		this.proSeq = proSeq;
	}
}
