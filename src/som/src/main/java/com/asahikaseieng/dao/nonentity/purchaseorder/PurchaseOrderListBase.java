 ...
 * @author tosco
 */
public class PurchaseOrderListBase implements Serializable {
	...
	/** COLUMNアノテーション 品目名称 */
	public static final String itmName_COLUMN = "ITM_NAME";

	/** COLUMNアノテーション 運用管理単位 */
	public static final String unitDiv_COLUMN = "UNIT_DIV";

	/** COLUMNアノテーション まとめ処理区分 */
	...
	/**
	 * 単価決定単位区分設定
	 * @param unitpriceDefineunit 単価決定単位区分
	 */
	...
	/**
	 * 引当明細FLG設定
	 * @param mortgageDetailFlg 引当明細FLG
	 */
	...
	public void setInspreceiptWaitQuantity(
			final BigDecimal inspreceiptWaitQuantity) {
	...
	/**
	 * 内示・確定区分設定
	 * @param advPurNoticeDecideDivision 内示・確定区分
	 */
	public void setAdvPurNoticeDecideDivision(
			final BigDecimal advPurNoticeDecideDivision) {
	...
	public void setOrderMortgagedQuantity(
			final BigDecimal orderMortgagedQuantity) {
	...
	public void setSumHousingConvertQuant(
			final BigDecimal sumHousingConvertQuant) {
	...
	public void setInspectWaitConvertQuantity(
			final BigDecimal inspectWaitConvertQuantity) {
	...
	/**
	 * 伝票発行済み区分設定
	 * @param slipIssueDivision 伝票発行済み区分
	 */
