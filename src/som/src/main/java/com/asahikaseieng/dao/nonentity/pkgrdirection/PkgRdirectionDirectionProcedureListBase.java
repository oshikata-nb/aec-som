 ...
 * @author tosco
 */
public class PkgRdirectionDirectionProcedureListBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public PkgRdirectionDirectionProcedureListBase() {
	}
	...
	*/
	...
	/**
	 * 実績温度取得.
	 * @return BigDecimal 実績温度
	 */
	public BigDecimal getResultConditionTemp() {
	 ...
	 */
	public void setResultConditionTemp(final BigDecimal resultConditionTemp) {
		this.resultConditionTemp = resultConditionTemp;
	}

	/**
	 * 実績攪拌速度取得.
	 * @return BigDecimal 実績攪拌速度
	 */
	public BigDecimal getResultStirSpeed() {
	 ...
	 */
	public void setResultStirSpeed(final BigDecimal resultStirSpeed) {
		this.resultStirSpeed = resultStirSpeed;
	}

	/**
	 * 実績ｐＨ取得.
	 * @return BigDecimal 実績ｐＨ
	 */
	public BigDecimal getResultPh() {
	 ...
	 * @param resultPh 実績ｐＨ
	 */
	public void setResultPh(final BigDecimal resultPh) {
