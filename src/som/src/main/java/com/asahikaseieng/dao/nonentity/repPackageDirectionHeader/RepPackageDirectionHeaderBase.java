...
/**
 * RepPackageDirectionHeaderクラス.
 * @author kanri-user
 */
public class RepPackageDirectionHeaderBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public RepPackageDirectionHeaderBase() {
	}
	...
	/** COLUMNアノテーション hItemName */
	public static final String hItemName_COLUMN = "H_ITEM_NAME";

	/** COLUMNアノテーション hStyleOfPacking */
	public static final String hStyleOfPacking_COLUMN = "H_STYLE_OF_PACKING";
	...
	/** COLUMNアノテーション pResultSdate */
	public static final String pResultSdate_COLUMN = "P_RESULT_SDATE";
	...
	/** COLUMNアノテーション sItemName */
	public static final String sItemName_COLUMN = "S_ITEM_NAME";

	/** COLUMNアノテーション sStyleOfPacking */
	public static final String sStyleOfPacking_COLUMN = "S_STYLE_OF_PACKING";

	/** COLUMNアノテーション sFillResultQty */
	public static final String sFillResultQty_COLUMN = "S_FILL_RESULT_QTY";

	/** COLUMNアノテーション sResultQty */
	public static final String sResultQty_COLUMN = "S_RESULT_QTY";
	...
	private String hStyleOfPacking;
	...
	private java.sql.Timestamp pResultSdate;
	...
	private String sStyleOfPacking;

	private java.math.BigDecimal sFillResultQty;

	private java.math.BigDecimal sResultQty;
	 ...
	 */
	public void setDirectionDivision(
			final java.math.BigDecimal directionDivision) {
	 ...
	 */
	public void setMekkinTankTempMin(
			final java.math.BigDecimal mekkinTankTempMin) {
	 ...
	 */
	public void setMekkinTankTempMax(
			final java.math.BigDecimal mekkinTankTempMax) {
	 ...
	 */
	public void setProductRecordFlag(
			final java.math.BigDecimal productRecordFlag) {
	 ...
	 */
	public void setStockdissLabelFlag(
			final java.math.BigDecimal stockdissLabelFlag) {
	 ...
	 */
	public void setStockdissLabelDate(
			final java.sql.Timestamp stockdissLabelDate) {
	 ...
	 */
	public void setCertificationFlag(
			final java.math.BigDecimal certificationFlag) {
	...
	/**
	 * hItemName設定.
	 * @param hItemName hItemName
	 */
	public void setHItemName(final String hItemName) {
		this.hItemName = hItemName;
	}

	/**
	 * hStyleOfPacking取得.
	 * @return hStyleOfPacking
	 */
	public String getHStyleOfPacking() {
		return this.hStyleOfPacking;
	}

	/**
	 * hStyleOfPacking設定.
	 * @param hStyleOfPacking hStyleOfPacking
	 */
	public void setHStyleOfPacking(final String hStyleOfPacking) {
		this.hStyleOfPacking = hStyleOfPacking;
	}
	 ...
	 * @return pResultSdate
	 */
	public java.sql.Timestamp getPResultSdate() {
		return this.pResultSdate;
	}

	/**
	 * pResultSdate設定.
	 * @param pResultSdate pResultSdate
	 */
	public void setPResultSdate(final java.sql.Timestamp pResultSdate) {
		this.pResultSdate = pResultSdate;
	}
	...
	/**
	 * sStyleOfPacking取得.
	 * @return sStyleOfPacking
	 */
	public String getSStyleOfPacking() {
		return this.sStyleOfPacking;
	}

	/**
	 * sStyleOfPacking設定.
	 * @param sStyleOfPacking sStyleOfPacking
	 */
	public void setSStyleOfPacking(final String sStyleOfPacking) {
		this.sStyleOfPacking = sStyleOfPacking;
	}

	/**
	 * sFillResultQty取得.
	 * @return sFillResultQty
	 */
	public java.math.BigDecimal getSFillResultQty() {
		return this.sFillResultQty;
	}

	/**
	 * sFillResultQty設定.
	 * @param sFillResultQty sFillResultQty
	 */
	public void setSFillResultQty(final java.math.BigDecimal sFillResultQty) {
		this.sFillResultQty = sFillResultQty;
	}
	 ...
	 * @return sResultQty
	 */
	public java.math.BigDecimal getSResultQty() {
		return this.sResultQty;
	}

	/**
	 * sResultQty設定.
	 * @param sResultQty sResultQty
	 */
	public void setSResultQty(final java.math.BigDecimal sResultQty) {
		this.sResultQty = sResultQty;
	}
	 ...
	 */
	public void setOrderPattern(final String orderPattern) {
