...
/**
 * DirectionStatusChangeHeaderListForReportクラス.
 * @author kanri-user
 */
public class DirectionStatusChangeHeaderListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public DirectionStatusChangeHeaderListForReportBase() {
	}
