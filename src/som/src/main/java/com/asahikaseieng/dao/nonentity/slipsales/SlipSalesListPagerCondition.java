 ...
 * @author tosco
 */
public class SlipSalesListPagerCondition extends DefaultThresholdPagerCondition {
	 ...
	 * コンストラクタ.
	 */
	public SlipSalesListPagerCondition() {
	}
	 ...
	 */
	public void setSrhFaxOutput(final java.math.BigDecimal srhFaxOutput) {
