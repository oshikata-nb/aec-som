 ...
 * @author a1020630
 */
public final class ConvertOrderBaseDto {

	/** Constructor */
	public ConvertOrderBaseDto() {
	}
	...
	public static final String pVenderGroupCd_PROCEDURE_PARAMETER = "in";
	...
	/**
	 * pVenderGroupCdを取得します。
	 * @return pVenderGroupCd
	 */
	public String getpVenderGroupCd() {
		return pVenderGroupCd;
	}

	/**
	 * pVenderGroupCdを設定します。
	 * @param pVenderGroupCd pVenderGroupCd
	 */
	public void setpVenderGroupCd(String pVenderGroupCd) {
		this.pVenderGroupCd = pVenderGroupCd;
	}
