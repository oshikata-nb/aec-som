...
/**
 * BeforehandMeltLblDetailListForReportクラス.
 * @author kanri-user
 */
public class BeforehandMeltLblDetailListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public BeforehandMeltLblDetailListForReportBase() {
	}
