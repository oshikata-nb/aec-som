...
/**
 * DirectionDetailBaseクラス.
 * @author kanri-user
 */
public class DirectionDetailBase implements Serializable {
...
//	/** IDアノテーション pkgDirectionNo. */
//	public static final String pkgDirectionNo_ID = "assigned";
//	/** IDアノテーション rowNo. */
