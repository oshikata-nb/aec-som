 ...
 * @author tosco
 */
public interface ShippingOtherLotSearchListDao {

	/** BEANアノテーション */
	Class BEAN = com.asahikaseieng.dao.nonentity.shipping.ShippingOtherLotSearchList.class;
	 ...
	 */
	List<ShippingOtherLotSearchList> getSearchList(
