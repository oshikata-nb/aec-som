...
/**
 * BeforehandMeltLblFormulaListForReportクラス.
 * @author kanri-user
 */
public class BeforehandMeltLblFormulaListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public BeforehandMeltLblFormulaListForReportBase() {
	}
