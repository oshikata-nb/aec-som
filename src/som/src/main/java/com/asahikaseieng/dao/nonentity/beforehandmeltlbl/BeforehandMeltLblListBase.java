 ...
 * @author tosco
 */
public class BeforehandMeltLblListBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public BeforehandMeltLblListBase() {
	}
	...
	/** 現工程 */
	private BigDecimal currentStepNo;
	...
	*/
	...
	/**
	 * 現工程取得
	 * @return BigDecimal 現工程
	*/
	public BigDecimal getCurrentStepNo() {
	...
	*/
	public void setCurrentStepNo(final BigDecimal currentStepNo) {
	...
	*/
	...
	/**
	 * 物流入庫実績取得
	 * @return String 物流入庫実績
	*/
	public String getPdwResult() {
	...
	*/
	public void setPdwResult(final String pdwResult) {
	...
	*/
	...
	/**
	 * 製造/包装記録発行フラグ取得
	 * @return BigDecimal 製造/包装記録発行フラグ
	*/
	...
	/**
	 * 製造/包装記録発行フラグ設定
	 * @param productRecordFlag 製造/包装記録発行フラグ
	*/
	...
	*/
	...
	/**
	 * 予備溶解ラベル発行フラグ取得
	 * @return BigDecimal 予備溶解ラベル発行フラグ
	*/
	...
	/**
	 * 予備溶解ラベル発行フラグ設定
	 * @param stockdissLabelFlag 予備溶解ラベル発行フラグ
	*/
	...
	*/
	...
	/**
	 * 調合タンク内部状態設定
	 * @param chogotankcondi 調合タンク内部状態
	*/
	...
	*/
	...
	/**
	 * 予備溶解槽内部状態設定
	 * @param yobiyokaicondi 予備溶解槽内部状態
	*/
	...
	*/
	...
	/**
	 * ホールドタンク内部状態設定
	 * @param holdtankcondi ホールドタンク内部状態
	*/
