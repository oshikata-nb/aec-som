...
, ITEM_QUEUE.SALES_TAX_CATEGORY
, ITEM_QUEUE.PURCHASE_TAX_CATEGORY
, ITEM_QUEUE.ITEM_DIVISION
...
ORDER BY ITEM_QUEUE.ITEM_CD, DECODE(ITEM_QUEUE.VERSION, ITEM.VERSION, 1, 0) DESC, ITEM_QUEUE.ACTIVE_DATE DESC, ITEM_QUEUE.VERSION
