...
/**
 * TemporaryPayableCreditBaseクラス.
 * @author t0011036
 */
public class TemporaryPayableCreditBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public TemporaryPayableCreditBase() {
	}
	...
	/** TABLEアノテーション. */
	public static final String TABLE = "TEMPORARY_PAYABLE_CREDIT";
