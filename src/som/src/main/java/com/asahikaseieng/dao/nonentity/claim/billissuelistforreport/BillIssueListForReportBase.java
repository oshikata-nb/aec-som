...
/**
 * BillIssueListForReportクラス.
 * @author t0011036
 */
public class BillIssueListForReportBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public BillIssueListForReportBase() {
	}
	...
	private java.math.BigDecimal otherCreditAmount;

	private java.math.BigDecimal otherSales;

	private java.math.BigDecimal kbn;
	 ...
	 */
	public java.math.BigDecimal getOtherCreditAmount() {
		return this.otherCreditAmount;
	}

	/**
	 * otherCreditAmount設定.
	 * @param otherCreditAmount otherCreditAmount
	 */
	public void setOtherCreditAmount(
			final java.math.BigDecimal otherCreditAmount) {
	 ...
	 * @return kbn
	 */
	public java.math.BigDecimal getKbn() {
		return this.kbn;
	}
	 ...
	 * @param kbn kbn
	 */
	public void setKbn(final java.math.BigDecimal kbn) {
		this.kbn = kbn;
	}
