...
/**
 * ShippingLocationListForAutoCompleteクラス.
 * @author tosco
 */
public class ShippingLocationForAutoCompleteBase implements Serializable {
	 ...
	 * コンストラクタ.
	 */
	public ShippingLocationForAutoCompleteBase() {
	}
