 ...
 * @author t0011036
 */
public final class ArTransAction extends AbstractAction {

	private ArTransLogic arTransLogic;
	...
	public ActionForward init(final ActionMapping mapping,
		...
		ArTransForm frm = (ArTransForm) form;
	...
	public ActionForward insert(final ActionMapping mapping,
		...
		try {
			/* 実行 */
			arTransLogic.insert(organizationCd, inputDate,
	...
	public ActionForward create(final ActionMapping mapping,
		...
		try {
			/* CSVデータ検索 */
			frm.setSearchList(arTransLogic.getList(AecTextUtils.likeFilter(frm
	...
	public ActionForward downLoadCsvData(final ActionMapping mapping,
		...
		/* CSVデータ作成 */
		List<String> csvDataList = arTransLogic.getData(frm.getSearchList());
		...
		String fileName = rb.getString("csv.ar.trans.filename");
	...
	/**
	 * arTransLogicを設定します。
	 * @param arTransLogic arTransLogic
	 */
	public void setArTransLogic(final ArTransLogic arTransLogic) {
		this.arTransLogic = arTransLogic;
	}
}
