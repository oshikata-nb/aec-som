 ...
 * @author a7710658
 */
public class SelectResearchItem extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"研究用以外", "研究用"};

	/**
	 * コンストラクタ
	 */
	public SelectResearchItem() {
		setItem();
	}
	 ...
	 */
	public SelectResearchItem(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
