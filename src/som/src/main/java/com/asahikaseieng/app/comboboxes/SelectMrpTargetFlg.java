 ...
 * @author a7710658
 */
public class SelectMrpTargetFlg extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"通常", "対象外"};

	/**
	 * コンストラクタ
	 */
	public SelectMrpTargetFlg() {
		setItem();
	}
	 ...
	 */
	public SelectMrpTargetFlg(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
