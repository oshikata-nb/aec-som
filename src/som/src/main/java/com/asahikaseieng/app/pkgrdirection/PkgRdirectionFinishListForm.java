 ...
 * @author tosco
 */
public class PkgRdirectionFinishListForm extends AbstractPkgRdirectionForm {

	/** serialVersionUID */
	private static final long serialVersionUID = 1L;

	/** 検索結果リスト */
	private List<PkgRdirectionDirectionFormulaList> searchFinishList;
	 ...
	 * コンストラクタ
	 */
	public PkgRdirectionFinishListForm() {
	}
	 ...
	 */
	public List<PkgRdirectionDirectionFormulaList> getSearchFinishList() {
		return searchFinishList;
	}
	 ...
	 */
	public void setSearchFinishList(final List<PkgRdirectionDirectionFormulaList> searchFinishList) {
	...
	private void clearCheck() {
		if (getSearchFinishList() != null) {
			for (PkgRdirectionDirectionFormulaList bean : getSearchFinishList()) {
