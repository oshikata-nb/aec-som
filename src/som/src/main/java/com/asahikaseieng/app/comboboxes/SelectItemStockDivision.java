 ...
 * @author a7710658
 */
public class SelectItemStockDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3"};

	private String[] myLabel = {"通常", "在庫表除外", "更新除外"};

	/**
	 * コンストラクタ
	 */
	public SelectItemStockDivision() {
		setItem();
	}
	 ...
	 */
	public SelectItemStockDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
