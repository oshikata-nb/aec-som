...
/**
 * 運送会社マスタメンテ画面のバーコード発行区分コンボボックス
 * @author 
 */
public class SelectBcPublishDivision extends AbstractSelectComboBox {
	 ...
	 * コンストラクタ
	 */
	public SelectBcPublishDivision() {
		setItem();
	}
	 ...
	 */
	public SelectBcPublishDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
