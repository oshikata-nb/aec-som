...
/**
 * 製造記録ＥＸＣＥＬダウンロード用ファイル作成
 * @author t2712372
 */
public class RdirectionListExcelDecoratorImpl implements
		RdirectionListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public RdirectionListExcelDecoratorImpl() {
		super();
	...
	public FileDownloadInfo createReport(final String[] directionNo,
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("r_manufucture_direction");
