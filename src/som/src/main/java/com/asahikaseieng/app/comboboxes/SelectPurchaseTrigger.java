 ...
 * @author a7710658
 */
public class SelectPurchaseTrigger extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3"};

	private String[] myLabel = {"発注点", "MRP", "個別"};

	/**
	 * コンストラクタ
	 */
	public SelectPurchaseTrigger() {
		setItem();
	}
	 ...
	 */
	public SelectPurchaseTrigger(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
