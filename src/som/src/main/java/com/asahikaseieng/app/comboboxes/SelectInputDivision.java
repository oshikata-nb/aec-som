 ...
 * @author 
 */
public class SelectInputDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"ファイル取込", "画面入力"};

	/**
	 * コンストラクタ
	 */
	public SelectInputDivision() {
		setItem();
	}
	 ...
	 */
	public SelectInputDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
