 ...
 * @author tosco
 */
public class PkgDirectionProcedureListForm extends AbstractPkgDirectionForm {

	/** serialVersionUID */
	private static final long serialVersionUID = 1L;

	/** 検索結果リスト */
	private List<PkgDirectionDirectionProcedureList> searchProcList;
	 ...
	 * コンストラクタ
	 */
	public PkgDirectionProcedureListForm() {
	}
	 ...
	 */
	public List<PkgDirectionDirectionProcedureList> getSearchProcList() {
	 ...
	 */
	public void setSearchProcList(final List<PkgDirectionDirectionProcedureList> searchProcList) {
	...
	private void clearCheck() {
		if (getSearchProcList() != null) {
			for (PkgDirectionDirectionProcedureList bean : getSearchProcList()) {
