...
/**
 * 包装記録ＥＸＣＥＬダウンロード用ファイル作成
 * @author t2712372
 */
public class PkgRdirectionListExcelDecoratorImpl implements
		PkgRdirectionListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public PkgRdirectionListExcelDecoratorImpl() {
		super();
	...
	public FileDownloadInfo createReport(final String[] directionNo,
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("r_package_direction");
