...
/**
 * 出荷帳票画面の出荷ステータス用コンボボックスクラス
 * @author tosco
 */
public class SelectSlipShippingShippingStatus extends AbstractSelectComboBox {
	 ...
	 * コンストラクタ
	 */
	public SelectSlipShippingShippingStatus() {
		setItem();
	}
	 ...
	 */
	public SelectSlipShippingShippingStatus(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
