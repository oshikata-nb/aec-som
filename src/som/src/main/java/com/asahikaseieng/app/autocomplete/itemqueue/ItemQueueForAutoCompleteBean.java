...
/**
 * 品目マスタキューのオートコンプリート結果表示用Bean
 * @author tosco
 */
public class ItemQueueForAutoCompleteBean extends GeneralParameterBean {
	 ...
	 * コンストラクタ
	 */
	public ItemQueueForAutoCompleteBean() {
	}
	 ...
	 * @param name 名称
	 */
	public ItemQueueForAutoCompleteBean(final String code, final String name) {
		super(code, name);
	}
