 ...
 * @author tosco
 */
public final class MgrecipeProcedureListForm extends AbstractMgrecipeForm {

	private static final long serialVersionUID = 1L;

	/** 検索結果リスト */
	private List<RecipeProcedureList> searchProcList;
	 ...
	 * コンストラクタ.
	 */
	public MgrecipeProcedureListForm() {
}
	...
	protected void clear() {
		...
		if (!"reInit".equals(getOp())) {
			// 検索結果リスト
			setSearchProcList(new ArrayList<RecipeProcedureList>());
		}
		// 工程検索行番号
		setLine(null);
	}
	 ...
	 */
	public List<RecipeProcedureList> getSearchProcList() {
	 ...
	 */
	public void setSearchProcList(final List<RecipeProcedureList> searchProcList) {
	...
	private void clearCheck() {
		if (getSearchProcList() != null) {
			for (RecipeProcedureList bean : getSearchProcList()) {
