 ...
 * @author tosco
 */
public final class GrecipeFormulaDetailForm extends AbstractGrecipeForm {
	...
	/** 検索結果 */
	private GrecipeRecipeFormulaList detailBean;
	 ...
	 * コンストラクタ.
	 */
	public GrecipeFormulaDetailForm() {
	}
	...
	/**
	 * 検索結果Bean取得
	 * @return GrecipeRecipeFormulaList 検索結果Bean
	 */
	public GrecipeRecipeFormulaList getDetailBean() {
		return detailBean;
	}
	 ...
	 */
	public void setDetailBean(final GrecipeRecipeFormulaList detailBean) {
