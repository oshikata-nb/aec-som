 ...
 * @author a7710658
 */
public class SelectSpotDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"通常", "スポット"};

	/**
	 * コンストラクタ
	 */
	public SelectSpotDivision() {
		setItem();
	}
	 ...
	 */
	public SelectSpotDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
