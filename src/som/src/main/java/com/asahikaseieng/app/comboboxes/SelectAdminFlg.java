...
/**
 * 担当者マスタメンテ画面の管理者区分用コンボボックス
 * @author tosco
 */
public class SelectAdminFlg extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"一般", "システム運用者"};

	/**
	 * コンストラクタ
	 */
	public SelectAdminFlg() {
		setItem();
	}
	 ...
	 */
	public SelectAdminFlg(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
