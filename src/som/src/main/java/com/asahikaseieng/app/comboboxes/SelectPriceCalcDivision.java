 ...
 * @author a7710658
 */
public class SelectPriceCalcDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"個単価", "Kg単価"};

	/**
	 * コンストラクタ
	 */
	public SelectPriceCalcDivision() {
		setItem();
	}
	 ...
	 */
	public SelectPriceCalcDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
