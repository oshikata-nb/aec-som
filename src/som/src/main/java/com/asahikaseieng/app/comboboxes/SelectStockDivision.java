 ...
 * @author a7710658
 */
public class SelectStockDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3"};

	private String[] myLabel = {"通常", "預かり在庫", "在庫引当対象外"};

	/**
	 * コンストラクタ
	 */
	public SelectStockDivision() {
		setItem();
	}
	 ...
	 */
	public SelectStockDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
