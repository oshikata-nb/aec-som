 ...
 * @author a1041072
 */
public class SelectSalesVenderFaxDivision extends AbstractSelectComboBox {

	private String[] myValue = {"3", "1"};

	private String[] myLabel = {"郵送", "出力無"};

	/**
	 * コンストラクタ
	 */
	public SelectSalesVenderFaxDivision() {
		setItem();
	}
	 ...
	 */
	public SelectSalesVenderFaxDivision(final boolean zero,
