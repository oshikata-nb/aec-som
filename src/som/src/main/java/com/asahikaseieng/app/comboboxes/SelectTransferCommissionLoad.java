...
/**
 * 取引先マスタメンテ画面の振込手数料負担用コンボボックス
 * @author tosco
 */
public class SelectTransferCommissionLoad extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"相手先", "自社"};

	/**
	 * コンストラクタ
	 */
	public SelectTransferCommissionLoad() {
		setItem();
	}
	 ...
	 */
	public SelectTransferCommissionLoad(final boolean zero,
