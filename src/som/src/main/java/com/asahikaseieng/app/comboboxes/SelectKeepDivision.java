 ...
 * @author a7710658
 */
public class SelectKeepDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"通常品(出荷売上)", "預かり品(受注売上)"};

	/**
	 * コンストラクタ
	 */
	public SelectKeepDivision() {
		setItem();
	}
	 ...
	 */
	public SelectKeepDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
