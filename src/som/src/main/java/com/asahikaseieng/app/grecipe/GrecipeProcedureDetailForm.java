 ...
 * @author tosco
 */
public final class GrecipeProcedureDetailForm extends AbstractGrecipeForm {
	...
	/** 検索結果 */
	private GrecipeRecipeProcedureList detailBean;
	 ...
	 * コンストラクタ.
	 */
	public GrecipeProcedureDetailForm() {
	}
	 ...
	 */
	public GrecipeRecipeProcedureList getDetailBean() {
		return detailBean;
	}
	 ...
	 */
	public void setDetailBean(final GrecipeRecipeProcedureList detailBean) {
