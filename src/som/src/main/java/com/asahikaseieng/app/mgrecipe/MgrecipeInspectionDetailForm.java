 ...
 * @author tosco
 */
public final class MgrecipeInspectionDetailForm extends AbstractMgrecipeForm {
	...
	/** 検索結果 */
	private RecipeInspectionList detailBean;
	 ...
	 * コンストラクタ.
	 */
	public MgrecipeInspectionDetailForm() {
	}
	 ...
	 */
	public RecipeInspectionList getDetailBean() {
		return detailBean;
	}
	 ...
	 */
	public void setDetailBean(final RecipeInspectionList detailBean) {
