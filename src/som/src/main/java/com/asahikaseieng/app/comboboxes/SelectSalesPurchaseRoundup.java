...
/**
 * 取引先マスタメンテ画面の売上金額端数区分用コンボボックス
 * @author tosco
 */
public class SelectSalesPurchaseRoundup extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3", "4"};

	private String[] myLabel = {"切り捨て", "四捨五入", "切り上げ", "自社マスタ"};

	/**
	 * コンストラクタ
	 */
	public SelectSalesPurchaseRoundup() {
		setItem();
	}
	 ...
	 */
	public SelectSalesPurchaseRoundup(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
