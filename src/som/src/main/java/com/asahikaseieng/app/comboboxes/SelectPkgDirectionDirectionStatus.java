 ...
 * @author a7710658
 */
public class SelectPkgDirectionDirectionStatus extends AbstractSelectComboBox {

	private static final  String[] myValue = {"1", "2"};

	private static final  String[] myLabel = {"未確定", "指図書発行済"};

	/**
	 * コンストラクタ
	 */
	public SelectPkgDirectionDirectionStatus() {
		setItem();
	}
	 ...
	 */
	public SelectPkgDirectionDirectionStatus(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
