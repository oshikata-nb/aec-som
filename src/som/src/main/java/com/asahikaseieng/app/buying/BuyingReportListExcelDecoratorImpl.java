 ...
 * @author tosco
 */
public class BuyingReportListExcelDecoratorImpl implements
		BuyingReportListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public BuyingReportListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("buyinglist");
	 ...
	 */
	private void setReport(final BuyingListConditionForReport condition) {
		short sRow = TEMP_START_ROW;
		short sCol = TEMP_START_COL;
		/* シートをセット */
		builder.setSheet("purchaselist");

		List<BuyingListForReport> list = buyingListLogic
				.getReportList(condition);

		for (BuyingListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	/**
	 * buyingListLogicを設定します。
	 * @param buyingListLogic buyingListLogic
	 */
