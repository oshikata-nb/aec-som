 ...
 * @author tosco
 */
public class SelectPaymentDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3", "4"};

	private String[] myLabel = {"支払予定日別", "支払先別", "支払方法別", "銀行別"};

	/**
	 * コンストラクタ
	 */
	public SelectPaymentDivision() {
		setItem();
	}
	 ...
	 */
	public SelectPaymentDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
