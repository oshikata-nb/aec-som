...
/**
 * 原材料別入出庫一覧表　原料包材選択コンボボックス
 * @author t1344224
 */
public class SelectInoutMaterialDirectionDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"原料", "包材"};

	/**
	 * コンストラクタ
	 */
	public SelectInoutMaterialDirectionDivision() {
		setItem();
	}
	 ...
	 */
	public SelectInoutMaterialDirectionDivision(final boolean zero,
