 ...
 * @author tosco
 */
public final class PkgDirectionProcedureDetailForm extends AbstractPkgDirectionForm {
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionProcedureDetailForm() {
}
	...
	protected void clear() {
		...
		// 端数区分(RECIPE5)
		this.setRoundDivisionRecipe5(null);
	}
	...
	*/
	...
	public String getFixedUnitDiv() {
		return PkgDirectionConst.UNIT_DIV_RECIPE5;
	}
