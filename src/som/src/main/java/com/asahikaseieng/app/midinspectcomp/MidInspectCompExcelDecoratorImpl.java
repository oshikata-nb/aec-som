 ...
 * @author tosco
 */
public class MidInspectCompExcelDecoratorImpl implements
		MidInspectCompExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public MidInspectCompExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("midinspectcomplist");
	...
	private void setHeaderReport(
		...
		List<MidInspectCompHeaderListForReport> list = midInspectCompListLogic
		...
		for (MidInspectCompHeaderListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setDetailReport(
		...
		List<MidInspectCompDetailListForReport> list = midInspectCompListLogic
		...
		for (MidInspectCompDetailListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setProcedureReport(
		...
		List<MidInspectCompProcedureListForReport> list = midInspectCompListLogic
		...
		for (MidInspectCompProcedureListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setFormulaReport(
		...
		List<MidInspectCompFormulaListForReport> list = midInspectCompListLogic
		...
		for (MidInspectCompFormulaListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setInspectionReport(
		...
		List<MidInspectCompInspectionListForReport> list = midInspectCompListLogic
		...
		for (MidInspectCompInspectionListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	/**
	 * midInspectCompListLogicを設定します。
	 * @param midInspectCompListLogic midInspectCompListLogic
	 */
