 ...
 * @author
 */
public class SelectDirectionMaterialUsedShipperDivision extends
	 ...
	 * コンストラクタ
	 */
	public SelectDirectionMaterialUsedShipperDivision() {
		setItem();
	}
	 ...
	 */
	public SelectDirectionMaterialUsedShipperDivision(final boolean zero,
