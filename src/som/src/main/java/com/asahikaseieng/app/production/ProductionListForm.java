 ...
 * 
 */
public final class ProductionListForm extends AbstractSearchForm {
	...
	/** 帳票Excel検索用 */
	private ProductionListConditionForReport reportCondition;
	 ...
	 */
	public ProductionListConditionForReport getReportCondition() {
		return reportCondition;
	}
	...
	public void setReportCondition(
			final ProductionListConditionForReport reportCondition) {
