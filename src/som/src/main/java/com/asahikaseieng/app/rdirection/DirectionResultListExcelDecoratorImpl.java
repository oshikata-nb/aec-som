 ...
 * @author tosco
 */
public class DirectionResultListExcelDecoratorImpl implements
		DirectionResultListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public DirectionResultListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("directionresultlist");
	...
	private void setHeaderReport(
		...
		List<DirectionResultHeaderListForReport> list = rdirectionListLogic
		...
		for (DirectionResultHeaderListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setDetailReport(
		...
		List<DirectionResultDetailListForReport> list = rdirectionListLogic
		...
		for (DirectionResultDetailListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setProcedureReport(
		...
		List<DirectionResultProcedureListForReport> list = rdirectionListLogic
		...
		for (DirectionResultProcedureListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setFormulaReport(
		...
		List<DirectionResultFormulaListForReport> list = rdirectionListLogic
		...
		for (DirectionResultFormulaListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setInspectionReport(
		...
		List<DirectionResultInspectionListForReport> list = rdirectionListLogic
		...
		for (DirectionResultInspectionListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	/**
	 * rdirectionListLogicを設定します。
	 * @param rdirectionListLogic rdirectionListLogic
	 */
