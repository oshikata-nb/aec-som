 ...
 * @author t1344224
 */
public final class BuyingInoutSearchForm extends AbstractSearchForm {
	...
	/** 検索結果リスト */
	private List<BuyingInoutSearchList> searchList;

	static {
		PAGE_ROW = Integer.parseInt(Constants.RB_SYSTEM_PROPERTIES
				.getString("linage.search.buying.inout.search"));
		DATA_ROW = Integer.parseInt(Constants.RB_SYSTEM_PROPERTIES
				.getString("threshold.search.buying.inout.search"));
	}

	/**
	 * コンストラクタ.
	 */
	public BuyingInoutSearchForm() {
	}
	...
	protected Class getPagerConditionClass() {
		return BuyingInoutSearchListPagerCondition.class;
	}
	...
	public void clear() {
		/** 検索リストのクリア */
		setSearchList(new ArrayList<BuyingInoutSearchList>());
	...
	/**
	 * 検索結果取得.
	 * @return BuyingInoutSearchList 検索結果
	 */
	public List<BuyingInoutSearchList> getSearchList() {
		return searchList;
	}
	 ...
	 */
	public void setSearchList(final List<BuyingInoutSearchList> searchList) {
