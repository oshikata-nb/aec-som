...
/**
 * 取引先マスタメンテ画面の送信区分用コンボボックス
 * @author 
 */
public class SelectMailSendDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "9"};

	private String[] myLabel = {"送信する", "送信しない"};

	/**
	 * コンストラクタ
	 */
	public SelectMailSendDivision() {
		setItem();
	}
	 ...
	 */
	public SelectMailSendDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
