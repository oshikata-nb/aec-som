 ...
 * @author t1344224
 */
public class SelectInoutMaterialDeliveryDivision extends AbstractSelectComboBox {
	 ...
	 * コンストラクタ
	 */
	public SelectInoutMaterialDeliveryDivision() {
		setItem();
	}
	 ...
	 */
	public SelectInoutMaterialDeliveryDivision(final boolean zero,
