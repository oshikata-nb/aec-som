 ...
 * @author tosco
 */
public final class OrderDeliverySearchForm extends AbstractSearchForm {
	...
	/** 検索結果リスト */
	private List<OrderDeliverySearchList> searchList;
	 ...
	 * コンストラクタ.
	 */
	public OrderDeliverySearchForm() {
	}
	...
	protected Class getPagerConditionClass() {
		return OrderDeliverySearchListPagerCondition.class;
	}
	...
	public void clear() {
		...
		/** 検索リストのクリア */
		setSearchList(new ArrayList<OrderDeliverySearchList>());
	 ...
	 */
	public List<OrderDeliverySearchList> getSearchList() {
		return searchList;
	}
	 ...
	 */
	public void setSearchList(final List<OrderDeliverySearchList> searchList) {
