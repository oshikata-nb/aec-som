 ...
 * @author t1344224
 */
public class SelectNewTaxDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "3"};

	private String[] myLabel = {"外税", "非課税"};

	/**
	 * コンストラクタ
	 */
	public SelectNewTaxDivision() {
		setItem();
	}
	 ...
	 */
	public SelectNewTaxDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
