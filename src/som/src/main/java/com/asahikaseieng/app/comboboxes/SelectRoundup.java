...
/**
 * 取引先マスタメンテ画面の端数区分用コンボボックス
 * @author tosco
 */
public class SelectRoundup extends AbstractSelectComboBox {
	 ...
	 */
	public SelectRoundup(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
