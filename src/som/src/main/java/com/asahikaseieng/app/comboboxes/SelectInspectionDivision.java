 ...
 * @author a7710658
 */
public class SelectInspectionDivision extends AbstractSelectComboBox {

	private static final String[] myValue = {"1", "2", "3"};

	private static final String[] myLabel = {"規格", "指標", "参考"};

	/**
	 * コンストラクタ
	 */
	public SelectInspectionDivision() {
		setItem();
	}
	 ...
	 */
	public SelectInspectionDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
