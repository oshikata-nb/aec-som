...
/**
 * 受注ヘッダーテーブルの受注区分用コンボボックスクラス（出荷指図用）
 * @author tosco
 */
public class SelectShippingOrderDivision extends AbstractSelectComboBox {

	private static final String[] myValue = {"1", "2", "4"};

	private static final String[] myLabel = {"在庫引当", "受注生産", "例外出荷"};

	/**
	 * コンストラクタ
	 */
	public SelectShippingOrderDivision() {
		setItem();
	}
	 ...
	 */
	public SelectShippingOrderDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
