...
/**
 * 仕入先別単価マスタ 単価区分用コンボボックス
 * @author tosco
 */
public class SelectUnitpriceDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"個あたり", "Kgあたり"};

	/**
	 * コンストラクタ
	 */
	public SelectUnitpriceDivision() {
		setItem();
	}
	 ...
	 */
	public SelectUnitpriceDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
