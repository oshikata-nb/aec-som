 ...
 * @author tosco
 */
public class RdirectionInspectionListForm extends AbstractRdirectionForm {
	 ...
	 * コンストラクタ
	 */
	public RdirectionInspectionListForm() {
	}
	...
	/** 検索結果リスト */
	private List<RdirectionDirectionInspectionList> searchInspectionList;

	/** 検索結果リスト保存用 */
	private List<RdirectionDirectionInspectionList> saveSearchInspectionList;
	...
	private void validateSearchListUPD(final ActionErrors errors,
			final HttpServletRequest request) {
		List<RdirectionDirectionInspectionList> list = this
		...
		if (list == null) {
			...
			for (RdirectionDirectionInspectionList bean : list) {
				index++;
				// 数値指定なら
	...
	private void clearCheck() {
		if (getSearchInspectionList() != null) {
			for (RdirectionDirectionInspectionList bean : getSearchInspectionList()) {
	 ...
	 */
	public List<RdirectionDirectionInspectionList> getSearchInspectionList() {
		return searchInspectionList;
	}
	...
	public void setSearchInspectionList(
			final List<RdirectionDirectionInspectionList> searchInspectionList) {
		this.searchInspectionList = searchInspectionList;
	}

	/**
	 * 検索結果リスト保存用を取得する
	 * @return List<RdirectionDirectionInspectionList> 検索結果リスト保存用
	 */
	public List<RdirectionDirectionInspectionList> getSaveSearchInspectionList() {
	...
	public void setSaveSearchInspectionList(
			final List<RdirectionDirectionInspectionList> saveSearchInspectionList) {
