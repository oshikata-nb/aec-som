 ...
 * @author tosco
 */
public class SelectPaymentUpdate extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"仕入先締め", "自社締め"};

	/**
	 * コンストラクタ
	 */
	public SelectPaymentUpdate() {
		setItem();
	}
	 ...
	 */
	public SelectPaymentUpdate(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
