 ...
 * @author tosco
 */
public class DirectionOrderListExcelDecoratorImpl implements
		DirectionOrderListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public DirectionOrderListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("directionorderlist");
	...
	private void setHeaderReport(
		...
		List<DirectionOrderListForReport> list = directionListLogic
		...
		for (DirectionOrderListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setDetailReport(
		...
		List<DirectionOrderDetailListForReport> list = directionListLogic
		...
		for (DirectionOrderDetailListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setProcedureReport(
		...
		List<DirectionOrderProcedureListForReport> list = directionListLogic
		...
		for (DirectionOrderProcedureListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setFormulaReport(
		...
		List<DirectionOrderFormulaListForReport> list = directionListLogic
		...
		for (DirectionOrderFormulaListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setInspectionReport(
		...
		List<DirectionOrderInspectionListForReport> list = directionListLogic
		...
		for (DirectionOrderInspectionListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	/**
	 * directionListLogicを設定します。
	 * @param directionListLogic directionListLogic
	 */
