...
/**
 * 調合タンク底弁インターロック解除/再設定　指図ステータスコンボボックス
 * @author a7710658
 */
public class SelectTankLockDirectionStatus extends AbstractSelectComboBox {

	private static String[] myValue = {"3", "4", "5"};

	private static String[] myLabel = {"製造開始"	, "中間品最終検査待", "中間品最終検査済"};

	/**
	 * コンストラクタ
	 */
	public SelectTankLockDirectionStatus() {
		setItem();
	}
	 ...
	 */
	public SelectTankLockDirectionStatus(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
