 ...
 * @author t1344224
 */
public class SelectDirectionMaterialUsedDeliveryDivision extends
		AbstractSelectComboBox {

	private String[] myValue = {"2", "1"};
	 ...
	 * コンストラクタ
	 */
	public SelectDirectionMaterialUsedDeliveryDivision() {
		setItem();
	}
	 ...
	 */
	public SelectDirectionMaterialUsedDeliveryDivision(final boolean zero,
