 ...
 * @author a7710658
 */
public class SelectNameDivision extends AbstractSelectComboBox {

	private String[] myValue = {"UNIT", "TANA", "STDV"};

	private String[] myLabel = {"単位", "棚卸区分", "検査項目"};

	/**
	 * コンストラクタ
	 */
	public SelectNameDivision() {
		setItem();
	}
	 ...
	 */
	public SelectNameDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
