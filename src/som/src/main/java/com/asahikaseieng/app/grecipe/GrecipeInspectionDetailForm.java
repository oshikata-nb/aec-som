 ...
 * @author tosco
 */
public final class GrecipeInspectionDetailForm extends AbstractGrecipeForm {
	...
	/** 検索結果 */
	private GrecipeRecipeInspectionList detailBean;
	 ...
	 * コンストラクタ.
	 */
	public GrecipeInspectionDetailForm() {
	}
	 ...
	 */
	public GrecipeRecipeInspectionList getDetailBean() {
		return detailBean;
	}
	 ...
	 */
	public void setDetailBean(final GrecipeRecipeInspectionList detailBean) {
