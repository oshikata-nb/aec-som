 ...
 * @author tosco
 */
public class SelectOrderDelDateSend extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"未送信", "送信済"};

	/**
	 * コンストラクタ
	 */
	public SelectOrderDelDateSend() {
		setItem();
	}
	 ...
	 */
	public SelectOrderDelDateSend(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
