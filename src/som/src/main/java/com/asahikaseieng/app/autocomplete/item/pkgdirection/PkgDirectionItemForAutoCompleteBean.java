 ...
 * @author tosco
 */
public class PkgDirectionItemForAutoCompleteBean extends GeneralParameterBean {
	 ...
	 * コンストラクタ
	 */
	public PkgDirectionItemForAutoCompleteBean() {
	}
	 ...
	 * @param name 名称
	 */
	public PkgDirectionItemForAutoCompleteBean(final String code,
			final String name) {
		super(code, name);
	}
