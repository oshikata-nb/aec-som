...
/**
 * 生産計画入力画面用　社内製造品/外注品区分コンボボックス
 * @author 
 */
public class SelectProductionTypeDivision extends AbstractSelectComboBox {

	private static String[] myValue = {"1", "2"};

	private static String[] myLabel = {"社内製造品", "外注品"};

	/**
	 * コンストラクタ
	 */
	public SelectProductionTypeDivision() {
		setItem();
	}
	 ...
	 */
	public SelectProductionTypeDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
