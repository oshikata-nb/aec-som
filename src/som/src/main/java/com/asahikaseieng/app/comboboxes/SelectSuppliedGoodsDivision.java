 ...
 * @author a7710658
 */
public class SelectSuppliedGoodsDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3"};

	private String[] myLabel = {"なし", "無償", "有償"};

	/**
	 * コンストラクタ
	 */
	public SelectSuppliedGoodsDivision() {
		setItem();
	}
	 ...
	 */
	public SelectSuppliedGoodsDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
