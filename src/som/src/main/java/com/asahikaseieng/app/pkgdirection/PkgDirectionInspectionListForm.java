 ...
 * @author tosco
 */
public class PkgDirectionInspectionListForm extends AbstractPkgDirectionForm {
	...
	/** 検索結果リスト */
	private List<PkgDirectionDirectionInspectionList> searchInspectionList;

	/** 検索結果リスト保存用 */
	private List<PkgDirectionDirectionInspectionList> saveSearchInspectionList;


	/**
	 * コンストラクタ
	 */
	public PkgDirectionInspectionListForm() {
	}
	...
	private void clearCheck() {
		if (getSearchInspectionList() != null) {
			for (PkgDirectionDirectionInspectionList bean : getSearchInspectionList()) {
	 ...
	 */
	public List<PkgDirectionDirectionInspectionList> getSearchInspectionList() {
		return searchInspectionList;
	}
	 ...
	 */
	public void setSearchInspectionList(final List<PkgDirectionDirectionInspectionList> searchInspectionList) {
		this.searchInspectionList = searchInspectionList;
	}

	/**
	 * 検索結果リスト保存用を取得する
	 * @return List<PkgDirectionDirectionInspectionList> 検索結果リスト保存用
	 */
	public List<PkgDirectionDirectionInspectionList> getSaveSearchInspectionList() {
	...
	public void setSaveSearchInspectionList(
			final List<PkgDirectionDirectionInspectionList> saveSearchInspectionList) {
