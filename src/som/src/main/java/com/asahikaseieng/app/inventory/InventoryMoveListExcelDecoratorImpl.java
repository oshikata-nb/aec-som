 ...
 * @author t0011036
 */
public class InventoryMoveListExcelDecoratorImpl implements
		InventoryMoveListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public InventoryMoveListExcelDecoratorImpl() {
		super();
	}
	...
	public FileDownloadInfo createReport(
			final List<InventoryMoveListForReport> list, final String tantoNm,
			final Timestamp currentDate) {
		/* テンプレートをセット */
		builder.setWorkbookUrl("inventorymovelist");
	 ...
	 */
	private void setDetail(final List<InventoryMoveListForReport> list) {

		short sRow = TEMP_START_ROW;
		short sCol = TEMP_START_COL;
		/* シートをセット */
		builder.setSheet("inventorymovelist");
		...
		for (InventoryMoveListForReport bean : list) {
			sCol = TEMP_START_COL;
