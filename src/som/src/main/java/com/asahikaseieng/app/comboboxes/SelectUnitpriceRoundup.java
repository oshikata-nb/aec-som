...
/**
 * 取引先マスタメンテ画面の単価端数区分用コンボボックス
 * @author tosco
 */
public class SelectUnitpriceRoundup extends AbstractSelectComboBox {
	 ...
	 */
	public SelectUnitpriceRoundup(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
