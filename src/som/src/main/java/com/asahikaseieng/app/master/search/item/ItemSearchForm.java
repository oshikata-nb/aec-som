...
/**
 * 品目マスタ検索(ポップアップ) Formクラス.
 * @author tosco
 */
public final class ItemSearchForm extends AbstractSearchForm {
	...
	/** 検索結果リスト */
	private List<ItemSearchList> searchList;
	...
	protected Class getPagerConditionClass() {
		return ItemSearchListPagerCondition.class;
	}
	...
	public void reset(final ActionMapping mapping,
		...
		if ("init".equals(getOp())) {
			setSearchList(new ArrayList<ItemSearchList>());
			clear();
		}
	}
	 ...
	 */
	public List<ItemSearchList> getSearchList() {
		return searchList;
	}
	 ...
	 */
	public void setSearchList(final List<ItemSearchList> searchList) {
