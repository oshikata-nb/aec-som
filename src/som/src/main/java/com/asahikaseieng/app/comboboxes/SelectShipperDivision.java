 ...
 * @author a7710658
 */
public class SelectShipperDivision extends AbstractSelectComboBox {

	private String[] myValue = {"0", "1", "2", "3"};

	private String[] myLabel = {"自社", "花王", "OEM", "油脂"};

	/**
	 * コンストラクタ
	 */
	public SelectShipperDivision() {
		setItem();
	}
	 ...
	 */
	public SelectShipperDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
