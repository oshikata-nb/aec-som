 ...
 * @author a7710658
 */
public class SelectInspectionType extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3"};

	private String[] myLabel = {"無検査", "抜取検査", "全品検査"};

	/**
	 * コンストラクタ
	 */
	public SelectInspectionType() {
		setItem();
	}
	 ...
	 */
	public SelectInspectionType(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
