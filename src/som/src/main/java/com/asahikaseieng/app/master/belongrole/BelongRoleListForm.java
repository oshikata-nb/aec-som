 ...
 * @author t0011036
 */
public final class BelongRoleListForm extends AbstractSearchForm {
	...
	/* 所属・ロール組合せリスト */
	private List<BelongRoleList> searchList;

	/* 帳票Excel用検索条件 */
	private BelongRoleListConditionForReport condition;
	...
	protected Class getPagerConditionClass() {
		return BelongRoleListPagerCondition.class;
	}
	...
	public ActionErrors validate(final ActionMapping mapping,
		...
		if ("search".equals(getOp())) {
			...
			setSearchList(new ArrayList<BelongRoleList>());
		}
	 ...
	 * @return searchList
	 */
	public List<BelongRoleList> getSearchList() {
		return searchList;
	}
	 ...
	 */
	public void setSearchList(final List<BelongRoleList> searchList) {
	 ...
	 * @return condition
	 */
	public BelongRoleListConditionForReport getCondition() {
		return condition;
	}
	 ...
	 */
	public void setCondition(final BelongRoleListConditionForReport condition) {
