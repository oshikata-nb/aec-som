 ...
 * @author tosco
 */
public class ShippingLogicException extends Exception {
	 ...
	 * @param cause エラー原因
	 */
	public ShippingLogicException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param message エラーメッセージ
	 */
	public ShippingLogicException(final String message) {
		super(message);
	}
	 ...
	 * @param cause エラー原因
	 */
	public ShippingLogicException(final Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public ShippingLogicException(final String key, final String... objects) {
		this.key = key;
