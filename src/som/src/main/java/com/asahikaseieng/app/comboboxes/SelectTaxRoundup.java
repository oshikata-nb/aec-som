...
/**
 * 取引先マスタメンテ画面の消費税端数区分用コンボボックス
 * @author tosco
 */
public class SelectTaxRoundup extends AbstractSelectComboBox {
	 ...
	 */
	public SelectTaxRoundup(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
