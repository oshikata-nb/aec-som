...
/**
 * 取引先マスタメンテ画面の売上金額端数単位用コンボボックス
 * @author tosco
 */
public class SelectSalesPurchaseRoundupUnit extends AbstractSelectComboBox {
	 ...
	 * コンストラクタ
	 */
	public SelectSalesPurchaseRoundupUnit() {
		setItem();
	}
	 ...
	 */
	public SelectSalesPurchaseRoundupUnit(final boolean zero,
