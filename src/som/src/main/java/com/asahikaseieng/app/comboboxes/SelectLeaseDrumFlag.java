 ...
 * @author a7710658
 */
public class SelectLeaseDrumFlag extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"リースドラム以外", "リースドラム"};

	/**
	 * コンストラクタ
	 */
	public SelectLeaseDrumFlag() {
		setItem();
	}
	 ...
	 */
	public SelectLeaseDrumFlag(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
