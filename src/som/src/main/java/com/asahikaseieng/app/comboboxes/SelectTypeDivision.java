 ...
 * @author a7710658
 */
public class SelectTypeDivision extends AbstractSelectComboBox {

	private String[] myValue = {"0", "1", "2", "3", "4", "5", "6", "7", "9"};

	private String[] myLabel = {"製品", "原料", "包材", "中間品", "仕入直送品", "仕入在庫品",
			"外注品(直送)", "外注品(非直送)", "その他"};

	/**
	 * コンストラクタ
	 */
	public SelectTypeDivision() {
		setItem();
	}
	 ...
	 */
	public SelectTypeDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
