 ...
 * @author a7710658
 */
public class SelectAccountDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3"};

	private String[] myLabel = {"普通", "当座", "その他"};

	/**
	 * コンストラクタ
	 */
	public SelectAccountDivision() {
		setItem();
	}
	 ...
	 */
	public SelectAccountDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
