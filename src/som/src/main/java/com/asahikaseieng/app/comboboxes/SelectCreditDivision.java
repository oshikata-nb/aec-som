...
/**
 * 取引先マスタメンテ画面の区分用コンボボックス
 * @author tosco
 */
public class SelectCreditDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3", "4", "5", "6"};

	private String[] myLabel = {"小切手", "手形", "振込", "郵便振替", "現金", "売上割引"};

	/**
	 * コンストラクタ
	 */
	public SelectCreditDivision() {
		setItem();
	}
	 ...
	 */
	public SelectCreditDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
