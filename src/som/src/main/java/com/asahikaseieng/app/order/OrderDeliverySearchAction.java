 ...
 * @author tosco
 */
public final class OrderDeliverySearchAction extends AbstractSearchAction {

	/** 受注検索ロジッククラス */
	private OrderDeliverySearchLogic orderDeliverySearchLogic;
	 ...
	 * コンストラクタ.
	 */
	public OrderDeliverySearchAction() {
		super();
	}
	...
	protected ActionForward initImpl(final ActionMapping mapping,
		...
		OrderDeliverySearchForm frm = (OrderDeliverySearchForm) form;
	...
	protected ActionForward searchImpl(final ActionMapping mapping,
		...
		frm.setSearchList(new ArrayList<OrderDeliverySearchList>());

		// 検索条件を取得
		OrderDeliverySearchListPagerCondition condition = (OrderDeliverySearchListPagerCondition) frm
		...
		// 明細取得
		frm.setSearchList(orderDeliverySearchLogic.getList(condition));
	...
	/**
	 * 納入先検索ロジッククラスを設定します。
	 * @param orderDeliverySearchLogic 納入先検索ロジッククラス
	 */
	public void setOrderDeliverySearchLogic(
			final OrderDeliverySearchLogic orderDeliverySearchLogic) {
		this.orderDeliverySearchLogic = orderDeliverySearchLogic;
	}
}
