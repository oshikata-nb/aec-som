 ...
 * @author tosco
 */
public class SelectSlipPublishComp extends AbstractSelectComboBox {
	 ...
	 */
	public SelectSlipPublishComp(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
