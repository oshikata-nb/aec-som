 ...
 * @author tosco
 */
public class PkgDirectionOrderListExcelDecoratorImpl implements
		PkgDirectionOrderListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public PkgDirectionOrderListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("pkgdirectionorderlist");
	...
	private void setHeaderReport(
		...
		List<PkgDirectionOrderHeaderListForReport> list = pkgDirectionListLogic
		...
		for (PkgDirectionOrderHeaderListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setDetailReport(
		...
		List<PkgDirectionOrderDetailListForReport> list = pkgDirectionListLogic
		...
		for (PkgDirectionOrderDetailListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setProcedureReport(
		...
		List<PkgDirectionOrderProcedureListForReport> list = pkgDirectionListLogic
		...
		for (PkgDirectionOrderProcedureListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setFormulaReport(
		...
		List<PkgDirectionOrderFormulaListForReport> list = pkgDirectionListLogic
		...
		for (PkgDirectionOrderFormulaListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setInspectionReport(
		...
		List<PkgDirectionOrderInspectionListForReport> list = pkgDirectionListLogic
		...
		for (PkgDirectionOrderInspectionListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	/**
	 * pkgDirectionListLogicを設定します。
	 * @param pkgDirectionListLogic pkgDirectionListLogic
	 */
