 ...
 * @author tosco
 */
public class PurchaseOrderReportListExcelDecoratorImpl implements
		PurchaseOrderReportListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public PurchaseOrderReportListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("purchaseorderlist");
	 ...
	 */
	private void setReport(final PurchaseOrderListConditionForRepor condition) {
		short sRow = TEMP_START_ROW;
		short sCol = TEMP_START_COL;
		/* シートをセット */
		builder.setSheet("purchaselist");

		List<PurchaseOrderListForRepor> list = purchaseOrderListLogic
				.getReportList(condition);

		for (PurchaseOrderListForRepor bean : list) {
			sCol = TEMP_START_COL;
	...
	/**
	 * purchaseOrderListLogicを設定します。
	 * @param purchaseOrderListLogic purchaseOrderListLogic
	 */
	public void setPurchaseOrderListLogic(
