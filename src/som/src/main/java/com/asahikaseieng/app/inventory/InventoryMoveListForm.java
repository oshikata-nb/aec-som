 ...
 * @author FPC
 */
public final class InventoryMoveListForm extends AbstractSearchForm {
	...
	/* リスト */
	private List<InventoryMoveList> searchList;

	/* EXCELダウンロードフラグ */
	private boolean excelDownloadFlg;

	/* 帳票Excel検索条件 */
	private InventoryMoveListConditionForReport reportCondition;

	/**
	 * コンストラクタ.
	 */
	public InventoryMoveListForm() {
	}
	...
	protected Class getPagerConditionClass() {
		return InventoryMoveListPagerCondition.class;
	}
	...
	public ActionErrors validate(final ActionMapping mapping,
		...
		if ("search".equals(getOp())) {
			...
			setSearchList(new ArrayList<InventoryMoveList>());
		}
	 ...
	 * @return searchList
	 */
	public List<InventoryMoveList> getSearchList() {
		return searchList;
	}
	 ...
	 */
	public void setSearchList(final List<InventoryMoveList> searchList) {
	 ...
	 */
	public InventoryMoveListConditionForReport getReportCondition() {
		return reportCondition;
	}
	...
	public void setReportCondition(
			final InventoryMoveListConditionForReport reportCondition) {
