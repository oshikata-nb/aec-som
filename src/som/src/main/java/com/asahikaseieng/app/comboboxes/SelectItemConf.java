...
/**
 *　受注先データ得意先連携マスタの品目設定用コンボボックス
 * @author tosco
 */
public class SelectItemConf extends AbstractSelectComboBox {
	 ...
	 */
	public SelectItemConf(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
