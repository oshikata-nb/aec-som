 ...
 * @author tosco
 */
public abstract class AbstractPkgRdirectionForm extends AbstractForm {
	...
	/** 包装開始予定日時 */
	private String planedSdate;

	/** 包装終了予定日時 */
	private String planedEdate;
	...
	protected void clear() {
		...
		// 用途
		this.setRecipeUse(PkgRdirectionConst.OPERATION_RECIPE_USE_PACKAGE);
		//製品入出庫実績存在フラグ
	...
	public void setRecipeId(final String strRecipeId) {
		if (StringUtils.isEmpty(strRecipeId)) {
			this.recipeId = null;
		} else {
			this.recipeId = new BigDecimal(strRecipeId);
		}
	}
	 ...
	 */
	public void setPlanedSdate(final String planedSdate) {
	 ...
	 */
	public void setPlanedEdate(final String planedEdate) {
	...
	/**
	 * ステータス名称設定
	 * @param directionStatusName ステータス名称
	 */
