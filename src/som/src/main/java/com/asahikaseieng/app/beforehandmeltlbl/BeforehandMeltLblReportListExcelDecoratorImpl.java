 ...
 * @author tosco
 */
public class BeforehandMeltLblReportListExcelDecoratorImpl implements
		BeforehandMeltLblReportListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public BeforehandMeltLblReportListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("beforehandmeltlbl");
	...
	private void setHeaderReport(
		...
		List<BeforehandMeltLblListForReport> list = beforehandMeltLblListLogic
		...
		for (BeforehandMeltLblListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setDetailReport(
		...
		List<BeforehandMeltLblDetailListForReport> list = beforehandMeltLblListLogic
		...
		for (BeforehandMeltLblDetailListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setProcedureReport(
		...
		List<BeforehandMeltLblProcedureListForReport> list = beforehandMeltLblListLogic
		...
		for (BeforehandMeltLblProcedureListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setFormulaReport(
		...
		List<BeforehandMeltLblFormulaListForReport> list = beforehandMeltLblListLogic
		...
		for (BeforehandMeltLblFormulaListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setInspectionReport(
		...
		List<BeforehandMeltLblInspectionListForReport> list = beforehandMeltLblListLogic
		...
		for (BeforehandMeltLblInspectionListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	/**
	 * beforehandMeltLblListLogicを設定します。
	 * @param beforehandMeltLblListLogic beforehandMeltLblListLogic
	 */
