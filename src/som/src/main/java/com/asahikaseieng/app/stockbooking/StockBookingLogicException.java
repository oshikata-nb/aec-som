 ...
 * @author tosco
 */
public class StockBookingLogicException extends Exception {
	 ...
	 * コンストラクタ
	 */
	public StockBookingLogicException() {
		super();
	}
	 ...
	 * @param cause エラー原因
	 */
	public StockBookingLogicException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param message エラーメッセージ
	 */
	public StockBookingLogicException(final String message) {
		super(message);
	}
	 ...
	 * @param cause エラー原因
	 */
	public StockBookingLogicException(final Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public StockBookingLogicException(final String key, final String... objects) {
		this.key = key;
