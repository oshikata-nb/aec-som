 ...
 * @author tosco
 */
public final class ShippingResultLotSearchForm extends AbstractSearchForm {
	...
	/** 検索結果リスト */
	private List<ShippingResultLotSearchList> searchList;
	 ...
	 * コンストラクタ.
	 */
	public ShippingResultLotSearchForm() {
	}
	...
	protected Class getPagerConditionClass() {
		return ShippingResultLotSearchListPagerCondition.class;
	}
	...
	public void clear() {
		...
		/** 検索リストのクリア */
		setSearchList(new ArrayList<ShippingResultLotSearchList>());
	 ...
	 */
	public List<ShippingResultLotSearchList> getSearchList() {
		return searchList;
	}
	 ...
	 */
	public void setSearchList(final List<ShippingResultLotSearchList> searchList) {
