 ...
 * @author tosco
 */
public final class SalesLotSearchForm extends AbstractSearchForm {
	...
	/** 検索結果リスト */
	private List<SalesLotSearchList> searchList;
	...
	protected Class getPagerConditionClass() {
		return SalesLotSearchListPagerCondition.class;
	}
	...
	public void clear() {
		...
		/** 検索リストのクリア */
		setSearchList(new ArrayList<SalesLotSearchList>());
	...
	*/
	 ...
	 */
	public List<SalesLotSearchList> getSearchList() {
		return searchList;
	}
	 ...
	 */
	public void setSearchList(final List<SalesLotSearchList> searchList) {
