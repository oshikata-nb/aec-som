 ...
 * @author tosco
 */
public final class ShippingOtherLotSearchForm extends AbstractSearchForm {
	...
	/** 検索結果リスト */
	private List<ShippingOtherLotSearchList> searchList;
	 ...
	 * コンストラクタ.
	 */
	public ShippingOtherLotSearchForm() {
	}
	...
	protected Class getPagerConditionClass() {
		return ShippingOtherLotSearchListPagerCondition.class;
	}
	...
	public void clear() {
		...
		/** 検索リストのクリア */
		setSearchList(new ArrayList<ShippingOtherLotSearchList>());
	 ...
	 */
	public List<ShippingOtherLotSearchList> getSearchList() {
		return searchList;
	}
	 ...
	 */
	public void setSearchList(final List<ShippingOtherLotSearchList> searchList) {
