...
/**
 * 取引先マスタメンテ画面の伝票発行区分用コンボボックス
 * @author tosco
 */
public class SelectSlipPublish extends AbstractSelectComboBox {
	 ...
	 */
	public SelectSlipPublish(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
