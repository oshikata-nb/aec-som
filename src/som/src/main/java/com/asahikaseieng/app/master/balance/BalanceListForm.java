 ...
 * @author t0011036
 */
public final class BalanceListForm extends AbstractSearchForm {
	...
	/* 区分 */
	private BigDecimal srhBalanceType;
	...
	/* 帳票Excel用検索条件 */
	private BalanceListConditionForReport condition;
	 ...
	 * @return condition
	 */
	public BalanceListConditionForReport getCondition() {
		return condition;
	}
	 ...
	 */
	public void setCondition(final BalanceListConditionForReport condition) {
