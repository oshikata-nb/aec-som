 ...
 * @author tosco
 */
public class TankLockListExcelDecoratorImpl implements
		TankLockListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public TankLockListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("tanklocklist");
	 ...
	 */
	private void setHeaderReport(final TankLockListConditionForReport condition) {
		short sRow = TEMP_START_ROW;
		short sCol = TEMP_START_COL;
		/* シートをセット */
		builder.setSheet("direction_header");

		List<TankLockHeaderListForReport> list = tankLockListLogic
		...
		for (TankLockHeaderListForReport bean : list) {
			sCol = TEMP_START_COL;
			...
			builder.setExcelDataString(sRow, sCol++, bean.getInterlock());
	 ...
	 * @param condition condition
	 */
	private void setDetailReport(final TankLockListConditionForReport condition) {
		short sRow = TEMP_START_ROW;
		short sCol = TEMP_START_COL;
		/* シートをセット */
		builder.setSheet("direction_detail");

		List<TankLockDetailListForReport> list = tankLockListLogic
		...
		for (TankLockDetailListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setProcedureReport(
		...
		List<TankLockProcedureListForReport> list = tankLockListLogic
		...
		for (TankLockProcedureListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	 ...
	 * @param condition condition
	 */
	private void setFormulaReport(final TankLockListConditionForReport condition) {
		short sRow = TEMP_START_ROW;
		short sCol = TEMP_START_COL;
		/* シートをセット */
		builder.setSheet("direction_formula");

		List<TankLockFormulaListForReport> list = tankLockListLogic
		...
		for (TankLockFormulaListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setInspectionReport(
		...
		List<TankLockInspectionListForReport> list = tankLockListLogic
		...
		for (TankLockInspectionListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	/**
	 * tankLockListLogicを設定します。
	 * @param tankLockListLogic tankLockListLogic
	 */
