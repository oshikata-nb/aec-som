...
import com.asahikaseieng.dao.nonentity.debt.aptrans.ApTransJournalListDao;
import com.asahikaseieng.dao.nonentity.procedurecall.ProJournalApCallDto;
 ...
 * @author t0011036
 */
public class ApTransLogicImpl implements ApTransLogic {

	private ProcedureCallDao procedureCallDao;

	private ApTransJournalListDao apTransJournalListDao;

	/**
	 * コンストラクタ.
	 */
	public ApTransLogicImpl() {
	}
	...
	public void insert(final String organizationCd, final String inputDate,
		...
		ProJournalApCallDto dto = new ProJournalApCallDto();
		...
		try {
			procedureCallDao.proJournalAp(dto);
	 ...
	 */
	public List<ApTransJournalList> getList(final String inputDate)
			throws NoDataException {
		List<ApTransJournalList> list = apTransJournalListDao
				.getList(inputDate);
	 ...
	 * @return List<String>
	 */
	public List<String> getData(final List<ApTransJournalList> list) {
		List<String> csvDataList = new ArrayList<String>();
		String rcString = null;

		for (ApTransJournalList bean : list) {
	...
	/**
	 * apTransJournalListDaoを設定します。
	 * @param apTransJournalListDao apTransJournalListDao
	 */
	public void setApTransJournalListDao(
			final ApTransJournalListDao apTransJournalListDao) {
		this.apTransJournalListDao = apTransJournalListDao;
	}
}
