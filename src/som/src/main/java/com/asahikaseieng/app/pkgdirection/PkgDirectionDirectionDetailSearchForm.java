...
/**
 * 包装指図－製造指図明細ポップアップ画面 Formクラス.
 * @author tosco
 */
public final class PkgDirectionDirectionDetailSearchForm extends
		AbstractSearchForm {
	...
	/** 検索結果リスト */
	private List<PkgDirectionDirectionDetailSearchList> searchList;
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionDirectionDetailSearchForm() {
	}
	...
	protected Class getPagerConditionClass() {
		return PkgDirectionDirectionDetailSearchListPagerCondition.class;
	}
	...
	public void reset(final ActionMapping mapping,
		...
		if ("init".equals(getOp())) {
			setSearchList(new ArrayList<PkgDirectionDirectionDetailSearchList>());
		}
	}
	...
	public void setSearchList(
			final List<PkgDirectionDirectionDetailSearchList> searchList) {
