 ...
 * @author tosco
 */
public class SalesLogicException extends Exception {
	 ...
	 * @param cause エラー原因
	 */
	public SalesLogicException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param message エラーメッセージ
	 */
	public SalesLogicException(final String message) {
		super(message);
	}
	 ...
	 * @param cause エラー原因
	 */
	public SalesLogicException(final Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public SalesLogicException(final String key, final String... objects) {
		this.key = key;
