...
/**
 * 処方メンテ画面の承認ステータス用コンボボックス
 * @author tosco
 */
public class SelectApprovalStatus extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3"};

	private String[] myLabel = {"入力中", "承認依頼中", "承認済み"};

	/**
	 * コンストラクタ
	 */
	public SelectApprovalStatus() {
		setItem();
	}
	 ...
	 */
	public SelectApprovalStatus(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
