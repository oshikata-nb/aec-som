 ...
 * @author tosco
 */
public class SelectOrderDeliveryDivision extends AbstractSelectComboBox {

	private static final String[] myValue = {"1", "2"};

	private static final String[] myLabel = {"油脂", "化成品"};

	/**
	 * コンストラクタ
	 */
	public SelectOrderDeliveryDivision() {
		setItem();
	}
	 ...
	 */
	public SelectOrderDeliveryDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
