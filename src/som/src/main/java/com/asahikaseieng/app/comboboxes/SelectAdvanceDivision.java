...
/**
 * 取引先マスタメンテ画面の前受金区分用コンボボックス
 * @author tosco
 */
public class SelectAdvanceDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"対象でない", "対象"};

	/**
	 * コンストラクタ
	 */
	public SelectAdvanceDivision() {
		setItem();
	}
	 ...
	 */
	public SelectAdvanceDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
