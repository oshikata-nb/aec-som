 ...
 * @author tosco
 */
public class DirectionProcedureListForm extends AbstractDirectionForm {

	/** serialVersionUID */
	private static final long serialVersionUID = 1L;

	/** 検索結果リスト */
	private List<DirectionDirectionProcedureList> searchProcList;
	 ...
	 * コンストラクタ
	 */
	public DirectionProcedureListForm() {
	}
	...
	protected void clear() {
		...
		if (!"reInit".equals(getOp())) {
			// 検索結果リスト
			setSearchProcList(new ArrayList<DirectionDirectionProcedureList>());
		}
		// 工程検索行番号
		setLine(null);
	}
	 ...
	 */
	public List<DirectionDirectionProcedureList> getSearchProcList() {
	 ...
	 */
	public void setSearchProcList(final List<DirectionDirectionProcedureList> searchProcList) {
	...
	private void clearCheck() {
		if (getSearchProcList() != null) {
			for (DirectionDirectionProcedureList bean : getSearchProcList()) {
	...
	public String getRecipeUse() {
		return SelectRecipeUse.RECIPE_USE_PRODUCTION;
	}
