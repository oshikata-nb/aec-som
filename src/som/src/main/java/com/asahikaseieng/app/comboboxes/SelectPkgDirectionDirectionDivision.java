 ...
 * @author a7710658
 */
public class SelectPkgDirectionDirectionDivision extends AbstractSelectComboBox {
	 ...
	 * コンストラクタ
	 */
	public SelectPkgDirectionDirectionDivision() {
		setItem();
	}
	 ...
	 */
	public SelectPkgDirectionDirectionDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		this.zeroflg = zero;
