 ...
 * @author t2712372
 */
public class PkgRdirectionListLabelExcelDecoratorImpl implements
		PkgRdirectionListLabelExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public PkgRdirectionListLabelExcelDecoratorImpl() {
		super();
	...
	private void setHeader(final List<RepLabelProductDirection> headerList,
		...
		for (RepLabelProductDirection bean : headerList) {
			...
			// ラベル種別（指図/実績）
			builder.setCellValue(sRow, sCol++, "実績");
			// 製造指図区分
