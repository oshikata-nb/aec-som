 ...
 * @author a7710658
 */
public class SelectMultiSupplierDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"しない", "する"};

	/**
	 * コンストラクタ
	 */
	public SelectMultiSupplierDivision() {
		setItem();
	}
	 ...
	 */
	public SelectMultiSupplierDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
