...
/**
 * 取引先マスタメンテ画面の取引先区分用コンボボックス
 * @author tosco
 */
public class SelectVenderDivision extends AbstractSelectComboBox {

	private String[] myValue = {"TS", "SI"};

	private String[] myLabel = {"得意先", "仕入先"};

	/**
	 * コンストラクタ
	 */
	public SelectVenderDivision() {
		setItem();
	}
	 ...
	 */
	public SelectVenderDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
