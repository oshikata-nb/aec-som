 ...
 * @author tosco
 */
public class SelectQuantityRoundup extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3"};

	private String[] myLabel = {"切り捨て", "四捨五入", "切り上げ"};

	/**
	 * コンストラクタ
	 */
	public SelectQuantityRoundup() {
		setItem();
	}
	 ...
	 */
	public SelectQuantityRoundup(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
