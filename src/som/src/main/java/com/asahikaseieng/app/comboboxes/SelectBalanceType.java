 ...
 * @author a7710658
 */
public class SelectBalanceType extends AbstractSelectComboBox {
	 ...
	 */
	public SelectBalanceType(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
