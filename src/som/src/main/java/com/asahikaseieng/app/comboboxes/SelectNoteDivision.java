 ...
 * @author a7710658
 */
public class SelectNoteDivision extends AbstractSelectComboBox {

	/* 分類マスタ登録画面では ON or OFF のチェックの為 0 or 1 */
	private String[] myValue = {"0", "1"};

	private String[] myLabel = {"約束手形", "為替手形"};

	/**
	 * コンストラクタ
	 */
	public SelectNoteDivision() {
		setItem();
	}
	 ...
	 */
	public SelectNoteDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
