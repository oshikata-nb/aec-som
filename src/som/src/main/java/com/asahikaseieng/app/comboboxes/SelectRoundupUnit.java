...
/**
 * 取引先マスタメンテ画面の端数単位用コンボボックス
 * @author tosco
 */
public class SelectRoundupUnit extends AbstractSelectComboBox {
	 ...
	 */
	public SelectRoundupUnit(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
