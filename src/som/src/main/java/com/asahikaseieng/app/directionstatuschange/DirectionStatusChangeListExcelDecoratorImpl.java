 ...
 * @author tosco
 */
public class DirectionStatusChangeListExcelDecoratorImpl implements
		DirectionStatusChangeListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public DirectionStatusChangeListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("directionstatuschange");
	...
	private void setHeaderReport(
		...
		List<DirectionStatusChangeHeaderListForReport> list = directionStatusChangeListLogic
		...
		for (DirectionStatusChangeHeaderListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setDetailReport(
		...
		List<DirectionStatusChangeDetailListForReport> list = directionStatusChangeListLogic
		...
		for (DirectionStatusChangeDetailListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setProcedureReport(
		...
		List<DirectionStatusChangeProcedureListForReport> list = directionStatusChangeListLogic
		...
		for (DirectionStatusChangeProcedureListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setFormulaReport(
		...
		List<DirectionStatusChangeFormulaListForReport> list = directionStatusChangeListLogic
		...
		for (DirectionStatusChangeFormulaListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setInspectionReport(
		...
		List<DirectionStatusChangeInspectionListForReport> list = directionStatusChangeListLogic
		...
		for (DirectionStatusChangeInspectionListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	/**
	 * directionStatusChangeListLogicを設定します。
	 * @param directionStatusChangeListLogic directionStatusChangeListLogic
	 */
