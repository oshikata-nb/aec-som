 ...
 * @author tosco
 */
public class RdirectionFinishListForm extends AbstractRdirectionForm {

	/** serialVersionUID */
	private static final long serialVersionUID = 1L;

	/** 検索結果リスト */
	private List<RdirectionDirectionFormulaList> searchFinishList;
	 ...
	 * コンストラクタ
	 */
	public RdirectionFinishListForm() {
	}
	 ...
	 */
	public List<RdirectionDirectionFormulaList> getSearchFinishList() {
		return searchFinishList;
	}
	 ...
	 */
	public void setSearchFinishList(final List<RdirectionDirectionFormulaList> searchFinishList) {
	...
	private void clearCheck() {
		if (getSearchFinishList() != null) {
			for (RdirectionDirectionFormulaList bean : getSearchFinishList()) {
