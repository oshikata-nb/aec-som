 ...
 * @author tosco
 */
public class OrderImportLogicException extends Exception {
	 ...
	 * コンストラクタ
	 */
	public OrderImportLogicException() {
		super();
	}
	 ...
	 * @param cause エラー原因
	 */
	public OrderImportLogicException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param message エラーメッセージ
	 */
	public OrderImportLogicException(final String message) {
		super(message);
	}
	 ...
	 * @param cause エラー原因
	 */
	public OrderImportLogicException(final Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public OrderImportLogicException(final String key, final String... objects) {
		this.key = key;
