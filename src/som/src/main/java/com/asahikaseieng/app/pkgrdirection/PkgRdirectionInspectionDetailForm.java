 ...
 * @author tosco
 */
public final class PkgRdirectionInspectionDetailForm extends
	...
	/** 検索結果 */
	private PkgRdirectionDirectionInspectionList detailBean;
	 ...
	 * コンストラクタ.
	 */
	public PkgRdirectionInspectionDetailForm() {
	}
	...
	/**
	 * 検索結果Bean取得
	 * @return PkgRdirectionDirectionInspectionList 検索結果Bean
	 */
	public PkgRdirectionDirectionInspectionList getDetailBean() {
		return detailBean;
	}
	 ...
	 */
	public void setDetailBean(
			final PkgRdirectionDirectionInspectionList detailBean) {
