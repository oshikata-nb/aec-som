...
/**
 * 中間品検査完了入力画面用　指図ステータスコンボボックス
 * @author a7710658
 */
public class SelectMidInspectCompDirectionStatus extends AbstractSelectComboBox {

	private static String[] myValue = {"4", "5"};

	private static String[] myLabel = {"中間品最終検査待", "中間品最終検査済"};

	/**
	 * コンストラクタ
	 */
	public SelectMidInspectCompDirectionStatus() {
		setItem();
	}
	 ...
	 */
	public SelectMidInspectCompDirectionStatus(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
