 ...
 * @author t0011036
 */
public final class ItemRelatedForm extends AbstractForm {
	...
	/* 原処方リスト */
	private List<ItemRelatedGrecipeList> searchGrecipeList;

	/* 基本処方リスト */
	private List<ItemRelatedMgrecipeList> searchMgrecipeList;

	/**
	 * コンストラクタ.
	 */
	public ItemRelatedForm() {
	}
	...
	public void clear() {
		...
		setSearchGrecipeList(new ArrayList<ItemRelatedGrecipeList>());
		setSearchMgrecipeList(new ArrayList<ItemRelatedMgrecipeList>());
	}
	...
	/**
	 * searchGrecipeListを取得します。
	 * @return searchGrecipeList
	 */
	public List<ItemRelatedGrecipeList> getSearchGrecipeList() {
		return searchGrecipeList;
	}

	/**
	 * searchGrecipeListを設定します。
	 * @param searchGrecipeList searchGrecipeList
	 */
	public void setSearchGrecipeList(
			final List<ItemRelatedGrecipeList> searchGrecipeList) {
		this.searchGrecipeList = searchGrecipeList;
	}

	/**
	 * searchMgrecipeListを取得します。
	 * @return searchMgrecipeList
	 */
	public List<ItemRelatedMgrecipeList> getSearchMgrecipeList() {
		return searchMgrecipeList;
	}

	/**
	 * searchMgrecipeListを設定します。
	 * @param searchMgrecipeList searchMgrecipeList
	 */
	public void setSearchMgrecipeList(
			final List<ItemRelatedMgrecipeList> searchMgrecipeList) {
		this.searchMgrecipeList = searchMgrecipeList;
	}
