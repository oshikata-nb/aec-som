 ...
 * @author tosco
 */
public class ArrivalReportListExcelDecoratorImpl implements
		ArrivalReportListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public ArrivalReportListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("arrivallist");
	 ...
	 */
	private void setReport(final ArrivalListConditionForReport condition) {
		short sRow = TEMP_START_ROW;
		short sCol = TEMP_START_COL;
		/* シートをセット */
		builder.setSheet("purchaselist");

		List<ArrivalListForReport> list = arrivalListLogic
		...
		for (ArrivalListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	/**
	 * arrivalListLogicを設定します。
	 * @param arrivalListLogic arrivalListLogic
	 */
