 ...
 * @author tosco
 */
public final class MgrecipeInspectionListForm extends AbstractMgrecipeForm {
	...
	/** 検索結果リスト */
	private List<RecipeInspectionList> searchInspectionList;

	/** 検索結果リスト保存用 */
	private List<RecipeInspectionList> saveSearchInspectionList;
	 ...
	 * コンストラクタ.
	 */
	public MgrecipeInspectionListForm() {
	}
	...
	private void clearCheck() {
		if (getSearchInspectionList() != null) {
			for (RecipeInspectionList bean : getSearchInspectionList()) {
	...
	/**
	 * 検索結果リストを取得する
	 * @return List<RecipeInspectionList> 検索結果リスト
	 */
	public List<RecipeInspectionList> getSearchInspectionList() {
	...
	public void setSearchInspectionList(
			final List<RecipeInspectionList> searchInspectionList) {
		this.searchInspectionList = searchInspectionList;
	}

	/**
	 * 検索結果リスト保存用を取得する
	 * @return List<RecipeInspectionList> 検索結果リスト保存用
	 */
	public List<RecipeInspectionList> getSaveSearchInspectionList() {
	...
	public void setSaveSearchInspectionList(
			final List<RecipeInspectionList> saveSearchInspectionList) {
