 ...
 * @author tosco
 */
public final class ShippingLotSearchForm extends AbstractSearchForm {
	...
	/** 検索結果リスト */
	private List<ShippingLotSearchList> searchList;
	...
	protected Class getPagerConditionClass() {
		return ShippingLotSearchListPagerCondition.class;
	}
	...
	public void clear() {
		...
		/** 検索リストのクリア */
		setSearchList(new ArrayList<ShippingLotSearchList>());
	 ...
	 */
	public List<ShippingLotSearchList> getSearchList() {
		return searchList;
	}
	 ...
	 */
	public void setSearchList(final List<ShippingLotSearchList> searchList) {
