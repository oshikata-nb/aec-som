...
/**
 * 取引先マスタメンテ画面の単価端数単位用コンボボックス
 * @author tosco
 */
public class SelectUnitpriceRoundupUnit extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3", "4", "5", "6", "7", "8"};

	private String[] myLabel = {"1", "0.1", "0.01", "0.001", "0.0001",
			"0.00001", "0.000001", "自社マスタ"};

	/**
	 * コンストラクタ
	 */
	public SelectUnitpriceRoundupUnit() {
		setItem();
	}
	 ...
	 */
	public SelectUnitpriceRoundupUnit(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
