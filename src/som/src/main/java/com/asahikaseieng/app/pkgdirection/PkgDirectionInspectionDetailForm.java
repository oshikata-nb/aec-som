 ...
 * @author tosco
 */
public final class PkgDirectionInspectionDetailForm extends AbstractPkgDirectionForm {
	...
	/** 検索結果 */
	private PkgDirectionDirectionInspectionList detailBean;

	/** 製造指図検査-更新日時 */
	private Timestamp inspectionUpdateDate;
	 ...
	 * コンストラクタ.
	 */
	public PkgDirectionInspectionDetailForm() {
}
	...
	*/
	...
	/**
	 * 検索結果Bean取得
	 * @return PkgDirectionDirectionInspectionList 検索結果Bean
	 */
	public PkgDirectionDirectionInspectionList getDetailBean() {
		return detailBean;
	}
	 ...
	 */
	public void setDetailBean(final PkgDirectionDirectionInspectionList detailBean) {
		this.detailBean = detailBean;
	}

	/**
	 * 製造指図検査-更新日時を取得します。
	 * @return inspectionUpdateDate
	 */
	public Timestamp getInspectionUpdateDate() {
		return inspectionUpdateDate;
	}

	/**
	 * 製造指図検査-更新日時を設定します。
	 * @param inspectionUpdateDate 製造指図検査-更新日時
	 */
	public void setInspectionUpdateDate(final Timestamp inspectionUpdateDate) {
		this.inspectionUpdateDate = inspectionUpdateDate;
	}
}
