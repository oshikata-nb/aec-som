 ...
 * @author tosco
 */
public class PkgRdirectionReportListExcelDecoratorImpl implements
		PkgRdirectionReportListExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public PkgRdirectionReportListExcelDecoratorImpl() {
	}
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("pkgrdirectionlist");
	...
	private void setHeaderReport(
		...
		List<PkgRdirectionHeaderListForReport> list = pkgRdirectionListLogic
		...
		for (PkgRdirectionHeaderListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setDetailReport(
		...
		List<PkgRdirectionDetailListForReport> list = pkgRdirectionListLogic
		...
		for (PkgRdirectionDetailListForReport bean : list) {
			sCol = TEMP_START_COL;
	...
	private void setProcedureReport(
		...
		List<PkgRdirectionProcedureListForReport> list = pkgRdirectionListLogic
		...
		for (PkgRdirectionProcedureListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setFormulaReport(
		...
		List<PkgRdirectionFormulaListForReport> list = pkgRdirectionListLogic
		...
		for (PkgRdirectionFormulaListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	private void setInspectionReport(
		...
		List<PkgRdirectionInspectionListForReport> list = pkgRdirectionListLogic
		...
		for (PkgRdirectionInspectionListForReport bean : list) {
			sCol = TEMP_START_COL;
			builder.setExcelDataBigDecimal(sRow, sCol++, bean
					.getDirectionDivision());
			builder.setExcelDataString(sRow, sCol++, bean.getDirectionNo());
	...
	/**
	 * pkgRdirectionListLogicを設定します。
	 * @param pkgRdirectionListLogic pkgRdirectionListLogic
	 */
