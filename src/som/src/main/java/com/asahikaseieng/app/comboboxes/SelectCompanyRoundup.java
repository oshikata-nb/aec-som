 ...
 * @author tosco
 */
public class SelectCompanyRoundup extends AbstractSelectComboBox {
	 ...
	 */
	public SelectCompanyRoundup(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
