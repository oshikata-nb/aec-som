 ...
 * @author a7710658
 */
public class SelectLabelPublish extends AbstractSelectComboBox {

	private static String[] myValue = {"1", "2", "3"};

	private static String[] myLabel = {"なし", "荷札", "ペリカン荷札"};

	/**
	 * コンストラクタ
	 */
	public SelectLabelPublish() {
		setItem();
	}
	 ...
	 */
	public SelectLabelPublish(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
