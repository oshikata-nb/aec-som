 ...
 * @author t2712372
 */
public class PkgDirectionListMaterialExcelDecoratorImpl implements
		PkgDirectionListMaterialExcelDecorator {
	 ...
	 * コンストラクタ
	 */
	public PkgDirectionListMaterialExcelDecoratorImpl() {
		super();
	...
	public FileDownloadInfo createReport(
		...
		/* テンプレートをセット */
		builder.setWorkbookUrl("material_direction_h");
