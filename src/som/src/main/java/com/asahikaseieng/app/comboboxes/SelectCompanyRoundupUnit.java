 ...
 * @author tosco
 */
public class SelectCompanyRoundupUnit extends AbstractSelectComboBox {
	 ...
	 * コンストラクタ
	 */
	public SelectCompanyRoundupUnit() {
		setItem();
	}
	 ...
	 */
	public SelectCompanyRoundupUnit(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
