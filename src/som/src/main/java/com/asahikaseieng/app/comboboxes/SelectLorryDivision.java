 ...
 * @author a7710658
 */
public class SelectLorryDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"ローリー以外", "ローリー"};

	/**
	 * コンストラクタ
	 */
	public SelectLorryDivision() {
		setItem();
	}
	 ...
	 */
	public SelectLorryDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
