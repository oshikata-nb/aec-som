 ...
 * @author a7710658
 */
public class SelectItemStatus extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3", "4"};

	private String[] myLabel = {"入力中", "承認依頼中", "承認済み", "研究用"};
	 ...
	 */
	public SelectItemStatus(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
