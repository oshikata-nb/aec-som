 ...
 * @author a7710658
 */
public class SelectTaxDivision extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2", "3", "4"};

	private String[] myLabel = {"外税", "内税", "非課税", "自社マスタ"};

	/**
	 * コンストラクタ
	 */
	public SelectTaxDivision() {
		setItem();
	}
	 ...
	 */
	public SelectTaxDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
