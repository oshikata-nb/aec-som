 ...
 * @author 
 */
public class SelectInoutMaterialShipperDivision extends AbstractSelectComboBox {
	 ...
	 * コンストラクタ
	 */
	public SelectInoutMaterialShipperDivision() {
		setItem();
	}
	 ...
	 */
	public SelectInoutMaterialShipperDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
