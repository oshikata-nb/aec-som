 ...
 * @author a7710658
 */
public class SelectLotDivision extends AbstractSelectComboBox {
	 ...
	 */
	public SelectLotDivision(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
