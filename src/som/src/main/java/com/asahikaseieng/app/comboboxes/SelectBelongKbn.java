 ...
 * @author tosco
 */
public class SelectBelongKbn extends AbstractSelectComboBox {

	private String[] myValue = {"1", "2"};

	private String[] myLabel = {"主所属", "兼務所属"};

	/**
	 * コンストラクタ
	 */
	public SelectBelongKbn() {
		setItem();
	}
	 ...
	 */
	public SelectBelongKbn(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
