...
/**
 * 取引先マスタメンテ画面の消費税端数単位用コンボボックス
 * @author tosco
 */
public class SelectTaxRoundupUnit extends AbstractSelectComboBox {
	 ...
	 */
	public SelectTaxRoundupUnit(final boolean zero, final boolean withNum) {
		super(zero, withNum);
		setItem();
	}
