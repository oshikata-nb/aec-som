...
<script language="JavaScript" type="text/javascript">
	...
	function selectClose(index){
		window.opener.setSalesLotValues(true
			, $F("locationCd" + index)
	...
	function selectCancel(){
		window.opener.setSalesLotValues(false, "", "", "", "", "");
	...
	Event.observe(window, 'load', function() {
		...
		new Ajax.Autocompleter(
		  ...
		  "<%= request.getContextPath() %>/SalesLocationForAutoComplete.do?op=searchLocation",
		  {
		  	paramName : "code",
...
<nested:form action="/SalesLotSearch" method="post" onsubmit="return false;" styleId="mainForm">
							...
							<table cellspacing="2" cellpadding="2" width="100%">
								...
								<app:modulo numerator='<%=pageContext.findAttribute("index").toString()%>' denominator="2" zero="true">
									...
									<td>
										...
										<nested:hidden property="aliasLotNo" styleId="<%="aliasLotNo" + pageContext.findAttribute("index").toString() %>" />
									</td>
									<%-- 在庫量 --%>
									<td class="alignRight">
