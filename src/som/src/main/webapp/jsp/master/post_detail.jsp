...
<nested:form action="/PostDetail" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table width="100%" cellspacing="2" cellpadding="2" border="0">
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="130">役職コード</td>
									<td>
										<nested:equal property="newFlg" value="true">
											<nested:text property="postId" maxlength="10" size="10" style="ime-mode:disabled" styleId="postId" onchange="setDirtyFlg();" />
										</nested:equal>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">役職名称</td>
									<td>
										<nested:text property="postName" maxlength="64" size="75" styleId="postName" onchange="setDirtyFlg();" />
									</td>
								</tr>
							</table>
						</td>
