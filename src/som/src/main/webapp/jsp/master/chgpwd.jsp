...
<nested:form action="/ChgPwd" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb">担当者パスワード変更</td>
									<td>
					...
					<tr>
						<td>
							...
							<table width="100%" cellspacing="2" cellpadding="2" border="0">
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="160">担当者コード</td>
									<td colspan="2">
