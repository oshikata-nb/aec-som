...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- 必須フィールド定義 --%>
        defineAsRequiredField("componentCd");

		<%-- 前後空白除去定義 --%>
		if ($('newFlg').value == 'true'){
        	defineAsKeyField("componentCd");
       	};
...
<nested:form action="/ComponentDetail" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table width="100%" cellspacing="2" cellpadding="2" border="0">
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="130">成分コード</td>
									<td>
										<nested:equal property="newFlg" value="true">
											<nested:text property="componentCd" maxlength="20" size="20" style="ime-mode:disabled" styleId="componentCd" onchange="setDirtyFlg();" />
										</nested:equal>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">成分名称</td>
									<td>
										<nested:text property="componentName" maxlength="50" size="95" styleId="componentName" onchange="setDirtyFlg();" />
									</td>
								</tr>
							</table>
						</td>
