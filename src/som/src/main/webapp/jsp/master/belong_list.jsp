...
<nested:form action="/BelongList" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">所属マスタ</td>
									<td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
	    											...
	    											<nested:define id="oid2" property="tantoCd"/>
	    											<nested:define id="oid3" property="postId"/>
	    											<nested:define id="oid4" property="belongKbn"/>

													<td>
														<%-- 部署コード --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/BelongDetail.do?op=init&organizationCd=" + pageContext.findAttribute("oid1").toString() + "&tantoCd=" + pageContext.findAttribute("oid2").toString() + "&postId=" + pageContext.findAttribute("oid3").toString() + "&belongKbn=" + pageContext.findAttribute("oid4").toString() + "'); return false;"%>'>
