...
<script language="JavaScript" type="text/javascript">
	...
	function selectClose(itemCd, itemName, itemUnit, unitDiv, smallnumLength, roundDivision){
		window.opener.setItemValues(itemCd, itemName, itemUnit, unitDiv, smallnumLength, roundDivision, true);
		//モーダルダイアログの終了
		window.close();
	}
	...
	function selectCancel(){
		window.opener.setItemValues("", "", "", "", "", "", false);
		//モーダルダイアログの終了
		window.close();
	}
...
<body>
<nested:form action="/ItemSearch" method="post" onsubmit="return false;" styleId="mainForm">
