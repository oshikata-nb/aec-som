...
<nested:form action="/BumonList" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">会計部門マスタ</td>
									<td>
								...
								<tr>
									<td>
										<table cellspacing="2" cellpadding="1"  border="0">
											<tr> 
												<td class="bcTitleSearch fb fcTitleSearch" width="130">会計部門コード</td>
												<td>
													<nested:text property="srhSectionCd" maxlength="10" size="10" styleId="srhSectionCd"/>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
	    											...
	    											<nested:define id="oid1" property="sectionCd"/>

													<td>
														<%-- 会計部門コード --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/BumonDetail.do?op=init&sectionCd=" + pageContext.findAttribute("oid1").toString() + "'); return false;"%>'>
													...
													<td>
														<%-- 会計部門略称 --%>
														<nested:write property="sectionShortedName"/>
													</td>
												</nested:iterate>
											</table>
										</td>
