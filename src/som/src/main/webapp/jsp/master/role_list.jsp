...
<nested:form action="/RoleList" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">ロールマスタ</td>
									<td>
								...
								<tr>
									<td>
										<table cellspacing="2" cellpadding="1"  border="0">
											<tr> 
												<td class="bcTitleSearch fb fcTitleSearch" width="130">ロールID</td>
												<td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
	    											...
	    											<nested:define id="oid1" property="roleId"/>

													<td>
														<%-- ロールID --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/RoleDetail.do?op=init&roleId=" + pageContext.findAttribute("oid1").toString() + "'); return false;"%>'>
