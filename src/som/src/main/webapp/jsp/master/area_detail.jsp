...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- 必須フィールド定義 --%>
        defineAsRequiredField("areaCd");

		<%-- 前後空白除去定義 --%>
		if ($('newFlg').value == 'true'){
        	defineAsKeyField("areaCd");
       	};
...
<nested:form action="/AreaDetail" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table width="100%" cellspacing="2" cellpadding="2" border="0">
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="130">地区コード</td>
									<td>
										<nested:equal property="newFlg" value="true">
											<nested:text property="areaCd" maxlength="10" size="10" style="ime-mode:disabled" styleId="areaCd" onchange="setDirtyFlg();" />
										</nested:equal>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">地区名称</td>
									<td>
										<nested:text property="areaName" maxlength="40" size="75" styleId="areaName" onchange="setDirtyFlg();" />
									</td>
								</tr>
							</table>
						</td>
