...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- 検索後入力された場合の不整合をただす --%>
		Event.observe('srhRyCd', 'keypress', clearLabel.bindAsEventListener($('srhRyDescription')), false);
	...
	function setReasonLabel(text, li) {
		...
		$("srhRyDescription").value = li.getElementsByTagName('span')[0].innerText;
		refreshLabel();
	}
...
<nested:form action="/ReasonList" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">理由マスタ</td>
									<td>
								...
								<tr>
									<td>
										<table cellspacing="2" cellpadding="1"  border="0">
											<tr> 
												<td class="bcTitleSearch fb fcTitleSearch" width="130">理由コード</td>
												<td>
													<nested:text property="srhRyCd" maxlength="8" size="8" styleId="srhRyCd"/>
													<div id="autocomplete_choices" class="autocomplete"></div>
												</td>

												<td>
													<div id="lblSrhRyDescription">
														<nested:write property="srhRyDescription" />
													</div>
													<nested:hidden property="srhRyDescription" styleId="srhRyDescription"/>
												</td>
											</tr>
										</table>
									</td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
	    											...
	    											<nested:define id="oid1" property="ryCd"/>

													<td>
														<%-- 理由コード --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/ReasonDetail.do?op=init&ryCd=" + pageContext.findAttribute("oid1").toString() + "'); return false;"%>'>
	        												<nested:write property="ryCd"/>
	        											</html:link>
													</td>
													...
													<td>
														<%-- デフォルト --%>
														<nested:write property="defaultFlgName"/>
													</td>
												</nested:iterate>
											</table>
										</td>
