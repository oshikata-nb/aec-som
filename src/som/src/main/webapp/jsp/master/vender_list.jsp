...
<script language="JavaScript" type="text/javascript">
	...
	function setVenderDivision() {
		$("venderDivision").value = $("srhVenderDivision").value;
	}
...
<nested:form action="/VenderList" method="post" onsubmit="return false;" styleId="mainForm">	
								...
								<tr>
									<td>
										<table cellspacing="2" cellpadding="1"  border="0">
											<tr>
												<td class="bcTitleSearch fb fcTitleSearch" width="130">取引先区分</td>
												<td>
													<% pageContext.setAttribute("SelectVenderDivision", new com.asahikaseieng.app.comboboxes.SelectVenderDivision(false, false)); %>
													<nested:select property="srhVenderDivision" onchange="setVenderDivision();">
											...
											<tr>
												<td class="bcTitleSearch fb fcTitleSearch">取引先コード</td>
												<td>
											...
											<tr>
												<td class="bcTitleSearch fb fcTitleSearch">担当部署コード</td>
												<td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
													...
													<td>
														<%-- 取引先コード --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/VenderDetail.do?op=init&venderDivision=" + pageContext.findAttribute("oid1").toString() + "&venderCd=" + pageContext.findAttribute("oid2").toString() + "'); return false;"%>'>
