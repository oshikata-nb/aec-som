...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- 検索後入力された場合の不整合をただす --%>
		Event.observe('srhProductionLine', 'keypress', clearLabel.bindAsEventListener($('srhProductionLineName')), false);
	...
	function setLineLabel(text, li) {
		...
		$("srhProductionLineName").value = li.getElementsByTagName('span')[0].innerText;
		refreshLabel();
	}
...
<nested:form action="/LineList" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">生産ラインマスタ</td>
									<td>
								...
								<tr>
									<td>
										<table cellspacing="2" cellpadding="1"  border="0">
											<tr> 
												<td class="bcTitleSearch fb fcTitleSearch" width="130">生産ラインコード</td>
												<td>
													<nested:text property="srhProductionLine" maxlength="10" size="10" styleId="srhProductionLine"/>
													<div id="autocomplete_choices" class="autocomplete"></div>
												</td>

												<td>
													<div id="lblSrhProductionLineName">
														<nested:write property="srhProductionLineName" />
													</div>
													<nested:hidden property="srhProductionLineName" styleId="srhProductionLineName"/>
												</td>
											</tr>
										</table>
									</td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
	    											...
	    											<nested:define id="oid1" property="productionLine"/>

													<td>
														<%-- 生産ラインコード --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/LineDetail.do?op=init&productionLine=" + pageContext.findAttribute("oid1").toString() + "'); return false;"%>'>
