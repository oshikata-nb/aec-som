...
<nested:form action="/OperationDetail" method="post" onsubmit="return false;" styleId="mainForm">	
						...
						<td>
							...
							<table width="100%" cellspacing="2" cellpadding="2" border="0">
								<tr>
									...
									<td>
										<nested:equal property="newFlg" value="true">
											<nested:text property="operationCd" maxlength="10" size="10" style="ime-mode:disabled" styleId="operationCd" onchange="setDirtyFlg();" />
										</nested:equal>
								...
								<tr>
									...
									<td>
										<nested:text property="operationName" maxlength="40" size="75" styleId="operationName" onchange="setDirtyFlg();" />
									</td>
								</tr>

								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">用途</td>
									<td>
										<% pageContext.setAttribute("SelectRecipeUse", new com.asahikaseieng.app.comboboxes.SelectRecipeUse(false, false, true)); %>
										<nested:select property="recipeUse" onchange="setDirtyFlg();" >
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">工程グループ</td>
									<td>
										<nested:select property="operationGroupCd" onblur="setDirtyFlg();" >
											<nested:options property="operationGroupValues" labelProperty="operationGroupLabels" />
										</nested:select>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<nested:textarea property="memo" rows="3" cols="65" styleId="memo" onchange="setDirtyFlg();" />
									</td>
								</tr>
							</table>
						</td>
