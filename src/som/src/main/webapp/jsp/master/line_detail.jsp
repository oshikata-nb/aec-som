...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- 必須フィールド定義 --%>
        defineAsRequiredField("productionLine");

		<%-- 前後空白除去定義 --%>
		if ($('newFlg').value == 'true'){
        	defineAsKeyField("productionLine");
       	};
...
<nested:form action="/LineDetail" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb">生産ラインマスタ</td>
									<td>
					...
					<tr>
						<td>
							...
							<table width="100%" cellspacing="2" cellpadding="2" border="0">
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="130">生産ラインコード</td>
									<td>
										<nested:equal property="newFlg" value="true">
											<nested:text property="productionLine" maxlength="10" size="10" style="ime-mode:disabled" styleId="productionLine" onchange="setDirtyFlg();" />
										</nested:equal>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">生産ライン名称</td>
									<td>
										<nested:text property="productionLineName" maxlength="40" size="75" styleId="productionLineName" onchange="setDirtyFlg();" />
									</td>
								</tr>
							</table>
						</td>
