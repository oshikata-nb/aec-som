...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- 検索後入力された場合の不整合をただす --%>
		Event.observe('srhAreaCd', 'keypress', clearLabel.bindAsEventListener($('srhAreaName')), false);
	...
	function setAreaLabel(text, li) {
		...
		$("srhAreaName").value = li.getElementsByTagName('span')[0].innerText;
		refreshLabel();
	}
...
<nested:form action="/AreaList" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">地区マスタ</td>
									<td>
								...
								<tr>
									<td>
										<table cellspacing="2" cellpadding="1"  border="0">
											<tr> 
												<td class="bcTitleSearch fb fcTitleSearch" width="130">地区コード</td>
												<td>
													<nested:text property="srhAreaCd" maxlength="10" size="10" styleId="srhAreaCd"/>
													<div id="autocomplete_choices" class="autocomplete"></div>
												</td>

												<td>
													<div id="lblSrhAreaName">
														<nested:write property="srhAreaName" />
													</div>
													<nested:hidden property="srhAreaName" styleId="srhAreaName"/>
												</td>
											</tr>
										</table>
									</td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
	    											...
	    											<nested:define id="oid1" property="areaCd"/>

													<td>
														<%-- 地区コード --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/AreaDetail.do?op=init&areaCd=" + pageContext.findAttribute("oid1").toString() + "'); return false;"%>'>
	        												<nested:write property="areaCd"/>
	        											</html:link>
													</td>
