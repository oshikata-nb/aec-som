...
<nested:form action="/LocationList" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">ロケーションマスタ</td>
									<td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
													...
													<td>
														<%-- ロケーションコード --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/LocationDetail.do?op=init&locationCd=" + pageContext.findAttribute("oid1").toString() + "'); return false;"%>'>
