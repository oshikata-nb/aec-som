...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- 検索後入力された場合の不整合をただす --%>
		Event.observe('srhAccountsCd', 'keypress', clearLabel.bindAsEventListener($('srhAccountsName')), false);
	...
	function setAccountsLabel(text, li) {
		...
		$("srhAccountsName").value = li.getElementsByTagName('span')[0].innerText;
		refreshLabel();
	}
...
<nested:form action="/AccountsList" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">勘定科目マスタ</td>
									<td>
								...
								<tr>
									<td>
										<table cellspacing="2" cellpadding="1"  border="0">
											<tr> 
												<td class="bcTitleSearch fb fcTitleSearch" width="130">勘定科目コード</td>
												<td>
													<nested:text property="srhAccountsCd" maxlength="10" size="10" styleId="srhAccountsCd"/>
													<div id="autocomplete_choices" class="autocomplete"></div>
												</td>

												<td>
													<div id="lblSrhAccountsName">
														<nested:write property="srhAccountsName" />
													</div>
													<nested:hidden property="srhAccountsName" styleId="srhAccountsName"/>
												</td>
											</tr>
										</table>
									</td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
	    											...
	    											<nested:define id="oid1" property="accountsCd"/>

													<td>
														<%-- 勘定科目コード --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/AccountsDetail.do?op=init&accountsCd=" + pageContext.findAttribute("oid1").toString() + "'); return false;"%>'>
