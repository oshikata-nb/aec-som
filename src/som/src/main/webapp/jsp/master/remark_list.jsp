...
<nested:form action="/RemarkList" method="post" onsubmit="return false;" styleId="mainForm">	
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">備考マスタ</td>
									<td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												<tr class="bcTitleList fb fcTitleList">
													<td width="40">詳細</td>
													<td width="100">取引先コード</td>
													<td>取引先名称1</td>
													<td width="100">納入先コード</td>
													<td>納入先名称1</td>
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
	    											...
	    											<nested:define id="oid1" property="remarkNo"/>

													<td>
														<%-- 編集 --%>
	        											<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/RemarkDetail.do?op=init&remarkNo=" + pageContext.findAttribute("oid1").toString() + "'); return false;"%>'>
	        												編集
	        											</html:link>
													</td>
