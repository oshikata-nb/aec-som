...
<script language="JavaScript" type="text/javascript">
	...
	function reportConfirm() {
		alertMsg = new Array();
		alertMsg[0] = "買掛元帳(EXCEL)出力してもよろしいですか？";
...
<nested:form action="/ApLedgerList" method="post" onsubmit="return false;" styleId="mainForm">
						...
						<table width="" border="0">
							<tr>
								...
								<table cellspacing="1" cellpadding="1" border="0">
									<tr>
										<td>
											<div id="cssButton"><a href="#" onclick="if (!(reportConfirm())) {return false;}else{return form_submit('op', 'report'); return false;}" class="cssButton">
												買掛元帳(EXCEL)</a>
											</div>
										</td>
									</tr>
							...
							<tr>
								...
								<table cellspacing="2" cellpadding="1" id="tblList">
									...
									<nested:iterate id="searchList" property="searchList" indexId="index">
										...
										<nested:hidden property="payableNo" styleId="payableNo"/>
										<nested:define id="vcd" property="venderCd" />
										<nested:define id="pyn" property="payableNo" />
										...
										<td width="180">
											<html:link href="#"
												onclick='<%=
													...
													+ "/ApLedgerDetail.do?op=search&venderCd="
													+ pageContext.findAttribute("vcd").toString() 
													+ "&payableNo=" 
													+ pageContext.findAttribute("pyn").toString() 
													+ "&targetKbn=" 
										...
										<%-- 支払・その他計 --%>
										<td width="67" align="right">
											<nested:write property="strOtherPayment"/>
										</td>
										<%-- 今回仕入額 --%>
										<td width="67" align="right">
