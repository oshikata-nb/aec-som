...
<script language="JavaScript" type="text/javascript">
	...
	function selectClose(index){
		window.opener.setShippingResultLotValues(true
			, $F("locationCd" + index)
	...
	function selectCancel(){
		window.opener.setShippingResultLotValues(false, "", "", "", "");
	...
	Event.observe(window, 'load', function() {
		...
		new Ajax.Autocompleter(
		  ...
		  "<%= request.getContextPath() %>/ShippingResultLocationForAutoComplete.do?op=searchLocation",
		  {
		  	paramName : "code",
...
<nested:form action="/ShippingResultLotSearch" method="post" onsubmit="return false;" styleId="mainForm">
