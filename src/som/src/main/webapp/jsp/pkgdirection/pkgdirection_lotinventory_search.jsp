...
<body>
<nested:form action="/PkgDirectionLotInventorySearch" method="post" onsubmit="return false;" styleId="mainForm">
					...
					<tr>
						<td><!-- ヘッダー部 -->
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" nowrap>在庫確認</td>
									<td>
