...
<body>
<nested:form action="/PkgDirectionProcedureDetail" method="post" onsubmit="return false;" styleId="mainForm">
					...
					<tr>
						<td><!-- ヘッダー部 -->
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb">包装指図工程詳細</td>
									<td>
						...
						<td>
							<table width="100%" cellspacing="2" cellpadding="1" border="0">
								<tr>
									...
									<td class="fcTitleDetail fb bcTitleDetail" width="160">工程名称</td>
									<td>
										<nested:write property="operationName" />
									</td>
								</tr>
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="160">工程開始予定日時</td>
									<td>
										<nested:write property="strStartDate" />
									</td>
								</tr>
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="160">工程終了予定日時</td>
									<td>
										<nested:write property="strEndDate" />
									</td>
								</tr>
								<tr>
