...
<nested:form action="/PkgDirectionProcedureList" method="post" onsubmit="return false;" styleId="mainForm">
										...
										<nested:notEmpty property="searchProcList">
											<table cellspacing="2" cellpadding="1" width="100%" border="0" id="tblList">
												<tr class="bcTitleList fb fcTitleList">
													...
													<td width="130">工程開始予定日時</td>
													<td width="130">工程終了予定日時</td>
													<td width="50">詳細</td>
													<td width="50">配合</td>
												</tr>
												<nested:iterate id="searchProcList" property="searchProcList" indexId="index">
													...
													<nested:notEmpty property="strStepNo">
														...
														<%-- 詳細 --%>
														<td>
															<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/PkgDirectionProcedureDetail.do?op=init&directionDivision=" + pageContext.findAttribute("div").toString() + "&directionNo=" + pageContext.findAttribute("dno").toString() + "&stepNo=" + pageContext.findAttribute("sno").toString() + "'); return false;"%>'>
																選
															</html:link>
														</td>
														<%-- 配合 --%>
														<td>
															...
															<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/PkgDirectionFormulaList.do?op=reSearch&directionDivision=" + pageContext.findAttribute("div").toString() + "&directionNo=" + pageContext.findAttribute("dno").toString() + "&procStepNo=" + pageContext.findAttribute("sno").toString() + "'); return false;"%>'>
																<nested:write property="formulaMark"  />
															</html:link>
															</nested:equal>
															<nested:equal property="formulaMark" value="×">
