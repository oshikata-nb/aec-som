...
<script language="JavaScript" type="text/javascript">
	...
	function reportAlert() {
		alertMsg = new Array();
		alertMsg[0] = "得意先別管理月報を発行してよろしいですか？";
...
<nested:form action="/MonthlyVender" method="post" onsubmit="return false;" styleId="mainForm">
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="750">
								...
								<tr>
									<td class="fcTitle fb" width="250">得意先別管理月報</td>
									<td>
...
　　抽出期間によっては、得意先別管理月報(Excel)の出力時間が多くかかります。<br><br>
　　　・実行中に他のメニューを押すと得意先別管理月報が正しく出力されません。<br>
　　　・実行中は他のメニューを押さないで下さい。<br><br>
　　得意先別管理月報(Excel)出力までしばらくお待ち下さい。。。<br><br>
													</div>
												</td>
											</tr>
										</table>
