...
<nested:form action="/ArBalanceList" method="post" onsubmit="return false;" styleId="mainForm">
						...
						<tr>
							...
							<table border="0" cellspacing="2" cellpadding="1">
								...
								<tr>
									...
									<td colspan="2">
										<nested:checkbox property="srhCreditAmountDivi" styleId="srhCreditAmountDivi" value="<%= Constants.FLG_ON %>"/>
										売掛残高があるもの
									</td>
								</tr>
								<tr>
							...
							<tr>
								...
								<table cellspacing="2" cellpadding="1" id="tblList">
									...
									<nested:iterate id="searchList" property="searchList" indexId="index">
										...
										<%-- 売掛残高 --%>
										<td width="67" align="right">
											<nested:write property="strClaimBalance"/>
										</td>
										<%-- 未請求残高 --%>
										<td width="67" align="right">
											<nested:write property="strClaimForward"/>
										</td>
										<%-- 未収金残高 --%>
										<td width="67" align="right">
