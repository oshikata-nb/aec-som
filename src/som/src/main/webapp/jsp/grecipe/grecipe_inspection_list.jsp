...
<nested:form action="/GrecipeInspectionList" method="post" onsubmit="return false;" styleId="mainForm">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td class="fcTitle fb" width="250">原処方</td>
							<td>
													...
													<nested:notEmpty property="strLineNo">
														...
														<td>
															<html:link href="#" onclick='<%="toDetail('"
																							...
																							+ "/GrecipeInspectionDetail.do?op=init"
