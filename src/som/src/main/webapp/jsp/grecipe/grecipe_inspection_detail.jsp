...
<body>
<nested:form action="/GrecipeInspectionDetail" method="post" onsubmit="return false;" styleId="mainForm">
		...
		<tr>
			<td>
				<table cellspacing="2" cellpadding="2" border="0" width="100%">
					<tr>
						<td class="fcTitleDetail fb bcTitleDetail" width="120">原処方コード</td>
						<td width="150">
		...
		<tr>
			<td>
				<table width="750" cellspacing="2" cellpadding="1" border="0">
					...
					<tr>
						<td class="fcTitleDetail fb bcTitleDetail" width="160">値1</td>
						<td>
							<nested:text property="value1" styleId="value1s" maxlength="20" size="20" onchange="setDirtyFlg();" onblur="format();" />
					...
					<tr>
						<td class="fcTitleDetail fb bcTitleDetail" width="160">値2</td>
						<td colspan="2">
							<nested:text property="value2" styleId="value2" maxlength="20" size="20" onchange="setDirtyFlg();" onblur="format();" />
