...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<logic:equal name="grecipeFormulaDetailForm" property="recipeUse" value="3">
	...
	function formatQty(obj){
		var value = obj.value;
		if( (value != null) && (value != "") ){
			digitRequest("HAIGO_RITU",null,null,value,setValue);
		}
	}
	<%-- 配合量のフォーマット済み設定--%>
...
<body>
<nested:form action="/GrecipeFormulaDetail" method="post" onsubmit="return false;" styleId="mainForm">
						...
						<td>
							<table width="750" cellspacing="2" cellpadding="1" border="0">
								<tr>
									...
									<td width="120">
										<nested:text property="itemCd" styleId="itemCd" maxlength="20" size="20" onchange="setDirtyFlg();" style="ime-mode:disabled"/>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="160">
									...
									<td class="alignLeft">
										...
										<nested:equal property="recipeUse" value="4"><%-- 包装時 --%>
											<div id="unitName"><nested:write property="unitName" /></div>
										</nested:equal>
									</td>
								</tr>
							</table>
