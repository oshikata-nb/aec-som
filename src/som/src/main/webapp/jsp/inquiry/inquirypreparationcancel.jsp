...
<nested:form action="/InquiryPreparationCancel" method="post" onsubmit="return false;" styleId="mainForm">
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">ロット別棚卸準備キャンセル処理</td>
									<td>
							...
							<table cellpadding="0" cellspacing="0" width="450" border="0">
								...
								<tr>
									<nested:equal property="deleteAuthority" value="true">
										<td class="alignRight">
											<div id="cssButton">
												<a href="#" onclick="if(!putConfirm()){return false;}else{return form_submit('op', 'delete'); return false;}" class="cssButton">
													&nbsp;&nbsp;削&nbsp;&nbsp;除&nbsp;&nbsp;
												</a>
											</div>
										</td>
