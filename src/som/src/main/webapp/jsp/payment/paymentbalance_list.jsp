...
<nested:form action="/PaymentBalanceList" method="post" onsubmit="return false;" styleId="mainForm">
						...
						<tr>
							...
							<table border="0" cellspacing="2" cellpadding="1">
								...
								<tr>
									...
									<td colspan="3">
										<nested:checkbox property="srhOutputDivision" styleId="temClosingFlg" value="<%= Constants.FLG_ON %>"/>
										支払残高があるもの
									</td>
								</tr>
							</table>
							...
							<tr>
								...
								<table cellspacing="2" cellpadding="1" id="tblList">
									<tr class="bcTitleList fb fcTitleList">
										<td>支払先</td>
										<td align="right">前回<br>支払予定額</td>
										<td align="right">支払<br>・その他計</td>
										<td align="right">今回仕入額</td>
										<td align="right">その他計</td>
										<td align="right">消費税</td>
										<td align="right">支払残高</td>
									</tr>
									<nested:iterate id="searchList" property="searchList" indexId="index">
										...
										<td width="80" align="right">
											<nested:write property="strOtherTotal"/>
										</td>
										<%-- 消費税 --%>
										<td width="80" align="right">
