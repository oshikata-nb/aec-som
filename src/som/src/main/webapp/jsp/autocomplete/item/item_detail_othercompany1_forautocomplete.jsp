		...
		<ul class="contacts">
			<nested:iterate id="list" property="result" indexId="index">
				<li class="contact">
					...
					<div><nested:hidden property="code" styleClass="code"/><nested:hidden property="styleOfPacking" styleClass="styleOfPacking"/><nested:hidden property="unitOfOperationManagement" styleClass="unitOfOperationManagement"/><nested:hidden property="name01" styleClass="name01"/><nested:hidden property="lotDivision" styleClass="lotDivision"/></div>
				</li>
			</nested:iterate>
		</ul>
	</nested:notEmpty>
