...
<script language="JavaScript" type="text/javascript">
	...
	function selectClose(index){
		window.opener.setBuyingInoutValues(true
			, $F("inoutNo" + index)
			, $F("lotNo" + index)
			, $F("strInoutQty" + index)
	...
	function selectCancel(){
		window.opener.setBuyingInoutValues(false, "", "", "", "", "", "", "");
...
<nested:form action="/BuyingInoutSearch" method="post" onsubmit="return false;" styleId="mainForm">
