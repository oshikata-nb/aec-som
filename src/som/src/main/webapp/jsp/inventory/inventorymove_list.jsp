...
<nested:form action="/InventoryMoveList" method="post" onsubmit="return false;" styleId="mainForm">
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">在庫移動入力</td>
									<td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
													...
													<td>
														<%-- ロケーション名称 --%>
														<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/InventoryMoveDetail.do?op=init&outLocationCd=" + pageContext.findAttribute("oid1").toString() + "&itemCd=" + pageContext.findAttribute("oid2").toString() + "&lotNo=" + pageContext.findAttribute("oid3").toString() + "'); return false;"%>'>
