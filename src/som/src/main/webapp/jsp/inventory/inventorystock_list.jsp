...
<nested:form action="/InventoryStockList" method="post" onsubmit="return false;" styleId="mainForm">
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">品目別予定在庫照会</td>
									<td>
								...
								<tr>
									<td>
										<table cellspacing="2" cellpadding="1" border="0">
											...
											<tr>
												<td class="bcTitleSearch fb fcTitleSearch" width="130">手持在庫数</td>
												<td>
										...
										<td>
											<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
												...
												<nested:iterate id="searchList" property="searchList" indexId="index">
													...
													<td>
														<%-- 受払ソースNo --%>
<%-- 受払ソースNoのリンクをコメントアウト 2009/07/15
														<nested:notEqual property="link" value="">
															...
															<html:link href="#" onclick='<%="open_window('" + request.getContextPath() + pageContext.findAttribute("oid1").toString() + pageContext.findAttribute("oid2").toString() + "'); return false;"%>'>
																<nested:write property="inoutSourceNo" />
															</html:link>
														</nested:notEqual>
