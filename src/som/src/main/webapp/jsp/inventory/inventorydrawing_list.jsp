...
<nested:form action="/InventoryDrawingList" method="post" onsubmit="return false;" styleId="mainForm">
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb" width="250">品目別引当明細照会</td>
									<td>
						...
						<td>
							<table width="100%" cellspacing="2" cellpadding="1" id="tblList">
								...
								<tr>
									...
									<%-- 仕上数 --%>
									<td class="alignRight">
										<nested:write property="strFinishQty"/>
									</td>
									...
									<%-- 販売引当残数 --%>
									<td class="alignRight">
										<nested:write property="strSalesAssignQty"/>
									</td>

									<%-- 先付受注数 --%>
									<td class="alignRight">
										<nested:write property="strPreOrderQty"/>
									</td>

									<%-- 利用可能数 --%>
									<td class="alignRight">
										<nested:write property="strUsepossibleQty"/>
									</td>

									<%-- 単位 --%>
									<td>
										<nested:write property="itemUnit"/>
									</td>
								</tr>
							</table>
						</td>
...
--%>
													...
													<td class="alignRight">
														<%-- 在庫推移 --%>
														<nested:write property="strInoutScheduleQty"/>
													</td>

													<td>
														<%-- 製造品目コード --%>
														<nested:write property="parentItemCd"/>
													</td>
												</nested:iterate>
											</table>
										</td>
