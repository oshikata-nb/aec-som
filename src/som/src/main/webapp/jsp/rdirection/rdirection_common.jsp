		...
		<table cellspacing="2" cellpadding="2" border="0" width="100%">
			...
			<tr>
				...
				<td class="alignRight">
					...
					<nested:notEmpty property="planedQty">
			...
			<tr>
				...
				<td></td>
				<td class="fcTitleDetail fb bcTitleDetail" width="130">製造担当者</td>
				<td class="alignLeft">
					<nested:write property="seizotantoName" />
				</td>
			</tr>
			<tr>
				...
				<td></td>
				<td class="fcTitleDetail fb bcTitleDetail" width="130">洗浄担当者</td>
				<td class="alignLeft">
					<nested:write property="senjotantoName" />
				</td>
			</tr>
			<tr>
				...
				<td></td>
				<td class="fcTitleDetail fb bcTitleDetail" width="130">滅菌作業担当者</td>
				<td class="alignLeft">
					<nested:write property="mekkintantoName" />
				</td>
			</tr>
		</table>
	</td>
...
<tr>
	...
	<table border="0" cellspacing="" cellpadding="" width="100%">
		<tr>
			<td>
				<%@ include file="/jsp/rdirection/rdirection_tab.jsp"%>
			</td>
		</tr>
	</table>
</tr>
