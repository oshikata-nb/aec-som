...
<nested:form action="/RdirectionProcedureList" method="post" onsubmit="return false;" styleId="mainForm">
												...
												<nested:notEmpty property="searchProcList">
													<table cellspacing="2" cellpadding="1" width="100%" border="0" id="tblList">
														<tr class="bcTitleList fb fcTitleList">
															...
															<td width="135">工程開始実績日時</td>
															<td width="135">工程終了実績日時</td>
															<td width="8">詳細</td>
															<td width="8">配合</td>
														</tr>
														<nested:iterate id="searchProcList" property="searchProcList" indexId="index">
															...
															<nested:notEmpty property="strStepNo">
																...
																<%-- 詳細 --%>
																<td>
																	<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/RdirectionProcedureDetail.do?op=init&directionNo=" + pageContext.findAttribute("dno").toString() + "&strStepNo=" + pageContext.findAttribute("sno").toString() + "'); return false;"%>'>
																		選
																	</html:link>
																</td>
																<%-- 配合 --%>
																<td>
																	...
																	<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/RdirectionFormulaList.do?op=reSearch&directionNo=" + pageContext.findAttribute("dno").toString() + "&tempProcStepNo=" + pageContext.findAttribute("sno").toString() + "'); return false;"%>'>
																		<nested:write property="formulaMark"  />
																	</html:link>
																	</nested:equal>
																	<nested:equal property="formulaMark" value="×">
