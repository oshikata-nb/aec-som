...
<nested:form action="/RdirectionFinishList" method="post" onsubmit="return false;" styleId="mainForm">
											...
											<nested:notEmpty property="searchFinishList">
												<table cellspacing="2" cellpadding="1" width="100%" border="0" id="tblList">
													<tr class="bcTitleList fb fcTitleList">
														...
														<td>品目名称</td>
														<td>区分</td>
														<td width="90">仕込み<br>予定数量</td>
														<td width="90">仕込み<br>実績数量</td>
													</tr>
													<nested:iterate id="searchFinishList" property="searchFinishList" indexId="index">
														...
														<nested:equal name="index" value="0" >
															...
															<td>
																<nested:text property="strQty" maxlength="22" size="22" styleId='<%= "strQty" + pageContext.findAttribute("index").toString() %>'
																 disabled="true" style="ime-mode:disabled" styleClass="alignRight" onchange="setDirtyFlg();"/>
															</td>
															<%-- 仕込み実績数量 --%>
															<td>
																<nested:text property="strResultQty" maxlength="22" size="22" styleId='<%= "strResultQty" + pageContext.findAttribute("index").toString() %>'
																 onblur="<%="setLine(" + pageContext.findAttribute("index").toString() + ");formatQty(this);"%>" style="ime-mode:disabled"
																 styleClass="alignRight" onchange="setDirtyFlg();"/>
															</td>
														</nested:equal>
														<%-- ２行目以降 --%>
														<nested:notEqual name="index" value="0" >
															...
															<nested:empty property="strSeq">
																<td>
																	<nested:select property="strStepNo" style="margin: 0;padding: 0" styleId="strStepNo" onchange="setDirtyFlg();">
																		<nested:optionsCollection name="rdirectionFinishListForm" property="stepNoCombo" label="labales" value="values" />
																	</nested:select>
																</td>
															</nested:empty>
															...
															<td>
																<nested:text property="strQty" maxlength="22" size="22" styleId='<%= "strQty" + pageContext.findAttribute("index").toString() %>'
																 onblur="<%="setLine(" + pageContext.findAttribute("index").toString() + ");formatQty(this);"%>"
