...
<body>
<nested:form action="/PkgRdirectionProcedureDetail" method="post" onsubmit="return false;" styleId="mainForm">
	...
	<nested:hidden property="jissekiFlag" styleId="jissekiFlag" />
					...
					<tr>
						<td><!-- ヘッダー部 -->
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb">包装実績工程詳細</td>
									<td>
					...
					<tr>
						<td>
							<table cellspacing="2" cellpadding="2" border="0" width="100%">
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="100">包装指図</td>
									<td width="170">
								...
								<tr>
									...
									<td class="fcTitleDetail fb bcTitleDetail" width="100">品目名称</td>
									<td>
					...
					<tr>
						<td>
							<table width="100%" cellspacing="2" cellpadding="1" border="0">
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">工程コード</td>
									<td>
										<nested:write property="operationCd" />
									</td>
									<td class="fcTitleDetail fb bcTitleDetail">工程名称</td>
									<td>
										<nested:write property="operationName" />
									</td>
								</tr>
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">工程開始実績日時</td>
									<td>
										<nested:text property="strResultSDay" maxlength="10" size="12" styleId="strResultSDay" onchange="setDirtyFlg();" style="ime-mode:disabled" />
										<nested:text property="strResultSTime" maxlength="5" size="7" styleId="strResultSTime" onchange="setDirtyFlg();" style="ime-mode:disabled" />
									</td>
								</tr>
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">工程終了実績日時</td>
									<td>
										<nested:text property="strResultEDay" maxlength="10" size="12" styleId="strResultEDay" onchange="setDirtyFlg();" style="ime-mode:disabled" />
										<nested:text property="strResultETime" maxlength="5" size="7" styleId="strResultETime" onchange="setDirtyFlg();" style="ime-mode:disabled" />
									</td>
								</tr>
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">正味質量(Net)</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">量目管理幅最小</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">量目管理幅最大</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">濾過用フィルター</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">濾過用メッシュ</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">ｵｰﾄﾁｪｯｶｰ最小</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">ｵｰﾄﾁｪｯｶｰ最大</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">ｸﾞﾛｽﾁｪｯｶｰ最小</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">ｸﾞﾛｽﾁｪｯｶｰ最大</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">ｵｰﾄﾁｪｯｶｰ中心</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">ｸﾞﾛｽﾁｪｯｶｰ中心</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">開きトルク最小</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">開きトルク最大</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">締めトルク最小</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">締めトルク最大</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">トルク圧</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">エアー圧</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">巻締め時間</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">ﾎｯﾄｴｱｰ設定温度</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">ﾎｯﾄｴｱｰ吹き出し圧力</td>
									<td>
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">第一ﾋｰﾄｼｰﾙ設定温度</td>
									<td>
									...
									<td class="fcTitleDetail fb bcTitleDetail">第二ﾋｰﾄｼｰﾙ設定温度</td>
									<td>
							...
							<table width="100%" cellspacing="2" cellpadding="1" border="0">
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="175">工程条件自由入力</td>
									<td>
										<nested:textarea property="condition" rows="5" cols="65" styleId="condition" onchange="setDirtyFlg();" />
									</td>
								</tr>
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">備考</td>
									<td>
										<nested:textarea property="remark" rows="5" cols="65" styleId="remark" onchange="setDirtyFlg();" />
									</td>
								</tr>
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail">注釈</td>
									<td>
										<nested:textarea property="notes" rows="5" cols="65" styleId="notes" onchange="setDirtyFlg();" />
									</td>
								</tr>
							</table>
						</td>
