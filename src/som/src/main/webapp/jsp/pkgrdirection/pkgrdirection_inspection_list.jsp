...
<nested:form action="/PkgRdirectionInspectionList" method="post" onsubmit="return false;" styleId="mainForm">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td class="fcTitle fb" width="250">包装実績入力検査</td>
							<td>
						...
						<nested:notEmpty property="searchInspectionList">
							<nested:iterate id="searchInspectionList" property="searchInspectionList" indexId="index">
								...
								<nested:notEmpty property="strLineNo">
									<nested:define id="oid1" property="directionDivision" />								
									<nested:define id="oid2" property="directionNo" />
									<nested:define id="oid3" property="stepNo" />
									<nested:define id="oid4" property="lineNo" />
									<td>
										<html:link href="#" onclick='<%="toDetail('" 
																		+ request.getContextPath()
																		+ "/PkgRdirectionInspectionDetail.do?op=init"
																		+ "&directionDivision=" + pageContext.findAttribute("oid1").toString()
																		+ "&directionNo=" + pageContext.findAttribute("oid2").toString() 
																		+ "&stepNo=" + pageContext.findAttribute("oid3").toString()
																		+ "&lineNo=" + pageContext.findAttribute("oid4").toString()
																		+ "'); return false;"%>'>
											選
										</html:link>
									</td>
