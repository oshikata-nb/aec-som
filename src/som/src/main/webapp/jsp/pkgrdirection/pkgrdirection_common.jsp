		...
		<table cellspacing="2" cellpadding="2" border="0" width="100%">
			<tr>
				...
				<td>
					...
					<html:link href ="#" onclick='<%="open_modal_popup_edge(600, 600,'PkgRdirectionDirectionDetailSearch', '',"
			...
			<tr>
				...
				<td>
					<nested:write property="planedSdate" />
				</td>
				<td></td>
				<td class="fcTitleDetail fb bcTitleDetail" width="130">包装終了予定日時</td>
				<td>
					<nested:write property="planedEdate" />
				</td>
			</tr>
			<tr>
...
<tr>
	...
	<table border="0" cellspacing="" cellpadding="" width="100%">
		<tr>
			<td>
				<%@ include file="/jsp/pkgrdirection/pkgrdirection_tab.jsp"%>
			</td>
		</tr>
	</table>
</tr>
