...
<script>
	...
	function moveTab(actionName) {
		if (!g_lock) {
			if (dirtyConfirm()) {
				location.href="<%= request.getContextPath() %>/" + actionName + ".do?op=init&directionNo=" + $F("directionNo") + "&directionDivision=" + $F("directionDivision");
				g_lock = true;
			}
		}
		return false;
...
<span id="slidetabsmenu">
	<ul>
		...
		<nested:notEqual property="tabId" value="Header">
			<li><a href="javascript:void();" title="ヘッダー情報" onclick="return moveTab('PkgRdirectionHeaderDetail');"><span>ヘッダー情報</span></a></li>
		</nested:notEqual>
		...
		<nested:notEqual property="tabId" value="ProcedureList">
			<li><a href="javascript:void();" title="工程情報" onclick="return moveTab('PkgRdirectionProcedureList');"><span>工程</span></a></li>
		</nested:notEqual>
		...
		<nested:notEqual property="tabId" value="FormulaList">
			<li><a href="javascript:void();" title="配合情報" onclick="return moveTab('PkgRdirectionFormulaList');"><span>配合</span></a></li>
		</nested:notEqual>
		...
		<nested:notEqual property="tabId" value="InspectionList">
			<li><a href="javascript:void();" title="検査情報" onclick="return moveTab('PkgRdirectionInspectionList');"><span>検査</span></a></li>
		</nested:notEqual>
		...
		<nested:notEqual property="tabId" value="FinishList">
			<li><a href="javascript:void();" title="仕上情報" onclick="return moveTab('PkgRdirectionFinishList');"><span>仕上</span></a></li>
		</nested:notEqual>
	</ul>
</span>
