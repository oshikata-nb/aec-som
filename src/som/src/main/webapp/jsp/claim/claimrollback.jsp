...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		new Ajax.Autocompleter(
		  "venderCd",
		  "autocomplete_vender",
		  "<%= request.getContextPath() %>/AutoComplete.do?op=autoClaimerCreditDateRb",
		  {
		    afterUpdateElement : setVenderCreditDateLabel
		  }
	    );
...
<nested:form action="/ClaimRollback" method="post" onsubmit="return false;" styleId="mainForm">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td class="fcTitle fb">請求更新ロールバック処理</td>
							<td>
