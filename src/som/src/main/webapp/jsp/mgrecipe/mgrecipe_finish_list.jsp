...
<nested:form action="/MgrecipeFinishList" method="post" onsubmit="return false;" styleId="mainForm">
															...
															<nested:empty property="strSeq">
																<td>
																	<nested:select property="strStepNo" style="margin: 0;padding: 0" styleId="strStepNo" onchange="setDirtyFlg();">
																		<nested:optionsCollection name="mgrecipeFinishListForm" property="stepNoCombo" label="labales" value="values" />
																	</nested:select>
																</td>
															</nested:empty>
