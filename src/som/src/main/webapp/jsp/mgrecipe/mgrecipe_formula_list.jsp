	...
	function sumQty(index){
		...
		if ($("recipeUse").value == "3") {
			...
			if ($("totalQty") != null) {
			    ...
			    var decPoint = $('decimalPoint0').value;
			    var round = $('roundDivision0').value;
...
<nested:form action="/MgrecipeFormulaList" method="post" onsubmit="return false;" styleId="mainForm">
											...
											<nested:notEmpty property="searchFormList">
												<table cellspacing="2" cellpadding="1" width="100%" border="0" id="tblList">
													...
													<nested:iterate id="searchFormList" property="searchFormList" indexId="index">
														...
														<%-- 単位 --%>
														<nested:equal name="mgrecipeFormulaListForm" property="recipeUse" value="3">
															<td>Kg</td>
														</nested:equal>
														<nested:equal name="mgrecipeFormulaListForm" property="recipeUse" value="4">
															<td>
														...
														<nested:notEmpty property="strSeq">
															...
															<%-- 詳細 --%>
															<td>
																<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/MgrecipeFormulaDetail.do?op=init&recipeId=" + pageContext.findAttribute("oid1").toString() + "&stepNo=" + pageContext.findAttribute("oid2").toString() + "&lineNo=" + pageContext.findAttribute("oid3").toString() + "&srhLink=" + pageContext.findAttribute("oid4").toString() + "'); return false;"%>'>
																	選
																</html:link>
															</td>
														</nested:notEmpty>
