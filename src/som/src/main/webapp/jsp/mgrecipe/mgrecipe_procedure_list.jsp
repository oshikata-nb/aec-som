...
<nested:form action="/MgrecipeProcedureList" method="post" onsubmit="return false;" styleId="mainForm">
											...
											<table cellspacing="2" cellpadding="1" width="100%" border="0" id="tblList">
												...
												<nested:iterate id="searchProcList" property="searchProcList" indexId="index">
													...
													<nested:notEmpty property="strStepNo">
														...
														<%-- 詳細 --%>
														<td>
															<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/MgrecipeProcedureDetail.do?op=init&recipeId=" + pageContext.findAttribute("rid").toString() + "&stepNo=" + pageContext.findAttribute("sno").toString() + "&srhLink=" + pageContext.findAttribute("lnk").toString() + "'); return false;"%>'>
																選
															</html:link>
														</td>
														<%-- 配合 --%>
														<td>
															...
															<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/MgrecipeFormulaList.do?op=reSearch&recipeId=" + pageContext.findAttribute("rid").toString() + "&procStepNo=" + pageContext.findAttribute("sno").toString() + "&srhLink=" + pageContext.findAttribute("lnk").toString() + "'); return false;"%>'>
																<nested:write property="formulaMark"  />
															</html:link>
															</nested:equal>
															<nested:equal property="formulaMark" value="×">
