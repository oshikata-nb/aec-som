...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- 数値型フィールド定義 --%>
		<logic:equal name="mgrecipeProcedureDetailForm" property="recipeUse" value="3">
		...
		<logic:equal name="mgrecipeProcedureDetailForm" property="recipeUse" value="4">
...
<body>
<nested:form action="/MgrecipeProcedureDetail" method="post" onsubmit="return false;" styleId="mainForm">
