...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- 日付型フィールド定義
		defineAsDateField("strStartDate");
		defineAsDateField("strEndDate"); --%>

		<%-- 時刻型フィールド定義
		defineAsTimeField("strStartTime");
		defineAsTimeField("strEndTime"); --%>
...
<nested:form action="/DirectionProcedureDetail" method="post" onsubmit="return false;" styleId="mainForm">
					...
					<tr>
						<td><!-- ヘッダー部 -->
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td class="fcTitle fb">製造指図工程詳細</td>
									<td>
					...
					<tr>
						<td><!-- 明細部 -->
							<table width="750" cellspacing="2" cellpadding="1" border="0">
								...
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="130">工程開始予定日時</td>
									<td>
										<nested:write property="strStartDate"/>&nbsp;<nested:write property="strStartTime"/>
									</td>
								</tr>

								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="130">工程終了予定日時</td>
									<td>
										<nested:write property="strEndDate"/>&nbsp;<nested:write property="strEndTime"/>
									</td>
								</tr>
							...
							<table width="750" cellspacing="2" cellpadding="1" border="0">
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" rowspan="9" width="130">工程条件</td>
								</tr>
									<td>
										<table width="100%" cellspacing="2" cellpadding="1" border="0">
											<tr>
												...
												<td>
													<nested:text property="strConditionTemp" styleId="strConditionTemp" maxlength="22" size="15" style="ime-mode:disabled" onblur="return formatRecipe2(this);" onchange="setDirtyFlg();" />
													℃
												</td>
											</tr>
											<tr>
												...
												<td>
													<nested:text property="strConditionTime" styleId="strConditionTime" maxlength="22" size="15" style="ime-mode:disabled" onblur="return formatRecipe1(this);"  onchange="setDirtyFlg();" />
													分
												</td>
											</tr>
											<tr>
												...
												<td>
													<nested:text property="strStirSpeed1" styleId="strStirSpeed1" maxlength="22" size="15" style="ime-mode:disabled" onblur="return formatRecipe1(this);" onchange="setDirtyFlg();" />
													Hz
												</td>
											</tr>
											<tr>
												...
												<td>
													<nested:text property="strStirSpeed2" styleId="strStirSpeed2" maxlength="22" size="15" style="ime-mode:disabled" onblur="return formatRecipe1(this);" onchange="setDirtyFlg();" />
													Hz
												</td>
											</tr>
											<tr>
												...
												<td>
													<nested:text property="strWaterWeight" styleId="strWaterWeight" maxlength="22" size="15" style="ime-mode:disabled" onblur="return formatSonota(this);" onchange="setDirtyFlg();" />
													kg
												</td>
											</tr>
											<tr>
							...
							<table width="750" cellspacing="2" cellpadding="1" border="0">
								...
								<tr>
									...
									<td>
										<nested:textarea property="procedureRemark" rows="5" cols="60" styleId="procedureRemark" onchange="setDirtyFlg();" />
									</td>
								</tr>
								<tr>
									<td class="fcTitleDetail fb bcTitleDetail" width="130">注釈</td>
									<td>
										<nested:textarea property="procedureNotes" rows="5" cols="60" styleId="procedureNotes" onchange="setDirtyFlg();" />
									</td>
								</tr>
							</table>
						...
						<td class="alignCenter">
							<table cellpadding="0" cellspacing="0" width="450" border="0">
								...
								<nested:lessEqual property="directionStatus" value="2">
									...
									<td class="alignCenter">
										<div id="cssButton">
											<a href="#" onclick="if (!(putDirtyConfirm())) {return false;}else{return form_submit('op', 'back'); return false;}"
												class="cssButton">&nbsp;&nbsp;戻&nbsp;&nbsp;る&nbsp;&nbsp;
											</a>
										</div>
									</td>
