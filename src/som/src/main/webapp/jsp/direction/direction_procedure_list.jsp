...
<nested:form action="/DirectionProcedureList" method="post" onsubmit="return false;" styleId="mainForm">
						...
						<table width="750" cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<span id="slidetabs" style="clear: left;">
									<table border="0" cellspacing="2" cellpadding="2" width="100%" id="tblList">
										<tr>
											<td>
												<nested:notEmpty property="searchProcList">
													<table cellspacing="2" cellpadding="1" width="100%" border="0" id="tblList">
														<tr class="bcTitleList fb fcTitleList">
															<td width="20"><br></td>
															<td width="45">ｽﾃｯﾌﾟ</td>
															<td width="10"></td>
															<td width="40">工程コード</td>
															<td width="250">工程名称</td>
															<td width="135">工程開始予定日時</td>
															<td width="135">工程終了予定日時</td>
															<td width="8">詳細</td>
															<td width="8">配合</td>
														</tr>
														<nested:iterate id="searchProcList" property="searchProcList" indexId="index">
															...
															<nested:notEmpty property="strStepNo">
																...
																<nested:define id="sno" property="strStepNo" />
																<%-- 詳細 --%>
																<td>
																	<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/DirectionProcedureDetail.do?op=init&directionNo=" + pageContext.findAttribute("dno").toString() + "&strStepNo=" + pageContext.findAttribute("sno").toString() + "'); return false;"%>'>
																		選
																	</html:link>
																</td>
																<%-- 配合 --%>
																<td>
																	...
																	<html:link href="#" onclick='<%="toDetail('" + request.getContextPath() + "/DirectionFormulaList.do?op=reSearch&directionNo=" + pageContext.findAttribute("dno").toString() + "&tempProcStepNo=" + pageContext.findAttribute("sno").toString() + "'); return false;"%>'>
																		<nested:write property="formulaMark"  />
																	</html:link>
																	</nested:equal>
																	<nested:equal property="formulaMark" value="×">
