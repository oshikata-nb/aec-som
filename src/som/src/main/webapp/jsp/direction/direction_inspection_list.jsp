...
<nested:form action="/DirectionInspectionList" method="post" onsubmit="return false;" styleId="mainForm">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td class="fcTitle fb" width="250">製造指図検査</td>
							<td>
													...
													<nested:notEmpty property="strLineNo">
														...
														<td>
															<html:link href="#" onclick='<%="toDetail('"
																							...
																							+ "/DirectionInspectionDetail.do?op=init"
