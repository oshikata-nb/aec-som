...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		new Ajax.Autocompleter(
		  ...
		  "<%= request.getContextPath() %>/OrderLocationForAutoComplete.do?op=searchLocation",
		  {
		  	paramName : "code",
...
<nested:form action="/OrderLotSearch" method="post" onsubmit="return false;" styleId="mainForm">
								...
								<tr>
									<td>
										<table cellspacing="2" cellpadding="2"  border="0">
											...
											<tr>
												<td class="bcTitleSearch fb fcTitleSearch">販売引当残</td>
												<td>
													<nested:write property="strSalesAssignQty"/>
												</td>
												<td></td>
												<td class="bcTitleSearch fb fcTitleSearch">先付け受注残</td>
												<td>
													<nested:write property="strPointingOrderQty"/>
												</td>
