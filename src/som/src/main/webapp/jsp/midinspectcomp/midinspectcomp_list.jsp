...
<script language="JavaScript" type="text/javascript">
	...
	Event.observe(window, 'load', function() {
		...
		<%-- フォーム設定の初期化 --%>
		<logic:equal name="midInspectCompListForm" property="searchList" value="false">
			initializeFormState();
		</logic:equal>
	...
	function noCheck(index){
	  var count = 0;
	  var item = document.midInspectCompListForm.midInspectCompCheckBox;
	  var len = item.length;
	...
	function enableCheckBox(chkbox) {
		...
		$("searchList[" + splitName[1] + "].midInspectCompCheckBox").disabled = false;
		$("searchList[" + splitName[1] + "].midInspectCompCheckBox").checked = true;
...
<nested:form action="/MidInspectCompList" method="post" onsubmit="return false;" styleId="mainForm">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td class="fcTitle fb" width="250">中間品検査完了入力</td>
							<td>
						...
						<tr>
							...
							<table cellspacing="1" cellpadding="1" border="0">
								<tr>
									...
									<td>
										<%
											pageContext.setAttribute("selectMidInspectCompDirectionStatus",
											new com.asahikaseieng.app.comboboxes.SelectMidInspectCompDirectionStatus(true, false));
										%>
										<nested:select property="srhDirectionStatus" styleId="srhDirectionStatus">
											<nested:options name="selectMidInspectCompDirectionStatus" property="values" labelName="selectMidInspectCompDirectionStatus" labelProperty="labels"/>
										</nested:select>
									</td>
								</tr>
							</table>
										...
										<app:modulo numerator='<%=pageContext.findAttribute("index").toString()%>' denominator="2" zero="true">
											...
											<td rowspan="2">
												<nested:equal property="directionStatus" value="5">
													<nested:checkbox property="midInspectCompCheckBox" disabled="true" styleId="midInspectCompCheckBox"/>
												</nested:equal>
												<nested:equal property="directionStatus" value="4">
													...
													<nested:notEmpty property="certificationFlag">
														<nested:checkbox property="midInspectCompCheckBox" disabled="false" styleId="midInspectCompCheckBox"/>
													</nested:notEmpty>
												</nested:equal>
											</td>
											<%-- 指図番号 --%>
