...
<script language="JavaScript" type="text/javascript">
	...
	function selectClose(index){
		window.opener.setShippingLotValues(true
			, $F("locationCd" + index)
	...
	function selectCancel(){
		window.opener.setShippingLotValues(false, "", "", "", "", "", "", "", "");
...
<nested:form action="/ShippingLotSearch" method="post" onsubmit="return false;" styleId="mainForm">
